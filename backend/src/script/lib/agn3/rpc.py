...
#
__all__ = ['XMLRPCProxy', 'XMLRPCError', 'AIO_XMLRPCProxy', 'AIO_XMLRPCError', 'AIO_XMLRPCProtocol', 'XMLRPC', 'XMLRPCClient', 'XMLRPCCall']
#
...
"""
	...
	class XMLRPCServer (xmlrpc.server.SimpleXMLRPCServer):
		...
		def _dispatch (self, method: str, params: Iterable[Any]) -> Any:
			try:
