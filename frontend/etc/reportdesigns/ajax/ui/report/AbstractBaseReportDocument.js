...
AbstractBaseReportDocument.prototype = Object.extend( new AbstractReportComponent( ),
{
	...
	__updateContainerSize : function()
	{
		...
		//There is "BrowserUtility.isIE7" used in the "if" statement instead of using the original "BrowserUtility.isIE"
		// to fix the EMMGUI-507. See https://bugs.eclipse.org/bugs/show_bug.cgi?id=350736
