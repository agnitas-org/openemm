...
BEGIN
  ...
  read_loop: LOOP
    ...
    SET @ddl1 = CONCAT('ALTER TABLE customer_', companyid, '_binding_tbl ADD entry_mailing_id INT(10) UNSIGNED');
    PREPARE stmt1 FROM @ddl1;
    EXECUTE stmt1;
    DEALLOCATE PREPARE stmt1;

    SET @ddl2 = CONCAT('ALTER TABLE hst_customer_', companyid, '_binding_tbl ADD entry_mailing_id INT(10) UNSIGNED');
