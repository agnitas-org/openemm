...
ALTER TABLE mailing_tbl ADD COLUMN locking_expire_timestamp TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'if set: the timestamp when a locking is not valid anymore';
