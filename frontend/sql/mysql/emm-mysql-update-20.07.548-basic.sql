...
ALTER TABLE admin_tbl ADD last_login_date TIMESTAMP NULL COMMENT 'Timestamp of last successful login';
...
BEGIN
  ...
  read_loop: LOOP
    ...
    SET @ddl1 = CONCAT('INSERT INTO startup_job_tbl (classname, version, company_id, enabled, state) VALUES (''com.agnitas.startuplistener.startupjobs.LastLoginMigrationStartupJob'', ''20.07.548'', ', companyid, ', 1, 0)');
