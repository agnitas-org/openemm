...
BEGIN
  ...
  read_loop: LOOP
    ...
    SET @ddl1 = CONCAT('INSERT INTO startup_job_tbl (classname, version, company_id, enabled, state) VALUES (''com.agnitas.startuplistener.startupjobs.TargetGroupUsageDataStartupJob'', ''21.01.162'', ', companyid, ', 1, 0)');
