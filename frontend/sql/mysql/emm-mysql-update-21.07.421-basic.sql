...
BEGIN
  ...
  read_loop: LOOP
    ...
    SET @ddl1 = CONCAT('CREATE INDEX intervtrack$', companyid, '$cid$idx ON interval_track_', companyid, '_tbl (customer_id)');
    PREPARE stmt1 FROM @ddl1;
    EXECUTE stmt1;
    DEALLOCATE PREPARE stmt1;
    
    SET @ddl2 = CONCAT('CREATE INDEX intervtrack$', companyid, '$sendd$idx ON interval_track_', companyid, '_tbl (send_date)');
