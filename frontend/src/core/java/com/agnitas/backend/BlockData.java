...
public class BlockData implements Comparable<BlockData> {
	...
	public static final int RCS = 12;
	public static final int RCSTITLE = 13;
	public static final int RCSSMS = 14;
	...
	public String toString () {
		return "com.agnitas.backend.BlockData (id=" + id + ",contentID=" + cid + ",comptype=" + comptype +
	 ...
	 */
	public String getNextTag() throws EMMTagSyntaxException {
		...
		if (end_position == content.length()) {
			throw new EMMTagSyntaxException("Syntax error in tag name " + content.substring(current_pos));
		}
