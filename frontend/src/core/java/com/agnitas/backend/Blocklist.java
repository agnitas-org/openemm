...
public class Blocklist {
	 ...
	 */
	public void writeBounce (int licenceID, long mailingID, long customerID, Media media) {
		if (bouncelog != null) {
			String	entry = "5.9.9;" + licenceID + ";" + mailingID + ";" + media.type + ";" + customerID + ";admin=auto opt-out due to blocklist\tstatus=blocklist\n";
			try (FileOutputStream file = new FileOutputStream (bouncelog, true)) {
				file.write (entry.getBytes (StandardCharsets.UTF_8));
			} catch (Exception e) {
