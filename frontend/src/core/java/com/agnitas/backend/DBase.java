 ...
 */
public class DBase implements Closeable {
	 ...
	 */
	public final void logging(int loglvl, String mid, String msg, Throwable th, int limit, boolean unwind) {
		data.logging(loglvl, (mid != null ? mid + "/db" : "db"), msg, th, limit, unwind);
	}
	public final void logging(int loglvl, String mid, String msg, Throwable th, boolean unwind) {
		logging(loglvl, mid, msg, th, -1, unwind);
	}
	public final void logging(int loglvl, String mid, String msg, Throwable th, int limit) {
		logging(loglvl, mid, msg, th, limit, false);
	}
	public final void logging(int loglvl, String mid, String msg, Throwable th) {
		logging(loglvl, mid, msg, th, 8, false);
	}
	public final void logging(int loglvl, String mid, String msg) {
		logging(loglvl, mid, msg, null);
	}
	public final void logging(int loglvl, String msg) {
	...
	private final void cursorTrace (String message) {
		if (cursorTrace) {
	...
	private boolean recoverableError (Throwable t, boolean first) {
		...
		if (cls == org.springframework.jdbc.UncategorizedSQLException.class) {
			return retryUncategorizedSQLException || first;
		}
