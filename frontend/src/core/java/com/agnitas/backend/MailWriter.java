...
import com.agnitas.backend.dao.BackendLogDAO;
...
abstract public class MailWriter {
	 ...
	 */
	protected MailWriter(Data data, BlockCollection allBlocks) throws Exception {
		this.data = data;
	...
	public void writeMail (Custinfo cinfo,
			       ...
			       Map <TagID, EMMTag> tagNames) throws Exception {
		writeMailDone ();
		mailType = mailtype;
		checkBlock(false);
		pending = true;
