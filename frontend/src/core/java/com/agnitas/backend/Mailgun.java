...
public interface Mailgun extends Closeable {
	/**
	 * Initialize internal data
	 *
	 * @param status_id the string version of the statusID to use
	 */
	void initialize(String status_id, Map<String, Object> opts) throws Exception;
	 ...
	 */
	String fire(String status_id, Map <String, Object> opts) throws Exception;
