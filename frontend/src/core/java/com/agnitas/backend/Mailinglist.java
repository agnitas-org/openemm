...
import com.agnitas.backend.dao.MailinglistDAO;
import com.agnitas.backend.exceptions.MissingMailinglistException;
...
public class Mailinglist {
	 ...
	 */
	public void retrieveInformation() throws MissingMailinglistException, SQLException {
		MailinglistDAO mailinglist = new MailinglistDAO(data.dbase, id);

		if (mailinglist.mailinglistID() == 0L) {
			throw new MissingMailinglistException (id, "No entry for mailinglistID in mailinglist table found");
		}
