...
public class Media {
	 ...
	 */
	public static final int TYPE_UNRELATED = -1;
	/**
	 * Mediatype email
	 */
	...
	public static final int TYPE_RCS = 5;
	/**
	 * Entry is not used
	 */
	public static final int STAT_UNUSED = 0;
	/**
	 * Entry marked as inactive
	 */
	public static final int STAT_INACTIVE = 1;
	/**
	 ...
	 */
	private static final String PARAMETER_PROFILEFIELD = "profilefield";
	 ...
	 */
	public static String defaultProfileField(int t) {
		switch (t) {
			case TYPE_EMAIL:
				return "email";
			case TYPE_PRINT:
	 ...
	 * @return its string representation
	 */
	public static String priorityName(int p) {
