...
public interface Admin {
    ...
    /**
     * Getter for the password. This method is meant to be called by the AdminDao only for storage.
     * The AdminDao empties this value after storage.
     */
    ...
    boolean allowedAll(Permission... permissions);
