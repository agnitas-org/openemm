...
public abstract class BaseTrackableLinkImpl implements BaseTrackableLink {
	...
	private boolean emmTriggerAttrPresent;
	protected List<LinkProperty> linkProperties = new ArrayList<>();

	protected BaseTrackableLinkImpl() {
		// Empty
	}
	
	protected BaseTrackableLinkImpl(BaseTrackableLink original) {
	...
	@Override
	public boolean isEmmTriggerAttrPresent() {
		return emmTriggerAttrPresent;
	}

	@Override
	public void setEmmTriggerAttrPresent(boolean emmTriggerAttrPresent) {
		this.emmTriggerAttrPresent = emmTriggerAttrPresent;
	}
}
