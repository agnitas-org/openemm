...
public interface Mailing extends MailingBase {
     ...
     */
    boolean buildDependencies(boolean scanDynTags, ApplicationContext con) throws DynTagException;
    boolean buildDependencies(boolean scanDynTags, List<String> dynNamesForDeletion, ApplicationContext con, List<Message> warnings, List<Message> errors, Locale locale) throws DynTagException;
    boolean buildDependencies(Popups popups, boolean scanDynTags, List<String> dynNamesForDeletion, ApplicationContext con, Locale locale) throws DynTagException;
    boolean buildDependencies(boolean scanDynTags, List<String> dynNamesForDeletion, ApplicationContext con) throws DynTagException;
