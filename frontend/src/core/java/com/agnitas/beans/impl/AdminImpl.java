...
public class AdminImpl implements Admin {
	...
	public Locale getLocale() {
		if (StringUtils.isBlank(adminLang)) {
			...
			return Locale.of(adminLang, adminCountry);
		}
	}
	...
	@Override
	public boolean allowedAll(Permission... permissions) {
		return Arrays.stream(permissions).allMatch(this::permissionAllowed);
	}
	...
	public SimpleDateFormat getDateTimeFormatWithSeconds() {
		SimpleDateFormat dateTimeFormat = (SimpleDateFormat) DateFormat.getDateInstance(DateFormat.SHORT, getLocale());
	...
	public DateTimeFormatter getDateFormatter() {
		String dateFormatPattern = ((SimpleDateFormat) DateFormat.getDateInstance(DateFormat.SHORT, getLocale())).toPattern().replaceFirst("y+", "yyyy");
	...
	public SimpleDateFormat getTimeFormat() {
		SimpleDateFormat timeFormat = (SimpleDateFormat) DateFormat.getTimeInstance(DateFormat.SHORT, getLocale());
