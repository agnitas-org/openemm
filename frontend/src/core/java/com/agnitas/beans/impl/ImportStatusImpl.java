...
public class ImportStatusImpl implements ImportStatus {
	...
	protected Map<ImportErrorType, Integer> errors = new EnumMap<>(ImportErrorType.class);
	...
	private Map<MediaTypes, Map<Integer, Integer>> mailinglistStatistics = new EnumMap<>(MediaTypes.class);
