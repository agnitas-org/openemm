...
public interface MailingDao {
    ...
    Map<MailingType, List<MailingBase>> getPredefinedMailingsForReports(int companyId, Set<MailingType> mailingTypes, int targetId, Set<Integer> adminAltgIds, int groupCount);
	 ...
	 */
	PaginatedList<Map<String, Object>> getMailingList(Admin admin, MailingsListProperties props);

	List<LightweightMailing> getLightweightMailings(Admin admin, MailingsListProperties props);
	...
	List<MailingBase> getMailingsInfoForComparison(Set<Integer> mailingIds, int companyId);

	PaginatedList<Map<String, Object>> getMailingsForComparison(MailingComparisonFilter filter, Admin admin);
