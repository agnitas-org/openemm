...
public interface RecipientDao {
    ...
    List<RecipientHistory> getRecipientBindingHistory(int recipientID, int companyID);

    List<Map<String, Object>> getRecipientClicksHistory(int recipientId, int mailingId, int companyId);

    List<RecipientHistory> getRecipientProfileHistory(int recipientID, int companyID);
	...
	int getNumberOfRecipients(int companyId, int mailingListId, String sqlConditions, Object... sqlConditionParameters);
     ...
     * @return customerID or 0 if no matching record found
     */
    int findByUserPassword(int companyID, String userCol, Object userValue, String passCol, String passValue);
    ...
    CaseInsensitiveMap<String, Object> getCustomerDataFromDb(int companyID, int customerID, DateFormat dateFormat);
    ...
    List<CaseInsensitiveMap<String, Object>> getCustomersDataFromDb(int companyID, int lastId, int count, Collection<String> columns);
    ...
    List<RecipientLiteImpl> getMailingAdminAndTestRecipients(int mailingId, int companyId);
    ...
    CaseInsensitiveMap<String, RecipientFieldDescription> getAvailableProfileFields(int companyID);
    ...
    List<Integer> insertTestRecipients(int companyId, List<String> addresses);
    ...
    void writeEmailAddressChangeRequest(int companyID, int customerID, String newEmailAddress, String confirmationCode);

	String readEmailAddressForPendingChangeRequest(int companyID, int customerID, String confirmationCode);

	void deletePendingEmailAddressChangeRequest(int companyID, int customerID, String confirmationCode);

	DbColumnType getColumnDataType(int companyId, String columnName);

	List<Integer> getRecipientIDs(int companyID, String keyColumn, Object keyValue);
    ...
    boolean isNotSavedRecipientDataMatchTarget(int companyId, int recipientId, String targetExpression, Map<String, Object> entry);

    List<Integer> listRecipientIdsByTargetGroup(int companyId, Target target);
	...
	BindingEntry getMailinglistBinding(int companyID, int customerID, int mailinglistId, int mediaType);

	List<CaseInsensitiveMap<String, Object>> getMailinglistRecipients(int companyID, int mailinglistID, MediaTypes mediaTypes, String targetSql, List<String> profileFieldsList, List<UserStatus> userstatusList, TimeZone timeZone);

    List<RecipientSalutationDto> getAdminAndTestRecipientsSalutation(int companyId, int adminId);

	List<RecipientLiteImpl> listAdminAndTestRecipientsByAdmin(int companyID, int adminID);
	...
	List<CaseInsensitiveMap<String, Object>> getTargetRecipients(int companyID, String targetSql, List<String> profileFieldsList, TimeZone timeZone);

	List<RecipientMailing> getMailingsDeliveredToRecipient(int customerID, int companyID);

	List<Integer> getCustomerDataFromDb(int companyId, String condition);

	int getSizeOfCustomerDataFromDbList(int companyId, String condition);
    ...
    List<String> getReadableNames(Set<Integer> ids, int companyID);
    ...
    void batchUpdateData(List<Integer> customerIds, List<Map<String, ? extends Object>> rowsData, List<String> columns, int companyId);
