...
public interface TrackableLinkDao {
    ...
    List<TrackableLink> getTrackableLinksWithParams(int companyId, int mailingId, boolean includeDeleted);
    ...
    void bulkClearExtensions(int mailingId, int companyId, Set<Integer> bulkIds);
