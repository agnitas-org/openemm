...
public interface DemoAccountService {
    ...
    Map<String, Integer> resetAccount(int companyId);
    
    Map<String, Integer> resetAccount(int companyId, boolean resetAdvanced);
    ...
    boolean fillAccountFromCompanyOnlyRecipients(int companyID, int fromCompanyID);
