...
public class ActionOperationActivateDoubleOptInDaoImpl extends AbstractActionOperationDaoImpl<ActionOperationActivateDoubleOptInParameters> {
	...
	/**
	 * Converts numeric representation of mediatype to {@link MediaTypes}. If numeric representation
	 ...
	 */
	private static MediaTypes extractMediaType(final Map<String, Object> map) {
