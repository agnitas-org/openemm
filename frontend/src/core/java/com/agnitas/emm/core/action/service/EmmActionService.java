...
public interface EmmActionService {
     ...
     */
    boolean actionExists(int actionID, int companyID);

    boolean executeActions(int actionID, int companyID, Map<String, Object> params, EmmActionOperationErrors errors);
    ...
    List<Integer> findTriggerIdsByName(String name, int companyId);

    List<Integer> getTriggerIds(int companyId);
}
