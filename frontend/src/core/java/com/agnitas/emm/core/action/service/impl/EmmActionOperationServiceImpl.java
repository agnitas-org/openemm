...
public class EmmActionOperationServiceImpl implements EmmActionOperationService, InitializingBean {
	...
	@Override
	public boolean executeOperation(AbstractActionOperationParameters operation, Map<String, Object> params, EmmActionOperationErrors errors) {
	...
	public EmmActionOperation getExecutor(ActionOperationType type) {
