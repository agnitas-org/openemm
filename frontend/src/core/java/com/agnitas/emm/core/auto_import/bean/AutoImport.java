...
public class AutoImport extends AutoImportLight {
	...
	public enum AutoImportType {
		 ...
		 */
		public static AutoImportType getAutoImportTypeFromStorageString(String storageString) {
			...
			throw new IllegalArgumentException("Invalid storage string '" + storageString + "' for AutoImportType");
		}
	}
