...
public interface AutoImportDao {
	...
	PaginatedList<AutoImport> getAutoImportsOverview(AutoImportOverviewFilter filter, int companyId, boolean restrictContentSourceType, boolean showReferenceTableImports);
