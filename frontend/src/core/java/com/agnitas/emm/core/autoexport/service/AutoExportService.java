...
package com.agnitas.emm.core.autoexport.service;
...
import com.agnitas.emm.core.autoexport.beans.AutoExportStatus;
...
public interface AutoExportService {
    ...
    PaginatedList<AutoExport> getAutoExportsOverview(AutoExportOverviewFilter filter, Admin admin);
