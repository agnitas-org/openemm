...
@Component
public final class AutoOptToCalendarAutoOptLabelConverter implements Converter<Optimization, CalendarAutoOptLabel> {

    @Override
    public CalendarAutoOptLabel convert(Optimization optimization) {
        return new CalendarAutoOptLabel(
            optimization.getId(),
            optimization.getShortname(),
            optimization.getWorkflowId(),
            optimization.getAutoOptimizationStatus(),
