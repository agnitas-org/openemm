...
/**
 * Utility class for SHA512 encoding.
 */
public final class Sha512Encoder implements ByteArrayEncoder {
	/**
	...
	/**
	 * Creates a new Sha512Encoder instance.
	 * 
	...
	public Sha512Encoder() {
		try {
			...
			throw new IllegalStateException("No SHA512 algorithm", e);
		}
	}
	
	/**
	 * Computes SHA512 hash of array of bytes.
	 * 
	 * @param data array of bytes
	 * 
	 * @return SHA512 hash of byte array
	 */
	@Override
	public byte[] encode(byte[] data) {
		sha512.reset();	// Make sure, we do include previously hashed data.
