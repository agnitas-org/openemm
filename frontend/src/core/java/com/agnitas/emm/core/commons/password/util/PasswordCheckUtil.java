...
public final class PasswordCheckUtil {
	 ...
	 */
	public static void invokeHandler(PolicyViolationException ex, PasswordCheckHandler handler) {
	...
	public static List<Message> policyViolationsToMessages(PolicyViolationException exception) {
