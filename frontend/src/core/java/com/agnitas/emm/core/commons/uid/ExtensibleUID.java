...
public interface ExtensibleUID {
	 ...
	 */
	ExtensibleUID setMediaID(int mediaID);
	...
	/**
	 * Returns the divId of content block from where this link had been called
	 * 
	 * @return the divId or 0, if called from template
	 */
	long getDivId ();
	 ...
	 * @return the instance of the ExtensibleUID for daisy chaining
	 */
	ExtensibleUID setDivId (long divId);
	...
	/**
	 * Get/set optional already generated payload for UID
	 */
	byte[] getPayload ();
	ExtensibleUID setPayload (byte[] payload);
}
