...
public interface ExtensibleUIDService {
    ...
    /**
     * Builds a UID string from the given extensible UID.
     * <p>
     * This method wraps checked exceptions into {@link BuildUIDException}.
     *
     * @throws BuildUIDException if UID could not be built
     */
    String buildUID(ExtensibleUID extensibleUID);
