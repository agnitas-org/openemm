...
public class UIDParseException extends Exception {
    private static final long serialVersionUID = 1805406379439396757L;

    public UIDParseException(String message) {
        super(message);
    }

    public UIDParseException(String message, Throwable cause) {
        super(message, cause);
    }
    ...
    public UIDParseException(String message, String uidString, Throwable cause) {
        super(message + " uid: " + uidString, cause);
    }
}
