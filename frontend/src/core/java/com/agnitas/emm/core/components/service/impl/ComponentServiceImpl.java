...
public class ComponentServiceImpl implements ComponentService {
	...
	private final ComponentModelValidator modelValidator;
	private final MailingComponentFactory mailingComponentFactory;
	private final FormComponentDao formComponentDao;
    ...
    public ComponentServiceImpl(
			...
			ComponentModelValidator modelValidator,
			MailingComponentFactory mailingComponentFactory,
			FormComponentDao formComponentDao,
	...
	private FormComponent makeComponentThumbnail(FormComponent imageComponent) {
		...
		int originWidth = imageComponent.getWidth();
		int originHeight = imageComponent.getHeight();
