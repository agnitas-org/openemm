...
public class DashboardServiceImpl implements DashboardService {
    ...
    @Override
    public JSONObject getStatisticsInfo(int mailingId, Locale locale, Admin admin) {
    ...
    private Map<Integer, Integer> getReportData(int mailingId, int companyId) {
