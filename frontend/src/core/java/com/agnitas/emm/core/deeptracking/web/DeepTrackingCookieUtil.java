...
public final class DeepTrackingCookieUtil {
	...
	private DeepTrackingCookieUtil() {

	}
	
	private static final Logger LOGGER = LogManager.getLogger(DeepTrackingCookieUtil.class);
	 ...
	 */
	public static Optional<DeepTrackingCookieValue> parseCookieValue(String value) {
		...
		if(index != -1) {
			...
			try {
				...
				LOGGER.info("could not parse session ID from deep tracking cookie value: {}", value, e);
