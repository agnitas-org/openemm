...
public class HashTagContext {
	 ...
	 */
	public HashTagContext(TrackableLink link, int customerID, ExtensibleUID uid, String originalUID, String referenceTableRecordSelector, Map<String, Object> staticValueMapOrNull) {
