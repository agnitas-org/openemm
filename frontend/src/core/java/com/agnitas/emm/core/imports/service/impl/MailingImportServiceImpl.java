...
import com.agnitas.emm.core.imports.exception.MailingImportException;
...
public class MailingImportServiceImpl implements MailingImportService {
    ...
    private void importMailingsFromZipArchive(ImportForm form, Admin admin) {
        ...
        try {
            ...
            throw new MailingImportException(e);
        } finally {
            org.apache.commons.io.FileUtils.deleteQuietly(tempZipFile);
