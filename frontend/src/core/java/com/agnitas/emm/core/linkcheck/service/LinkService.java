...
public interface LinkService {
	...
	String personalizeLink(TrackableLink link, ExtensibleUID uid, String orgUID, int customerID, final String referenceTableRecordSelector, final boolean applyLinkExtensions, final String encodedStaticValueMap);
	...
	String validateLink(String link, GridCustomPlaceholderType type);
