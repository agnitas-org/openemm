...
package com.agnitas.emm.core.loginmanager.dao;
...
public interface LoginTrackDao {
	 ...
	 */
    void trackLoginStatus(String ipAddress, String username, LoginStatus loginStatus);
	 ...
	 */
	List<LoginData> listLoginData(Date sinceOrNull);
	 ...
	 */
	List<LoginData> listLoginDataByIpAddress(String ipAddress, Date sinceOrNull);
	 ...
	 * @return list of logins since given timestamp
	 */
	List<LoginData> listLoginDataByUsername(String username, Date sinceOrNull);
	 ...
	 */
	int deleteOldRecordsHours(int retentionTimeHours, int maxRecords);
	 ...
	 */
	Optional<LoginData> findLoginDataByTrackingID(long trackingID);
