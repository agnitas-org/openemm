...
public interface HostAuthenticationDao {
	 ...
	 */
	void writePendingSecurityCode(Admin admin, String hostID, String securityCode);
	 ...
	 * @param securityCode security code
	 */
	void writePendingSecurityCode(Supervisor supervisor, String hostID, String securityCode);
	 ...
	 */
	boolean isHostAuthenticated(Admin admin, String hostID);
	 ...
	 * @return {@code true} if host is authenticated, otherwise {@code false}
	 */
	boolean isHostAuthenticated(Supervisor supervisor, String hostID);
	 ...
	 * @param hostID host ID
	 */
	void removePendingSecurityCode(Admin admin, String hostID);
	 ...
	 * @param hostID host ID
	 */
	void removePendingSecurityCode(Supervisor supervisor, String hostID);
