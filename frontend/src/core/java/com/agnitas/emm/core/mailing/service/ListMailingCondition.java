...
public class ListMailingCondition {
	...
	public abstract static class SendDateCondition extends ListMailingCondition {
	...
	public abstract static class MailingPropertyCondition extends ListMailingCondition {
