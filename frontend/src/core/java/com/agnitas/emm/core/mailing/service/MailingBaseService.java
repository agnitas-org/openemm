...
public interface MailingBaseService {
    ...
    int calculateRecipients(int mailingId, int companyId, int targetGroupId);
    ...
    List<String> getNames(Set<Integer> mailingIds, int companyId);
    ...
    void activateTrackingLinksOnEveryPosition(Mailing mailing, ApplicationContext context);
    ...
    String getThumbnailUrl(Mailing mailing);
}
