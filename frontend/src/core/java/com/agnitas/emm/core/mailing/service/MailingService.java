...
public interface MailingService {
	...
	List<Mailing> listMailings(int companyId, ListMailingFilter filter);
	...
	List<Mailing> getMailingsForMailinglist(int mailinglistId, int companyId);
	...
	int saveMailingWithNewContent(Mailing mailing);

	int saveMailingWithNewContent(Mailing mailing, Admin admin);

	int saveMailingWithNewContent(Mailing mailing, boolean errorTolerant, boolean removeUnusedContent);
    ...
    PaginatedList<Map<String, Object>> getOverview(Admin admin, MailingsListProperties props);
	...
	Map<Integer, MailingBase> getMailingsInfoForComparison(Set<Integer> mailingIds, int companyId);

    Optional<Integer> getThumbnailComponentId(Mailing mailing);

	boolean isPostMailing(Mailing mailing);

	boolean isPostMailing(int mailingId, int companyId);

	boolean isOfflineHtmlFormat(Mailing mailing);
