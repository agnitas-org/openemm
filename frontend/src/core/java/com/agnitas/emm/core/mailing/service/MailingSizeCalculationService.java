...
public interface MailingSizeCalculationService {
     ...
     * @return the info of maximum possible mail sizes in bytes depending on mailing format:
     */
    MailingSize calculate(Mailing mailing, Admin admin);

    long getDeliverySize(Mailing mailing, Admin admin);
}
