...
public class TagContentValidator implements DynTagValidator {
    ...
    public boolean validate(DynTagDto dynTagDto, Popups popups, Admin admin) {
        ...
        try (TAGCheck tagCheck = tagCheckFactory.createTAGCheck(dynTagDto.getMailingId(), admin.getLocale())) {
            ...
            logger.warn("Something went wrong while content tag validation in the dyn tag (ID: {}, Name: '{}'): {}",
