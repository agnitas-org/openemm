...
public class SecurityTokenGenerator {
	...
	private static final Logger logger = LogManager.getLogger(SecurityTokenGenerator.class);
	
	/** RNG for generating security tokens. */
	private static final Random random = new SecureRandom();
	
	/** Alphabet used for generation of security tokens. */
	private static final char[] SECURITY_TOKEN_SYMBOLS = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".toCharArray();
