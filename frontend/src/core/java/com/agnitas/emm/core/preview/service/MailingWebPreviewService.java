...
public interface MailingWebPreviewService {
    ...
    PreviewResult getPreview(PreviewSettings settings, Admin admin) throws Exception;

    PreviewResult getPreview(Mailing mailing, PreviewSettings settings, Admin admin) throws Exception;

    MediaTypes castPreviewFormatToMediaType(int previewFormat);
