...
public class ProfileFieldValidationServiceImpl implements ProfileFieldValidationService {
    ...
    public boolean isValidShortname(int companyId, String shortName, String fieldName) {
        ...
        if (Strings.CI.equals(shortName, fieldName)) {
            isValid = true;
        } else {
        ...
        if (profileField == null) {
            ...
            switch (newSimpleDataType) {
	            case Date:
                    ...
                    try {
                        newValue = Strings.CS.replace(newValue, dateFormatPattern, "");
	            ...
	            case DateTime:
                    ...
                    try {
                        newValue = Strings.CS.replace(newValue, dateTimeFormatPattern, "");
    ...
    private boolean fieldNotExistInDb(int companyId, String shortName, String fieldName) {
        ...
        for (RecipientFieldDescription field : profileFields) {
            boolean isColumnEqualsFieldName = Strings.CI.equals(field.getColumnName(), fieldName);
            boolean isColumnEqualsShortname = Strings.CI.equals(field.getColumnName(), shortName);
            boolean isDbShortnameEqualsShortname = Strings.CI.equals(field.getShortName(), shortName);
