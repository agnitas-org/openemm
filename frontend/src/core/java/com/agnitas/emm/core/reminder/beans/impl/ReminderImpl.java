...
public class ReminderImpl implements Reminder {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ReminderImpl)) return false;

        ReminderImpl that = (ReminderImpl) o;

        return that.id == id
                && that.companyId == companyId
                && that.sent == sent
                && Strings.CS.equals(that.lang, lang)
                && Strings.CS.equals(that.message, message)
                && Strings.CS.equals(that.recipientEmails, recipientEmails)
                && Strings.CS.equals(that.senderName, senderName)
                && Strings.CS.equals(that.title, title);
    }
}
