...
@Component
public class RecipientBindingHistoryToRecipientHistoryConverter implements CollectionConverter<RecipientBindingHistory, RecipientHistory> {

    @Override
    public RecipientHistory convert(final RecipientBindingHistory bindingHistory) {
