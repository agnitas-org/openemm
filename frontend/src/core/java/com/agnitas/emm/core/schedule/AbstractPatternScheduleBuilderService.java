...
public abstract class AbstractPatternScheduleBuilderService<T extends TimeScheduledEntry> {
    ...
    protected AbstractPatternScheduleBuilderService(PatternScheduleConfig config) {
        this.config = config;
    }
    ...
    public abstract boolean isInvalid(List<T> parameter);

    public abstract String buildSchedule(List<T> parameter);

    public abstract List<T> parse(String parameter);
