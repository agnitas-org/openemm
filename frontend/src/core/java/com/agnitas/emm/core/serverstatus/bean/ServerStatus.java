...
import com.agnitas.emm.core.serverstatus.SseDebugStatus;
...
public class ServerStatus {
    ...
    public String getShortVersion() {
        try {
            return new Version(version).truncateToMinor().getShortVersion();
        } catch (Exception e) {
            return version;
        }
    }
    ...
    public Integer getDbConnectionsCount() {
        return dbConnectionsCount;
    }
    ...
    public SseDebugStatus getSseStatus() {
        return sseStatus;
    }
    ...
    public static class StatusBuilder {
        ...
        public ServerStatus.StatusBuilder database(String dbTypeToUse, String dbUrlToUse, String dbVersionToUse, boolean dbConnectStatusToUse, Integer dbConnectionsCount) {
            this.dbType = dbTypeToUse;
            this.dbUrl = dbUrlToUse;
            this.dbVersion = dbVersionToUse;
            this.dbConnectStatus = dbConnectStatusToUse;
            this.dbConnectionsCount = dbConnectionsCount;
            return this;
        }
        ...
        public ServerStatus.StatusBuilder sseDebugStatus(SseDebugStatus sseDebugStatus) {
            this.sseStatus = sseDebugStatus;
            return this;
        }
        ...
        public ServerStatus build() {
            ...
            serverStatus.dbConnectionsCount = dbConnectionsCount;
            ...
            serverStatus.sseStatus = sseStatus;
            return serverStatus;
        }
    }
