...
public interface ServerStatusService {
    ...
    boolean saveServerConfig(int companyId, String configName, String configValue, String description, Admin admin);
	...
	boolean isVersionUpdateExists();

	boolean isEOLReached();

	String getEOLDate(Admin admin);
