...
public interface RecipientFieldService {
	...
	PaginatedList<RecipientFieldDescription> getPaginatedList(List<RecipientFieldDescription> fields, ProfileFieldForm paginationForm, int companyId);
	...
	CaseInsensitiveMap<String, RecipientFieldDescription> getVisibleFields(int companyID, int adminID);
    List<RecipientFieldDescription> listVisibleFields(int companyId, int adminId);
    Set<String> getNamesOfChangeableFields(int companyId, int adminId);
}
