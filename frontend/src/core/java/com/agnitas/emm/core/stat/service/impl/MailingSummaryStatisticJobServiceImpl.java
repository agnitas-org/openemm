...
public class MailingSummaryStatisticJobServiceImpl implements MailingSummaryStatisticJobService {
	...
	public int statJob(int jobId, int companyId, int mailingId, String targetGroups, int recipientsType) {
	...
	public void removeExpiredData() {
		...
		if (cleanUpTime > 0) {
			...
			logger.error("Summary statistic clean up time is {}. All data remains in DB!", cleanUpTime);
		}
	}
