...
public abstract class AbstractTargetComplexityAnalyzer<T extends AbstractEqlNode> implements TargetComplexityAnalyzer<T> {
    ...
    private static final Logger logger = LogManager.getLogger(AbstractTargetComplexityAnalyzer.class);
    ...
    protected AbstractTargetComplexityAnalyzer(Class<T> nodeType) {
