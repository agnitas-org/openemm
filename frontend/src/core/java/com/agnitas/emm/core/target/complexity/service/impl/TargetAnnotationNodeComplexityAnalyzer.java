...
@Component
public final class TargetAnnotationNodeComplexityAnalyzer extends AbstractTargetComplexityAnalyzer<AnnotationBooleanEqlNode> {
    public TargetAnnotationNodeComplexityAnalyzer() {
        super(AnnotationBooleanEqlNode.class);
    }

    @Override
    public void analyze(AnnotationBooleanEqlNode node, boolean negative, TargetComplexityEvaluationState state) {
