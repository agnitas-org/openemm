...
@Component
public final class TargetStartsWithNodeComplexityAnalyzer extends AbstractTargetComplexityAnalyzer<StartsWithRelationalEqlNode> {
    public TargetStartsWithNodeComplexityAnalyzer() {
        super(StartsWithRelationalEqlNode.class);
    }

    @Override
    public void analyze(StartsWithRelationalEqlNode node, boolean negative, TargetComplexityEvaluationState state) {
        add(state, TargetComplexityCriterion.LIKE_OPERATOR);
