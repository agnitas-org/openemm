...
public abstract class FaultyCodeException extends CodeGeneratorException {
	 ...
	 */
	protected FaultyCodeException(final AbstractEqlNode faultyNode, final String reason) {
	 ...
	 * @param reason reason of error
	 */
	protected FaultyCodeException(AbstractEqlNode faultyNode, String reason, Throwable cause) {
	 ...
	 * @param reason reason of error
	 */
	protected FaultyCodeException(CodeLocation codeLocation, String reason) {
	 ...
	 * @param reason reason of error
	 */
	protected FaultyCodeException(CodeLocation codeLocation, String reason, Throwable cause) {
