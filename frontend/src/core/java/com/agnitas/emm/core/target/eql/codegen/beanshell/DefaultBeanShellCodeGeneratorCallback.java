...
public class DefaultBeanShellCodeGeneratorCallback implements BeanShellCodeGeneratorCallback {
	...
	private void numericPostOrderBinaryOperatorRelationalEqlNode(BinaryOperatorRelationalEqlNode node, CodeFragment left, CodeFragment right) {
	...
	private void numericPostOrderBinaryOperatorExpressionalEqlNode(BinaryOperatorExpressionalEqlNode node, CodeFragment left, CodeFragment right) {
		final String operatorSymbol = OperatorUtils.numericBeanShellOperatorSymbol(node);
