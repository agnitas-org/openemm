...
public final class UnsubscribeServlet extends HttpServlet {
	...
	private transient Unsubscription unsubscription;
	private transient OneClickUnsubscription oneClickUnsubscription;
	private transient UserFormExecutionService userFormExecuteService;
