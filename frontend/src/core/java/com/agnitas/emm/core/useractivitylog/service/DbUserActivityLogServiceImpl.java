...
public class DbUserActivityLogServiceImpl implements UserActivityLogService {
	...
	@Async
	@Override
	public void writeRestUserActivityLog(RestUserAction action, Admin admin) {
		...
		generalUserActivityLogDao.addAdminUseOfFeature(admin, action.description(), new Date());
	}
