...
import com.agnitas.emm.core.velocity.emmapi.AccessToCompanyDeniedException;
...
public final class ThrowingMethodExceptionEventHandler implements MethodExceptionEventHandler {
	...
	private static final Logger LOGGER = LogManager.getLogger(ThrowingMethodExceptionEventHandler.class);
	...
	public Object methodException(final Context context, final Class<?> clazz, final String method, final Exception exception, final Info info) {		
		LOGGER.info("Method {}#{} threw exception in Velocity script", clazz.getCanonicalName(), method, exception);
