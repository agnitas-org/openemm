...
public final class CompanyAccessCheckImpl implements CompanyAccessCheck {
	...
	private static final Logger LOGGER = LogManager.getLogger(CompanyAccessCheckImpl.class);
	...
	@Override
	public void checkCompanyAccess(int toCompanyId, int byCompanyId) {
	...
	private final boolean isValidAccess(final int toCompanyId, final int byCompanyId) {
		...
		LOGGER.debug("Checking access to company {} by company {} running the script", toCompanyId, byCompanyId);
