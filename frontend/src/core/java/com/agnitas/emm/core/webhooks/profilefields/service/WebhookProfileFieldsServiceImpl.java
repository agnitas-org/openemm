...
public class WebhookProfileFieldsServiceImpl implements WebhookProfileFieldsService {

	private WebhookProfileFieldDao profileFieldDao;
	
	@Override
	public Set<String> listProfileFieldNamesForWebhook(int companyID, WebhookEventType eventType) {
		return this.profileFieldDao.listProfileFieldsForWebhook(companyID, eventType);
	}
	
	@Override
	public boolean deleteProfileFieldSettingsForWebhooks(int companyID) {
		return profileFieldDao.deleteProfileFieldsForWebhooks(companyID);
	}

	@Transactional
	@Override
	public void updateIncludedProfileField(int companyID, WebhookEventType eventType, Set<String> profileFields) {
	...
	public void setWebhookProfileFieldDao(WebhookProfileFieldDao dao) {
