 ...
 */
public class WebhookNotRegisteredException extends WebhookRegistrationException {
	 ...
	 */
	public WebhookNotRegisteredException(int companyId, WebhookEventType eventType) {
