...
public interface WebhookRegistrationDao {
	 ...
	 */
	void registerWebhookUrl(int companyId, WebhookEventType eventType, String url);
	 ...
	 * @throws NullPointerException if <code>url</code> or <code>eventType</code> is <code>null</code>
	 */
	void unregisterWebhookUrl(int companyId, WebhookEventType eventType);
	 ...
	 */
	List<WebhookRegistryEntry> listAllRegisteredWebhookUrls(WebhookEventType eventType);
	 ...
	 * @throws NullPointerException if <code>url</code> or <code>eventType</code> is <code>null</code>
	 */
	WebhookRegistryEntry findWebhookEntry(int companyId, WebhookEventType eventType);
	
	/**
	 * Return true for successful deletion of company data
	 * @param companyId
	 */
	boolean deleteWebhookUrlByCompany(int companyId);
