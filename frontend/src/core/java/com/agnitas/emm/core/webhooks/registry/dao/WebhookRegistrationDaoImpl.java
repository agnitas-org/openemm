...
public class WebhookRegistrationDaoImpl extends BaseDaoImpl implements WebhookRegistrationDao {
	...
	@Transactional
	@Override
	public void registerWebhookUrl(int companyId, WebhookEventType eventType, String url) {
	...
	public void unregisterWebhookUrl(int companyId, WebhookEventType eventType) {
        ...
        update("DELETE FROM webhook_url_tbl WHERE company_ref = ? AND event_type = ?", companyId, eventType.getEventCode());
	}
