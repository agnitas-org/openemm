...
public interface WebhookSettingsService {
	 ...
	 */
	WebhookSettings findRegisteredWebhookSettings(int companyID, WebhookEventType eventType);
	 ...
	 */
	List<WebhookSettings> listWebhookSettings(int companyID);
	...
	void updateWebhookSettings(int companyID, WebhookEventType eventType, String url, Set<String> profileFields);
