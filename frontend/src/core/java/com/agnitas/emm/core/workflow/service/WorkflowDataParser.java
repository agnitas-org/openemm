...
public class WorkflowDataParser {

    private static final Logger logger = LogManager.getLogger(WorkflowDataParser.class);

    private final ObjectMapper mapper;

    public WorkflowDataParser() {
    ...
    public List<WorkflowIcon> deSerializeWorkflowIconsList(String contentJson) {
        ...
        try {
            ...
            logger.error("deSerializeWorkflowIconsList: {}", e.getMessage(), e);
    ...
    public String serializeWorkflowIcons(List<WorkflowIcon> icons) {
        try {
            ...
            logger.error("serializeWorkflowIcons: {}", e.getMessage(), e);
            return null;
        }
    }
}
