...
public interface WorkflowService {
    ...
    void saveWorkflow(Admin admin, Workflow workflow, List<WorkflowIcon> icons, boolean duringPause, boolean isUnpausing);

    void saveWorkflow(Admin admin, Workflow workflow, List<WorkflowIcon> icons);

    void restoreCreatedMailings(List<WorkflowIcon> icons, Workflow existingWorkflow, Admin admin);
	...
	Workflow getWorkflowOrThrow(int workflowId, int companyId);
    ...
    <T extends WorkflowMailingAware> Optional<T> findMailingIcon(int workflowId, int mailingId, Class<T> mailingIconClass);

    /**
     * A shortcut for {@link WorkflowDao#validateDependency(int, int, WorkflowDependency, boolean)} where
     ...
     */
    boolean checkReactionNeedsActiveBinding(WorkflowReaction reaction);

    /**
     * User statuses are required to compose correct sql for email recipients selection.
     */
    List<UserStatus> getProperUserStatusList(WorkflowReaction reaction);
     ...
     */
    List<Integer> getReactedRecipients(WorkflowReaction reaction, boolean excludeLoggedReactions);
     ...
     * See {@link WorkflowReactionDao#getStepsToMake(CompaniesConstraints)} and {@link WorkflowReactionDao#setUselessStepsDone(CompaniesConstraints)}.
     */
    void processPendingReactionSteps(CompaniesConstraints constraints);

    /**
     * See {@link WorkflowDao#getActiveWorkflowsTrackingProfileField(String, int)}.
     *
    ...
    /**
     * See {@link WorkflowDao#getActiveWorkflowsUsingProfileField(String, int)}.
     *
     * @param column the column name of the profile field to check.
     * @param companyId an identifier of the current user's company.
     * @return a list of dependent workflows sorted by {@link Workflow#getWorkflowId()} (descending).
     ...
     */
    void setTargetConditionDependency(Target target, int companyId, int workflowId);
