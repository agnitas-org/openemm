...
public final class MailingCreationOptions {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof MailingCreationOptions options) {
            return options.alwaysCreateNew == alwaysCreateNew &&
                options.mailingListId == mailingListId &&
                Strings.CS.equals(options.targetGroupExtension, targetGroupExtension) &&
                options.createdFromReleased == createdFromReleased &&
                Strings.CS.equals(options.textTemplateStub, textTemplateStub) &&
