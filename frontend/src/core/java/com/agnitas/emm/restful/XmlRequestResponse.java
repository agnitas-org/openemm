...
public class XmlRequestResponse extends BaseRequestResponse {
	...
	private static final Logger logger = LogManager.getLogger(XmlRequestResponse.class);
	...
	public String getString() throws Exception {
		try {
            Document xmlDocument = XmlUtilities.newXxeProtectedDocumentBuilderFactory()
					.newDocumentBuilder()
					.newDocument();
