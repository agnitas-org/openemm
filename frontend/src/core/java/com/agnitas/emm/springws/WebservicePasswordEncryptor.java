...
import com.agnitas.emm.core.admin.encrypt.exception.PasswordEncryptionException;
...
public final class WebservicePasswordEncryptor {
	...
	public String encrypt(String username, String password) {
		try {
			...
			throw new PasswordEncryptionException("Unable to encrypt password for user: %s".formatted(username), e);
		}
	}
	
	private String encryptVersion2(String username, String password) throws Exception {
	...
	public String decrypt(String username, String encryptedPasswordBase64) throws Exception {
		// When migrating to a newer algorithm, implement fallback here
		return decryptVersion2(username, encryptedPasswordBase64);
    }
	
	private String decryptVersion2(String username, String encryptedPasswordBase64) throws Exception {
		final byte[] saltBytes = create8ByteSalt(username);
	...
	private static byte[] create8ByteSalt(String username) {
