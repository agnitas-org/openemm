 ...
 * use{@link WebserviceUserService#saveWebServiceUser(Admin, WebserviceUserDto, boolean)} with non-empty
...
public interface WebserviceUser extends WebserviceUserListItem {
	...
	void setGrantedPermissions(final Set<String> grantedPermissions);
	
	void setGrantedPermissionGroupIDs(final Set<Integer> permissionGroups);
	
	Set<Integer> getGrantedPermissionGroupIDs();
}
