...
public interface WebserviceUserDao {
	 ...
	 */
	WebserviceUser getWebserviceUser(String username);
	 ...
	 */
	void updateUser(WebserviceUser user);
	 ...
	 */
    void createWebserviceUser(WebserviceUserCredential user, int dataSourceId, int bulkSizeLimit);

	/**
	 * Lists all webservice user (active and non-active users).
	 */
	PaginatedList<WebserviceUserListItem> getWebserviceUserList(int companyID, String sortColumn, boolean sortDirectionAscending, int pageNumber, int pageSize);

	PaginatedList<WebserviceUserListItem> getWebserviceUserMasterList(String sortColumn, boolean sortDirectionAscending, int pageNumber, int pageSize);

	PaginatedList<WebserviceUserListItem> getWebserviceUserList(WebserviceUserOverviewFilter filter);
