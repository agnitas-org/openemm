...
import static com.agnitas.emm.core.workflow.service.WorkflowActivationService.DEFAULT_STEPPING;
...
public class OptimizationScheduleServiceImpl implements OptimizationScheduleService {
		...
		for (Mailing testMailing : allMailings) {
			...
			if (testMailing.getMailingType() != MailingType.NORMAL
				...
				throw new MailingAlreadySentException(
						"Mailing has already been sent ! Mailing-ID: "
								+ testMailing.getId());
			}
	...
	@Override
	public void unscheduleOptimization(Optimization optimization)
			throws MaildropDeleteException {
	...
	private List<Mailing> getTestMailings(Optimization optimization) {
	...
	public void setOptimizationCommonService(
			OptimizationCommonService optimizationCommonService) {
