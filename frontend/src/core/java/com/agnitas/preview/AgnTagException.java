...
public class AgnTagException extends RuntimeException {
	...
	private final List<String[]> report; // each element of the report is an array with 3 elements :  [0]=the block which contains the error(s), [1]= the tag which is wrong, [2] = an error description
