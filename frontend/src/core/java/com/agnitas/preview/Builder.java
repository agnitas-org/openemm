...
public class Builder {
	...
	private String	rdirDomainForImages;
	public Builder () {
		mailingID = 0L;
		customerID = 0L;
		selector = null;
	...
	public Builder rdirDomainForImages (String rdirDomainForImages) {
		this.rdirDomainForImages = rdirDomainForImages;
		return this;
	}
	public String rdirDomainForImages () {
		return rdirDomainForImages;
	}
	public String id () {
		return "[" + mailingID + "/" + customerID +
			...
			(isMobile ? "." : "") +
			(lineLength != null && lineLength > 0 ? lineLength : "") +
			(sendDate > 0 ? sendDate : "") +
			(onAnonPreserveLinks ? "$" : "") +
			(rdirDomainForImages != null ? "{i:" + rdirDomainForImages + "}" : "") +
	...
	private String makeTextID(String text) {
		...
		if (text.length() < 32) {
			...
			try {
				...
				StringBuilder buf = new StringBuilder(sha512Digest.getDigestLength());
