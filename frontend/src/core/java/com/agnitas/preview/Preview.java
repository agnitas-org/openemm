...
public interface Preview {
	...
	String ID_RCS = "__rcs__";
	String ID_RCSTITLE = "__rcs_title__";
	String ID_RCSSMS = "__rcs_sms__";
	...
	String makeTextPreview(long mailingId, long customerId, String text, int lineLength);
