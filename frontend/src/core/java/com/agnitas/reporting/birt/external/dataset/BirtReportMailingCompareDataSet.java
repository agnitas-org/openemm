...
//			mailingSummaryDataSet.removeCategoryData(tempTableId, CommonKeys.OPENERS_TRACKED_INDEX);
	...
	public List<BirtReportCompareStatRow> getComparisonData(int tempTableID, String sortBy) {
	 ...
	 */
	private void addSentMailsByMailtypeData(List<Integer> mailingIds, int companyId, int tempTableID, List<BirtReporUtils.BirtReportFigure> figures) {
	...
	private void migrateDataToOwnTempTable(int ownTempTableID, int curMailingTempTableID, Integer mailingId) {
	...
	private void addMailingNamesAndSendDates(List<Integer> mailingIds, int companyId, int tempTableID) {
        if (CollectionUtils.isEmpty(mailingIds)) {
            return;
        }
	...
	@DaoUpdateReturnValueCheck
	private void insertIntoTempTable(int tempTableID, BirtReportCompareStatRow statRow) {
	...
	private List<BirtReportCompareStatRow> getResultsFromTempTable(int tempTableID) {
    ...
    private Map<Map<Integer, Integer>, Map<Integer, BirtReportCompareStatRow>> getCategoriesData(String query, List<Integer> categories, int blockNumber) {
    ...
    public List<BirtReportCompareStatRow> getData(int tempTableID, String sortBy) {
