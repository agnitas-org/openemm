...
public class DevicesStatDataSet extends BIRTDataSet {
	...
	public List<MailingDevicesStatRow> getMailingDevicesStat(int companyId, String selectedTargets, int mailingId, int devicesMax, String language) {
	...
	private static class DeviceMailingStatisticRowMapper implements RowMapper<MailingDevicesStatRow> {

		private final String unknownDeviceName;
		...
		public MailingDevicesStatRow mapRow(ResultSet resultSet, int i) throws SQLException {
            ...
            devRow.setDeviceName(Objects.toString(resultSet.getString("description"), unknownDeviceName));
            devRow.setOpeningsCount(resultSet.getInt("openings"));
			devRow.setClicksCount(resultSet.getInt("clicks"));
