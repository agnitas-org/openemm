...
public class MailingBouncesDataSet extends BIRTDataSet {
	...
	public BouncesAvailableContainer getBouncesWithDetailByMailings(int companyID, String mailings, String lang, String targets, BounceType bounceType, String hiddenTarget) {
	...
	public List<BouncesRow> getBouncesWithDetail(int companyID, int mailingID, String language, String selectedTargets, BounceType bounceType) {
		return getBouncesWithDetail(companyID, mailingID, language, selectedTargets, bounceType, null);
	}

	public List<BouncesRow> getBouncesWithDetail(int companyId, int mailingId, String lang, String targets, BounceType bounceType, String hiddenTarget) {
	...
	private List<BouncesRow> getHardBouncesWithDetail(int companyId, int mailingId, String lang, String targets) {
    ...
    private BouncesRow getSoftBouncesUndelivered(int companyID, int mailingID, String language, int hardTotal) {
