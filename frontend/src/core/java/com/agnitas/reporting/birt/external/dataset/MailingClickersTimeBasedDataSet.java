...
// TODO: GWUA-6950/GWUA-6948: Remove after migration
public class MailingClickersTimeBasedDataSet extends TimeBasedDataSet {

	public List<TimeBasedClickStatRow> getData(int tempTableID) {
	...
	public int prepareData(String keyColumn, Integer id, Integer companyID, String selectedTargets, String startDateString, String endDateString, Boolean hourly, String recipientType) {
		...
		for (Entry<Integer, LightTarget> targetEntry : targetGroups.entrySet()) {
			...
			while (currentStartDate.before(endDate)) {
				...
				for (DeviceClass deviceClass : DeviceClass.getOnlyKnownDeviceClasses()) {
					...
					Map<String, Object> row = selectSingleRow(sql, id, currentStartDate, currentEndDate, deviceClass.getId(), currentStartDate, currentEndDate, deviceClass.getId(), currentStartDate, currentEndDate);
					...
					Map<String, Object> rowAnonymous = selectSingleRow(sqlAnonymous, id, currentStartDate, currentEndDate, deviceClass.getId(), currentStartDate, currentEndDate, deviceClass.getId(), currentStartDate, currentEndDate);
				...
				Map<String, Object> row = selectSingleRow(sql, id, currentStartDate, currentEndDate, currentStartDate, currentEndDate);
				int netValue = toInt(row.get("net"));
				int grossValue = toInt(row.get("gross"));
				...
				Map<String, Object> rowAnonymous = selectSingleRow(sqlAnonymous, id, currentStartDate, currentEndDate, currentStartDate, currentEndDate);
				int anonymousValue = toInt(rowAnonymous.get("value"));
