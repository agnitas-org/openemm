...
public class MailingStatisticDataSet extends BIRTDataSet {
    ...
    private int prepareSummaryReport(int mailingId, int companyId, String targetsStr, String hiddenTargetIdStr,
                                     String recipientType, List<BirtReporUtils.BirtReportFigure> figures, DateFormats dateFormats) {
    ...
    public List<SendStatWithMailingIdRow> getSummaryData(int companyID, String mailings, String targetGroupIds, String figuresOptions) {
        return getSummaryData(companyID, mailings, targetGroupIds, null, figuresOptions, null);
    }

    public List<SendStatWithMailingIdRow> getSummaryData(int companyID, String mailings, String targetGroupIds, String figuresOptions, DateFormats dateFormats) {
        return getSummaryData(companyID, mailings, targetGroupIds, null, figuresOptions, dateFormats);
    }

    public List<SendStatWithMailingIdRow> getSummaryData(int companyID, String mailings, String targetGroupIds, String hiddenTargetGroup, String figuresOptions, DateFormats dateFormats) {
