...
public class MailingSummaryDataSet extends ComparisonBirtDataSet {
     ...
     */
    public int prepareReport(int mailingID, int companyID, String selectedTargetsAsString, String recipientsType, Boolean showSoftbounces, String startDate, String stopDate, Boolean hourScale) {
    ...
    public int prepareReportOptimization(int optimizationID, int companyID, String selectedTargetsAsString, String recipientsType, Boolean showSoftbounces, String startDate, String stopDate, Boolean hourScale) {
    ...
    public void insertDeliveredIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets,
                                             String hiddenTargetSql, String recipientsType, DateFormats dateFormats) {
    ...
    @DaoUpdateReturnValueCheck
    public void insertMailformatsIntoTempTable(int tempTableID, int mailingID, int companyID, List<BirtReporUtils.BirtReportFigure> figures, String startDateString, String endDateString) {
        ...
        if (StringUtils.isNotBlank(startDateString) && StringUtils.isNotBlank(endDateString)) {
            ...
            if (startDateString.contains(":")) {
                parameters.add(parseDate(startDateString, DATE_PARAMETER_FORMAT_WITH_HOUR));
            } else {
                parameters.add(parseDate(startDateString, DATE_PARAMETER_FORMAT));
            }
            if (endDateString.contains(":")) {
                parameters.add(DateUtils.addHours(parseDate(endDateString, DATE_PARAMETER_FORMAT_WITH_HOUR), 1));
            } else {
                parameters.add(DateUtils.addDays(parseDate(endDateString, DATE_PARAMETER_FORMAT), 1));
            }
        }
    ...
    public int prepareDashboardForCharts(int mailingID, int companyID) {
        int tempTableID = createTempTable();
    ...
    public void insertOpenersIntoTempTable(int mailingID, int tempTableID, int companyID, List<LightTarget> targets,
                                           ...
                                           boolean useOwnTargetGroups, DateFormats dateFormats) {
    ...
    @DaoUpdateReturnValueCheck
    public void insertClicksAnonymousIntoTempTable(int mailingID, int tempTableID, int companyID, DateFormats dateFormats) {
    ...
    @DaoUpdateReturnValueCheck
    public void updateRates(int tempTableID, int companyID, List<LightTarget> targets) {
    ...
    private void updateRatesByCategories(int tempTableID, List<Integer> allCategoryIndex, List<Integer> allTargetgroupIndex, List<Integer> categoryIndex) {
    ...
    private void updateDeliveredRatesByCategories(int tempTableID, List<Integer> allCategoryIndex, List<Integer> allTargetgroupIndex, List<Integer> categoryIndex) {
        StringBuilder totalCountQuery = new StringBuilder();
        totalCountQuery
                .append("SELECT a.targetgroup_index, CASE WHEN (SUM(a.value) IS NULL OR SUM(a.value) = 0) THEN -1 ELSE SUM(a.value) END AS total")
                .append(" FROM ").append(getTempTableName(tempTableID)).append(" a")
    ...
    @DaoUpdateReturnValueCheck
    private void insertMailformatRate(int tempTableID, int targetGroupIndex, int categoryIndex) {
        try {
    ...
    public List<MailingSummaryRow> getSummaryData(Integer tempTableID) {
        if (tempTableID == null) {
            logger.error("tempTableID is null in call for getSummaryData");
            throw new IllegalArgumentException("tempTableID is null in call for getSummaryData");
        }
    ...
    public void insertRevenueIntoTempTable(int mailingID, int tempTableID, int companyID, List<LightTarget> targets,
                                           String hiddenTargetSql, DateFormats dateFormats) {
    ...
    public void insertOpenedGrossIntoTempTable(int mailingID, int tempTableID, int companyID, List<LightTarget> targets, DateFormats dateFormats) {
        List<LightTarget> allTargets = getTargetListWithAllSubscriberTarget(targets);
    ...
    @DaoUpdateReturnValueCheck
    public void insertOpenedAnonymousIntoTempTable(int mailingID, int tempTableID, int companyID, DateFormats dateFormats) {
    ...
    public void insertOpenedInvisibleIntoTempTable(int mailingID, int tempTableID, int companyID, List<LightTarget> subTargets,
                                                   String hiddenTargetSql, String recipientsType, boolean useOwnTargetGroups, DateFormats dateFormats) {
    ...
    @DaoUpdateReturnValueCheck
    public void removeCategoryData(int tempTableID, int categoryIndex) {
        String query = "DELETE FROM " + getTempTableName(tempTableID) + " WHERE category_index = ?";
        updateEmbedded(query, categoryIndex);
    }

    @DaoUpdateReturnValueCheck
    private void insertDeliveredMailsCalculated(int tempTableID, int companyID) {
    ...
    @DaoUpdateReturnValueCheck
    private void updateDashboardRates(int tempTableID) {
        String queryTotalSend = "SELECT value FROM " + getTempTableName(tempTableID) + " WHERE targetgroup_index = ? AND category_index = ? ";
    ...
    @DaoUpdateReturnValueCheck
    private void insertSoftbouncesUndeliverable(int mailingID, int tempTableID, int companyID, List<LightTarget> targets, String recipientsType, boolean showSoftbounces) {
    ...
    protected void insertSoftbouncesIntoTempTable(int tempTableID, int deliveredMails, LightTarget target, int targetGroupIndex) {
    ...
    protected int selectOpeningClickers(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString) {
    ...
    protected int selectNonOpeningClickers(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString) {
        StringBuilder queryBuilder = new StringBuilder("SELECT COUNT(DISTINCT(r.customer_id)) counter FROM rdirlog_" + companyID + "_tbl r");
        List<Object> parameters = new ArrayList<>();
    ...
    protected int selectClicks(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString) {
    ...
    protected int selectAnonymousClicks(int companyID, int mailingID, String startDateString, String endDateString) {
        StringBuilder queryBuilder = new StringBuilder("SELECT COUNT(*) AS counter FROM rdirlog_" + companyID + "_tbl r");
        List<Object> parameters = new ArrayList<>();
     ...
     */
    protected Map<DeviceClass, Integer> selectClickersByDeviceClassWithoutCombinations(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString) {
    ...
    protected int selectClickers(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString) {
     ...
     */
    protected Map<DeviceClass, Integer> selectOpenersByDeviceClassWithoutCombinations(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString) {
    ...
    protected int selectOpeners(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString, int[] deviceIDs) {
    ...
    protected int selectOpenings(int companyID, int mailingID, String recipientsType, String targetSql, String startDateString, String endDateString) {
    ...
    protected int selectAnonymousOpenings(int companyID, int mailingID, String startDateString, String endDateString) {
        StringBuilder queryBuilder = new StringBuilder("SELECT COUNT(*) AS counter FROM onepixellog_device_" + companyID + "_tbl o");
        List<Object> parameters = new ArrayList<>();
    ...
    private int getTempTableValuesByCategoryAndTargetGroupId(int tempTableID, String category, int targetGroupId) {
        ...
        try {
            ...
            logger.error("No data found for category: {}, targetId: {}", category, targetGroupId);
            value = 0;
        }
        return value;
    }
    ...
    private void insertIntoTempTable(int tempTableID, List<TempRow> rows) {
    ...
    private void insertIntoTempTable(int tempTableID, String category, int categoryIndex, String targetgroup, int targetgroupId, int targetgroupIndex, int value, int partialValue) {
    ...
    private List<MailingSummaryRow> getResultsFromTempTable(int tempTableID) {
    ...
    protected Map<Integer, Integer> getMeasuredFromTempTable(int tempTableId) {
    ...
    protected double selectRevenue(int companyID, int mailingID, String targetSql, String startDateString, String endDateString) {
    ...
    protected int selectOptOuts(int companyID, int mailingID, String targetSql, String recipientsType, String startDateString, String endDateString) {
     ...
     */
    protected int selectSoftbouncesFromBindings(int companyID, int mailingID, String targetSql, String recipientsType, String startDateString, String endDateString) {
     ...
     */
    protected int selectHardbouncesFromBindings(int companyID, int mailingID, String targetSql, String recipientsType, String startDateString, String endDateString) {
     ...
     */
    protected int selectSoftbouncesFromBounces(int companyID, int mailingID, String targetSql, String recipientsType, String startDateString, String endDateString) {
     ...
     */
    protected int selectHardbouncesFromBounces(int companyID, int mailingID, String targetSql, String recipientsType, String startDateString, String endDateString) {
