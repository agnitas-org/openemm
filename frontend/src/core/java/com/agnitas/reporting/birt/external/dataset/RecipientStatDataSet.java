...
public class RecipientStatDataSet extends RecipientsBasedDataSet {
	...
	public List<RecipientDoiRow> getRecipientsDoiData(int companyId, Integer mailinglistId, String startDateStr, String stopDateStr) {
    ...
    public List<RecipientDetailRow> getRecipientDetails(int companyID, String targetID,
			...
			String stopDateString, Boolean hourScale, String hiddenFilterTargetId) {
    	List<Object> parameters = new ArrayList<>();
    	...
    	if (hourScale) {
    		...
    		endDate = DateUtils.addDays(parseDate(stopDateString, "yyyy-MM-dd"), 1);
    		parameters.add(endDate);
    	}
