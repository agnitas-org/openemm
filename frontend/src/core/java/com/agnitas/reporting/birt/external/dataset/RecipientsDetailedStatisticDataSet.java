...
public class RecipientsDetailedStatisticDataSet extends RecipientsBasedDataSet {
     ...
     */
    public void initRecipientsStatistic(int companyId, String selectedMailingLists, String selectedTargetsAsString,
                                        String startDate, String stopDate, String hiddenFilterTargetIdStr) {
        ...
        Date dateStart = parseDate(startDate, YYYY_MM_DD);
        Date dateStop = parseDate(stopDate, YYYY_MM_DD);
     ...
     */
    public void initRecipientsDynamicStatistic(int companyId, String selectedMailingLists, String selectedTargetsAsString,
                                               String startDate, String stopDate, String hiddenFilterTargetIdStr) {
        List<Integer> mailingListIds = new ArrayList<>();
        for (String mailingListIdString : selectedMailingLists.split(",")) {
            mailingListIds.add(NumberUtils.toInt(mailingListIdString));
    ...
    private List<RecipientsDetailedStatisticsRow> getRecipientDetailedStat(int companyId, int mailinglistId,
                                                                           String mailinglistName, int mailinglistIndex, LightTarget target,
                                                                           int targetGroupIndex, Date startDate, Date endDate,
