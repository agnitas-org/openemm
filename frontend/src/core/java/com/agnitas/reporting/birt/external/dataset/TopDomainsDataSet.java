...
// TODO check usage and remove after GWUA-6951
public class TopDomainsDataSet extends BIRTDataSet {
	...
	public List<SendPerDomainStatRow> getStat(String mailingsCsv, int companyId, String targetsCsv, int maxDomains, String lang, boolean topLevelDomain) {
	 ...
	 */
	public int prepareReport(int mailingID, int companyID, String selectedTargetsAsString, int domainsMax, String language, boolean topLevelDomains) {
	...
	public List<SendPerDomainStatRow> getResultsFromTempTable(int tempTableID) {
	...
	private void insertSentStatIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets, String language, int domainsMax, boolean topLevelDomains, boolean mailingTrackingDataAvailable) {
	...
	private void insertBouncesIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets, String language, int domainsMax, boolean topLevelDomains) {
	...
	private void insertHardBouncesIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets, String language, int domainsMax, boolean topLevelDomains) {
		insertBouncesIntoTempTable(tempTableID, mailingID, companyID, targets, language, domainsMax, topLevelDomains,
				new Rule("bounce.detail >= 510", CATEGORY_NAME_HARDBOUNCES, CATEGORY_HARDBOUNCES));

	}
	
	private void insertSoftBouncesIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets, String language, int domainsMax, boolean topLevelDomains) {
		insertBouncesIntoTempTable(tempTableID, mailingID, companyID, targets, language, domainsMax, topLevelDomains,
	...
	private void insertBouncesIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets, String language, int domainsMax, boolean topLevelDomains, Rule rule) {
		Map<Integer, TempRow> otherDomainsMap = new HashMap<>();
	...
	private void insertOpenersIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets, String language, int domainsMax, boolean topLevelDomains) {
		Map<Integer, TempRow> otherDomainsMap = new HashMap<>();
	...
	@DaoUpdateReturnValueCheck
	private void insertClickersIntoTempTable(int tempTableID, int mailingID, int companyID, List<LightTarget> targets, String language, int domainsMax, boolean topLevelDomains) {
		Map<Integer, TempRow> otherDomainsMap = new HashMap<>();
	...
	private void updateRates(int tempTableID, int targetGroupIndex, int base, int... categories) {
		...
		sqlUpdateRatesBuilder.append(" WHERE category_index IN (")
				.append(StringUtils.join(ArrayUtils.toObject(categories), ", "))
				.append(") AND targetgroup_index = ?");

		updateEmbedded(sqlUpdateRatesBuilder.toString(), targetGroupIndex);
	}

	private int getTotalSentEmails(int tempTableID, int targetGroupIndex) {
	...
	private int getTotalClickers(int tempTableID, int targetGroupIndex) {
	...
	private int getTotalOpeners(int tempTableID, int targetGroupIndex) {
	...
	private void insertIntoTempTable(int tempTableID, TempRow row) {
