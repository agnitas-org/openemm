...
public class TotalOptimizationDataSet extends MailingSummaryDataSet {
	 ...
	 */
	public void prepareOptimizationReport(int optimizationId, int companyId, Boolean showSoftbounces) {
	 ...
	 */
	private int prepareOptimizationMailingsData(int optimizationId, int companyId) {
	...
	private int prepareTotalOptimizationSummaryData(int companyID, Boolean showSoftbounces) {
	...
	public List<OptimizationMailingData> getOptimizationMailings() {
	...
	public List<OptimizationMailingSummaryRow> getTotalOptimizationSummaryData() {
		String query = "SELECT " +
    ...
    protected String getSubjectFromMTParam(String mtParam) {
        ...
        return Objects.toString(com.agnitas.reporting.birt.external.utils.StringUtils.findParam("subject", mtParam), "");
    }
	...
	@DaoUpdateReturnValueCheck
	private void insertDeliveredIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSQL) {
		int mailingId = data.getMailingId();
	...
	@DaoUpdateReturnValueCheck
	private void insertRevenueIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSQL) {
	...
	@DaoUpdateReturnValueCheck
	private void insertOptOutsIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSQL) {
		int mailingId = data.getMailingId();
	...
	@DaoUpdateReturnValueCheck
	private void insertSoftbouncesUndeliverable(int tempTableID, OptimizationMailingData data, int companyID, boolean showSoftbounces) {
	...
	@DaoUpdateReturnValueCheck
	private void insertBouncesIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSQL) {
        int mailingId = data.getMailingId();
		int hardbounces;
	...
	@DaoUpdateReturnValueCheck
	private void insertOpenedAnonymousIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID) {
	...
	@DaoUpdateReturnValueCheck
	private void insertOpenedGrossIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSQL) {
	...
	@DaoUpdateReturnValueCheck
	private void insertOpenedInvisibleIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSQL) {
		int mailingId = data.getMailingId();
	...
	private void insertOpenersIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSQL) {
        int mailingId = data.getMailingId();
	...
	@DaoUpdateReturnValueCheck
	private void insertClicksAnonymousIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID) {
	...
	@DaoUpdateReturnValueCheck
	public int insertSendIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSql) {
	...
	@DaoUpdateReturnValueCheck
	public void insertClickersIntoTempTable(int tempTableID, OptimizationMailingData data, int companyID, String targetSql, String recipientsType, String startDate, String endDate) {
        int mailingId = data.getMailingId();
	...
	private void insertIntoSummaryTempTable(int tempTableID, String category, int categoryIndex, int mailingId, int value, int groupId) {
	...
	private void insertOptimizationMailingData(int tempTableID, OptimizationMailingData mailing) {
		String insertSql = "INSERT INTO tmp_report_aggregation_" + tempTableID + "_tbl " +
