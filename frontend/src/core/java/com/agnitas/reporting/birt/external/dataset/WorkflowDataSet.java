...
public class WorkflowDataSet extends TotalOptimizationDataSet {
     ...
     */
    public void prepareWorkflowReport(int workflowId, int companyId, Boolean showSoftbounces, String startDate, String endDate) {
    ...
    private int prepareWorkflowMailingsData(int workflowId, int companyId) {
    ...
    private int prepareTotalWorkflowSummaryData(int companyID, Boolean showSoftbounces, String startDate, String endDate) {
    ...
    public String getMailingNameBySortOrder(int order) {
    ...
    public Integer getSortOrderByMailingName(String name) {
        return selectEmbedded(
    ...
    public List<WorkflowMailingData> getWorkflowMailings() {
        String sql = """
    ...
    public List<WorkflowMailingSummaryRow> getTotalWorkflowSummaryData() {
        String query = """
    ...
    @Override
    public void updateRates(int tempTableID, List<Integer> mailingIds) {
    ...
    private void updateRatesByCategories(int tempTableID, List<Integer> allCategoryIndex, List<Integer> mailingIds, List<Integer> categoryIndex) {
        String tableName = getTemporaryTableName(tempTableID);
    ...
    private void updateDeliveredRatesByCategories(int tempTableID, List<Integer> allCategoryIndex, List<Integer> mailingIds, List<Integer> categoryIndex) {
        String tableName = getTemporaryTableName(tempTableID);
    ...
    @DaoUpdateReturnValueCheck
    private void insertDeliveredIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSQL, String startDate, String endDate) {
        int mailingId = data.getMailingId();
    ...
    @DaoUpdateReturnValueCheck
    private void insertRevenueIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSQL, String startDate, String endDate) {
    ...
    @DaoUpdateReturnValueCheck
    private void insertOptOutsIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSQL, String startDate, String endDate) {
        int mailingId = data.getMailingId();
    ...
    @DaoUpdateReturnValueCheck
    private void insertSoftbouncesUndeliverable(int tempTableID, WorkflowMailingData data, int companyID, boolean showSoftbounces, String startDate, String endDate) {
    ...
    private int getTempTableValuesByCategoryAndMailingId(int tempTableID, String category, int mailingId) {
        try {
            return selectEmbedded(
    ...
    @DaoUpdateReturnValueCheck
    private void insertBouncesIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSQL, String startDate, String endDate) {
        int mailingId = data.getMailingId();
        int hardbounces;
    ...
    @DaoUpdateReturnValueCheck
    private void insertOpenedAnonymousIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String startDate, String endDate) {
    ...
    @DaoUpdateReturnValueCheck
    private void insertOpenedGrossIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSQL, String startDate, String endDate) {
    ...
    @DaoUpdateReturnValueCheck
    private void insertOpenedInvisibleIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSQL, String startDate, String endDate) {
        int mailingId = data.getMailingId();
    ...
    private void insertOpenersIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSQL, String startDate, String endDate) {
        int mailingId = data.getMailingId();
    ...
    @DaoUpdateReturnValueCheck
    private void insertClicksAnonymousIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String startDate, String endDate) {
    ...
    @DaoUpdateReturnValueCheck
    public int insertSendIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSql, String startDate, String endDate) {
    ...
    @DaoUpdateReturnValueCheck
    public void insertClickersIntoTempTable(int tempTableID, WorkflowMailingData data, int companyID, String targetSql, String recipientsType, String startDate, String endDate) {
        int mailingId = data.getMailingId();
    ...
    @Override
    public int createSummaryTempTable() {
    ...
    private void insertIntoSummaryTempTable(int tempTableID, String category, int categoryIndex, int mailingId, int value, int order) {
    ...
    private void insertTotalValueByCategories(int tempTableID, List<Integer> mailingIds) {
        String tableName = getTemporaryTableName(tempTableID);
    ...
    private void insertWorkflowMailingData(int tempTableID, WorkflowMailingData mailing) {
        String insertSql = """
