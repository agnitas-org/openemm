...
public final class ExpirationUtils {
    ...
    @SuppressWarnings("unused") // used in mailing_summary.rptdesign
    public static boolean isDateOlderThenDays(String statPeriodStartDateStr, int expirationPeriodDays) {
        ...
        return isDateOlderThenDays(expirationPeriodDays, statPeriodStartDate);
    }

    public static boolean isDateOlderThenDays(int expirationPeriodDays, LocalDate statPeriodStartDate) {
