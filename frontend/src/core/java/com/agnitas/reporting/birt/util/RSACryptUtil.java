...
public class RSACryptUtil {
	...
	public static byte[] encrypt(byte[] text, String publicKey) throws GeneralSecurityException {
	 ...
	 */
	public static String encrypt(String text, String publicKey) throws GeneralSecurityException {
		try {
	 ...
	 * @return Encrypted text encoded as BASE64
	 */
	public static String encryptUrlSafe(String text, String publicKey) throws GeneralSecurityException {
		byte[] cipherText = encrypt(text.getBytes(StandardCharsets.UTF_8), publicKey);
	 ...
	 */
	public static byte[] decrypt(byte[] text, String privateKey) throws GeneralSecurityException {
	 ...
	 */
	public static String decrypt(String text, String privateKey) throws GeneralSecurityException {
		try {
			// decrypt the text using the private key
	...
	public static PrivateKey getPrivateKeyFromString(String key) throws GeneralSecurityException {
		...
		EncodedKeySpec privateKeySpec = new PKCS8EncodedKeySpec(Base64.decodeBase64(key.getBytes(StandardCharsets.UTF_8)));
	...
	public static PublicKey getPublicKeyFromString(String key) throws GeneralSecurityException {
		KeyFactory keyFactory = KeyFactory.getInstance(ALGORITHM, CryptographicUtilities.BOUNCY_CASTLE_PROVIDER);
		EncodedKeySpec publicKeySpec = new X509EncodedKeySpec(Base64.decodeBase64(key.getBytes(StandardCharsets.UTF_8)));
	...
	private static byte[] decodeBASE64(String text) {
		return Base64.decodeBase64(text.getBytes(StandardCharsets.UTF_8));
	}
