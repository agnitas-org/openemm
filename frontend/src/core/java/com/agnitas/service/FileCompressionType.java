...
public enum FileCompressionType {
	...
	FileCompressionType(String defaultFileExtension) {
		this.defaultFileExtension = defaultFileExtension;
	}

	public static FileCompressionType getFromString(String compressionTypeString) {
		...
		throw new IllegalArgumentException("Invalid compression type: " + compressionTypeString);
	}
