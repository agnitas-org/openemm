...
public class ServiceResult<T> {
    ...
    public static <R> ServiceResult<R> from(ServiceResult<?> serviceResult, R result) {
        return new ServiceResult<>(
                result,
                serviceResult.isSuccess(),
                serviceResult.getSuccessMessages(),
                serviceResult.getWarningMessages(),
                serviceResult.getErrorMessages(),
                serviceResult.getInfoMessages()
        );
    }
