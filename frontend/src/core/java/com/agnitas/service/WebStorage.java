...
import com.agnitas.emm.core.recipient.dto.ProfileFieldOverviewWebStorageEntry;
...
public interface WebStorage {
    ...
    WebStorageBundle<ProfileFieldOverviewWebStorageEntry> PROFILE_FIELD_OVERVIEW = WebStorageBundle.define("profile-field-overview", ProfileFieldOverviewWebStorageEntry.class);
    ...
    WebStorageBundle<SortingWebStorageEntry> RESPONSE_INBOX_OVERVIEW = WebStorageBundle.define("response-inbox-overview", SortingWebStorageEntry.class);
