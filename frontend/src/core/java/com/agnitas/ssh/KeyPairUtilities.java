...
public class KeyPairUtilities {
	 ...
	 */
	public static String getAlgorithm(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
			...
			throw new IllegalArgumentException("KeyPair data is empty");
		}
	}
	 ...
	 * "ecdsa-sha2-nistp256" or "ecdsa-sha2-nistp384" or "ecdsa-sha2-nistp521" for ECDSA key<br />
	 */
	public static String getAlgorithm(PublicKey publicKey) throws Exception {
		if (publicKey == null){
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
			...
			throw new IllegalArgumentException("Unsupported ssh algorithm name: " + publicKey.getAlgorithm());
		}
	}
	 ...
	 * "ecdsa-sha2-nistp256" or "ecdsa-sha2-nistp384" or "ecdsa-sha2-nistp521" for ECDSA key<br />
	 */
	public static String getAlgorithm(PrivateKey privateKey) throws Exception {
		if (privateKey == null){
			throw new IllegalArgumentException("Invalid empty privateKey parameter");
	...
	public static int getKeyStrength(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static int getKeyStrength(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
	...
	public static byte[] getPublicKeyBytes(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
	...
	public static String getMd5Fingerprint(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getMd5Fingerprint(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha1Fingerprint(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha1Fingerprint(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha1FingerprintBase64(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha1FingerprintBase64(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha256Fingerprint(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha256Fingerprint(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha256FingerprintBase64(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha256FingerprintBase64(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha384Fingerprint(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha384Fingerprint(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha384FingerprintBase64(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha384FingerprintBase64(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha512Fingerprint(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha512Fingerprint(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String getSha512FingerprintBase64(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else {
	...
	public static String getSha512FingerprintBase64(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
			try {
	...
	public static String encodePublicKeyForAuthorizedKeys(KeyPair keyPair) throws Exception {
		if (keyPair == null) {
			throw new IllegalArgumentException("Invalid empty keyPair parameter");
		} else if (keyPair.getPublic() == null) {
			throw new IllegalArgumentException("Missing public key for AuthorizedKey string generation");
		} else {
			return encodePublicKeyForAuthorizedKeys(keyPair.getPublic());
		}
	}

	public static String encodePublicKeyForAuthorizedKeys(PublicKey publicKey) throws Exception {
		if (publicKey == null) {
			throw new IllegalArgumentException("Invalid empty publicKey parameter");
		} else {
	...
	private static class BlockDataWriter {
		...
		private void writeBigInt(BigInteger bigIntegerData) {
			writeData(bigIntegerData.toByteArray());
		}

		private void writeString(String stringData) {
		...
		private void writeData(byte[] data) {
			try {
				if (data.length <= 0) {
					throw new IllegalArgumentException("Key blocksize error");
				}

				keyDataOutput.writeInt(data.length);
				keyDataOutput.write(data);
			} catch (IOException e) {
				throw new UncheckedIOException("Key block write error", e);
			}
		}
