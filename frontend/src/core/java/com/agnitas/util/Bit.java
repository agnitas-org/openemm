...
public class Bit {
	 ...
	 */
	public static boolean isset (long value, int ... bits) {
	 ...
	 */
	public static long set (long value, int ... bits) {
	 ...
	 */
	public static long clr (long value, int ... bits) {
		return value & (~ createBitmask (bits));
	}

	public static int clr (int value, int ... bits) {
		return value & (~ ((int) createBitmask (bits)));
	}
}
