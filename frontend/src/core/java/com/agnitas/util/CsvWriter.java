...
public class CsvWriter implements Closeable {
	...
	public CsvWriter(OutputStream outputStream) {
		this(outputStream, StandardCharsets.UTF_8, DEFAULT_SEPARATOR, DEFAULT_STRING_QUOTE, DEFAULT_LINEBREAK);
	}
	...
	public CsvWriter(OutputStream outputStream, char separator) {
		this(outputStream, StandardCharsets.UTF_8, separator, DEFAULT_STRING_QUOTE, DEFAULT_LINEBREAK);
	}
	...
	public CsvWriter(OutputStream outputStream, char separator, Character stringQuote) {
		this(outputStream, StandardCharsets.UTF_8, separator, stringQuote, DEFAULT_LINEBREAK);
	}
	...
	public CsvWriter(OutputStream outputStream, char separator, Character stringQuote, String lineBreak) {
		this(outputStream, StandardCharsets.UTF_8, separator, stringQuote, lineBreak);
	}
	...
	public CsvWriter(OutputStream outputStream, String encoding, char separator, Character stringQuote) {
		this(outputStream, StringUtils.isBlank(encoding) ? StandardCharsets.UTF_8 : Charset.forName(encoding), separator, stringQuote == null ? DEFAULT_STRING_QUOTE : stringQuote, DEFAULT_LINEBREAK);
	}
	 ...
	 */
	public void writeValues(List<?> values) throws CsvDataException, IOException {
	 ...
	 *             the exception
	 */
	public void writeAll(List<? extends List<?>> valueLines) throws Exception {
		for (List<?> valuesOfLine : valueLines) {
	...
	public static byte[] csv(List<? extends List<?>> rows) throws Exception {
