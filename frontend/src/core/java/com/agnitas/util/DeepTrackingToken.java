...
public class DeepTrackingToken {
	 ...
	 */
	private static final long XOR_KEY = 568565;
	
	private static final long HEX_KEY = 0x5CF16053L;
	...
	private String createDataHashWithXorKeySHA512() throws Exception {
		try {
			...
			sha512Digest.reset();
			sha512Digest.update(hashBase.toString().getBytes(StandardCharsets.US_ASCII));
