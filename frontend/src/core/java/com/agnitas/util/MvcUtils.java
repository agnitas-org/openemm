...
public final class MvcUtils {
    ...
    public static ResponseEntity<InputStreamResource> csvFileResponse(byte[] data, String filename) {
        return getFileResponse(data, filename, MediaType.parseMediaType("application/csv"));
    }

    public static ResponseEntity<InputStreamResource> jsonFileResponse(byte[] data, String filename) {
        return getFileResponse(data, filename, MediaType.APPLICATION_JSON);
    }

    public static ResponseEntity<InputStreamResource> zipFileResponse(byte[] data, String filename) {
        return getFileResponse(data, filename, MediaType.parseMediaType("application/zip"));
    }

    private static ResponseEntity<InputStreamResource> getFileResponse(byte[] data, String filename, MediaType mediaType) {
