...
public class PunycodeCodec {
	...
	private PunycodeCodec() {

	}

	private static final Pattern DOMAIN_FROM_LINK_PATTERN = Pattern.compile("^([^:]+://)([^/?;#]*)([/?;#].*)?$");

	public static String encodeDomainName(String domainName) {
		if (domainName == null) {
			return null;
		} else {
	 ...
	 */
	public static String decodeDomainName(String domainNameToDecode) {
	...
	public static final String encodeDomainInLink(final String fullUrl) {
