...
public class ResetServerCommandsContextListener implements ServletContextListener {
	...
	private static final Logger logger = LogManager.getLogger(ResetServerCommandsContextListener.class);
    ...
    public void contextInitialized(ServletContextEvent event) {
        try {
			...
			ServerMessageDao serverMessageDao = (ServerMessageDao) springContext.getBean("ServerMessageDao");
