...
public class Substitute {
	 ...
	 */
	public final void put (Object variable, Object value) {
	 ...
	 */
	public final String replace (String str, Map <String, String> extra, List <String> missing) {
		if (str == null) {
			return str;
		}
	...
	public final String replace (String str, Map <String, String> extra) {
