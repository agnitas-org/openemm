...
public class Version implements Comparable<Version> {
	...
	public static Version of(String versionStr) {
		try {
			...
			throw new IllegalArgumentException("Invalid version string: " + versionStr, e);
		}
	}
	...
	public Version truncateToMinor() {
		this.microVersion = 0;
	...
	public boolean isLTS() {
		...
		if (minorVersion == 11 || minorVersion == 5) {
			return true;
		}

		return microVersion == 0 && hotfixVersion > 0;
	}

	public String getShortVersion() {
		return "%d.%02d".formatted(majorVersion, minorVersion);
	}
	...
	public boolean equals(Object o) {
		...
		return majorVersion == version.majorVersion && minorVersion == version.minorVersion
				&& microVersion == version.microVersion && hotfixVersion == version.hotfixVersion
				&& legacyFormat == version.legacyFormat;
	}

	@Override
	public int hashCode() {
		return Objects.hash(majorVersion, minorVersion, microVersion, hotfixVersion, legacyFormat);
	}
