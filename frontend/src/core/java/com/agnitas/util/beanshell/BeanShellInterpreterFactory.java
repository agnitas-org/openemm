					...
					if (resultSet.next()) {
						for (int i = 1; i <= resultMetaData.getColumnCount(); i++) {
							...
							try {
								...
								case java.sql.Types.BIGINT, java.sql.Types.INTEGER, java.sql.Types.NUMERIC, java.sql.Types.SMALLINT, java.sql.Types.TINYINT:
								...
								case java.sql.Types.DECIMAL, java.sql.Types.DOUBLE, java.sql.Types.FLOAT:
									if (resultSet.getObject(i) != null) {
								...
								case java.sql.Types.CHAR, java.sql.Types.LONGVARCHAR, java.sql.Types.VARCHAR:
