...
public enum TextRecognitionChar {
	...
	public static TextRecognitionChar getTextRecognitionCharById(int id) {
		for (TextRecognitionChar item : TextRecognitionChar.values()) {
			if (item.getIntValue() == id) {
				return item;
			}
		}
		throw new IllegalArgumentException("Invalid int value for TextRecognitionChar");
	}

	public static TextRecognitionChar getTextRecognitionCharByChar(Character textRecognitionChar) {
		for (TextRecognitionChar item : TextRecognitionChar.values()) {
		...
		throw new IllegalArgumentException("Invalid TextRecognitionChar char");
	}

	public static TextRecognitionChar getTextRecognitionCharByString(String textRecognitionCharString) {
