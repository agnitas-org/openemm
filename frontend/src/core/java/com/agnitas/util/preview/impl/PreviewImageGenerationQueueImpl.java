...
public class PreviewImageGenerationQueueImpl implements PreviewImageGenerationQueue {
    ...
    private static final Logger logger = LogManager.getLogger(PreviewImageGenerationQueueImpl.class);
    ...
    private final ConcurrentMap<String, PreviewImageGenerationTask> schedule = new ConcurrentHashMap<>();
    ...
    private class WrapperTask implements Runnable {
        ...
        private final PreviewImageGenerationTask task;
