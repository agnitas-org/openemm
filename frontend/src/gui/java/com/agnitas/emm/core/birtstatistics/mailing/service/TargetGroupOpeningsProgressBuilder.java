...
public class TargetGroupOpeningsProgressBuilder extends TargetGroupEventProgressBuilder {

    private final MailingProgressStatsDao progressStatsDao;

    protected TargetGroupOpeningsProgressBuilder(
        ...
        super(mailingId, companyId, dateRange, targets, hourScale);
    ...
    protected CustomerEventStats getMultiDeviceCounts(MailingProgressStatisticFilter filter) {
        return progressStatsDao.getMultiDeviceOpensStats(filter);
    }

    @Override
    protected CustomerEventStats getSingleDeviceCounts(MailingProgressStatisticFilter filter) {
        return progressStatsDao.getSingleDeviceOpensStats(filter);
    }
