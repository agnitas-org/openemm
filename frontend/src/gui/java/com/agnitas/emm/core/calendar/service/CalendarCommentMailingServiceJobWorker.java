 ...
 *    VALUES ((SELECT MAX(id) + 1 FROM job_queue_tbl), 'CalendarCommentMailingService', CURRENT_TIMESTAMP, NULL, 0, 'OK', 0, 0, '**00', CURRENT_TIMESTAMP, NULL, 'CalendarCommentMailingService', 1);
 */
...
public class CalendarCommentMailingServiceJobWorker extends JobWorkerBase {
	...
	public String runJob() {
        serviceLookupFactory.getBeanCalendarReminderService().send();
		return null;
    }
