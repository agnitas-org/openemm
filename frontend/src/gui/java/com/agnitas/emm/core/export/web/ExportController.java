...
public class ExportController implements XssCheckAware {
    ...
    private String redirectToView(int id) {
    ...
    private String getRecipientTypeByLetter(String letter) {
        return switch (letter) {
            ...
            case "T" -> "Test recipient";
            case "W" -> "Normal recipient";
            default -> "not set";
        };
    }
    ...
    private String getRecipientStatusById(int statusId) {
        return switch (statusId) {
            ...
            case 1 -> "Active";
            case 2 -> "Bounced";
            case 3 -> "Opt-Out by admin";
            case 4 -> "Opt-Out by recipient";
            case 5 -> "Waiting for user confirmation";
            case 6 -> "blacklisted";
            case 7 -> "suspended";
            default -> "not set";
        };
