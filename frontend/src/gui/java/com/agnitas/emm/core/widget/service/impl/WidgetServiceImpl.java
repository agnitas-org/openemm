...
import com.agnitas.emm.core.widget.exception.WidgetTokenGenerationException;
...
public class WidgetServiceImpl implements WidgetService {
    ...
    @Override
    public String generateToken(WidgetType widgetType, WidgetSettingsBase settings, int companyId) {
        ...
        try {
            ...
            throw new WidgetTokenGenerationException(
                    "Widget token generation failed! Type: %s, Company: %d".formatted(widgetType, companyId),
                    e
            );
        }
    }
