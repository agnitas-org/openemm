...
public class WidgetController implements XssCheckAware {
    ...
    public ResponseEntity<DataResponseDto<String>> generateSubscribeToken(SubscribeWidgetSettingsForm form, Admin admin, Popups popups) {
    ...
    public String viewWidget(@RequestParam String token) {
        ...
        if (widgetType == WidgetType.SUBSCRIBE) {
