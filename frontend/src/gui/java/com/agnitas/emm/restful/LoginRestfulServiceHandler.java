 ...
 */
@Component("RestfulServiceHandler_login")
public class LoginRestfulServiceHandler implements RestfulServiceHandler {
    ...
    public LoginRestfulServiceHandler(RestfulUserActivityLogDao restfulUserActivityLogDao, ConfigService configService) {
