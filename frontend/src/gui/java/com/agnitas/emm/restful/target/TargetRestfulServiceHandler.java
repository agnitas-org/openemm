...
public class TargetRestfulServiceHandler implements RestfulServiceHandler {
	...
	protected final RestfulUserActivityLogDao userActivityLogDao;
	protected final TargetService targetService;
	protected final TargetDao targetDao;
	protected final RecipientDao recipientDao;
	protected final ColumnInfoService columnInfoService;
	protected final ConfigService configService;

    public TargetRestfulServiceHandler(
	...
	public boolean isParameterExcludedForUnsafeHtmlTagCheck(Admin admin, String parameter, HttpServletRequest request) {
		return List.of("eql", "sql").contains(parameter) && configService.allowHtmlInReferenceAndProfileFields(admin.getCompanyID());
	}

	@Override
	public boolean isBodyPropertyExcludedForUnsafeHtmlTagCheck(Admin admin, String property, HttpServletRequest request) {
		return List.of("eql", "sql").contains(property) && configService.allowHtmlInReferenceAndProfileFields(admin.getCompanyID());
	}
