 ...
 */
@Component("RestfulServiceHandler_workflow")
public class WorkflowRestfulServiceHandler implements RestfulServiceHandler {
	...
	public void resumeWorkflow(Admin admin, Workflow workflow) {
		...
		workflowActivationService.resume(workflow.getWorkflowId(), admin);
