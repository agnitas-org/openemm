...
public class AgnitasSassConnectionFactory {
    ...
    private AgnitasSassConnectionFactory() {
    ...
    public static ProcessConnection bundled(File sassExecutableTempDirPath) throws IOException {
        return ConnectionFactory.ofExecutable(getBundledDartExec(sassExecutableTempDirPath));
    }
    ...
    static synchronized void extractBundled(File sassExecutableTempDirPath) throws IOException {
