...
public class TableTag extends BodyTagSupport {
    ...
    protected SortDirection getNextSortDir(String sortProperty) {
        if (!Strings.CS.equals(sortProperty, getSortCriterion())) {
    ...
    protected boolean isSortedBy(String property) {
        return Strings.CS.equals(property, getSortCriterion());
    }
    ...
    private void initDecorator() {
        try {
            ...
            throw new IllegalStateException("Unable to instantiate table decorator: " + decoratorClassName, e);
        }
    }
