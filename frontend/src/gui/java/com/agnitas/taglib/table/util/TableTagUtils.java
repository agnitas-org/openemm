...
public class TableTagUtils {
    ...
    public static Class<?> getPropertyType(String name, Object item) {
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot determine type of property '%s' for object of type %s".formatted(name, item.getClass().getName()),
                    e
            );
        }
    }
    ...
    public static Object getPropertyValue(Object bean, String property) {
        ...
        try {
            ...
            throw new IllegalArgumentException(
                    "Cannot read property '%s' from object of type %s".formatted(property, bean.getClass().getName()),
                    e
            );
        }
    }
    ...
    public static String buildUrl(String url, Map<String, String> params) {
        try {
            ...
            logger.error("Can't build url! Request URI: {}, Params: {}", url, params);
