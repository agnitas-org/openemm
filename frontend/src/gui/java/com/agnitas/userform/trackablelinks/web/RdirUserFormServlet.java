...
public class RdirUserFormServlet extends HttpServlet {
	...
	private transient FormTrackableLinkDao formTrackableLinkDao;
	...
	private transient MailingContentTypeCache mailingContentTypeCache;
	private transient RecipientFactory recipientFactory;
	...
	public void service(HttpServletRequest request, HttpServletResponse res) throws IOException {
		...
		if (trackableUserFormLink.getProperties() != null && !trackableUserFormLink.getProperties().isEmpty()) {
