 ...
 *    VALUES ((SELECT MAX(id) + 1 FROM job_queue_tbl), 'LoginTrackTableCleaner', CURRENT_TIMESTAMP, NULL, 0, 'OK', 0, 0, '0400', CURRENT_TIMESTAMP, NULL, 'LoginTrackTableCleaner', 1);
 * 
 *  Optional:
...
public class LoginTrackTableCleanerJobWorker extends AbstractLoginTrackTableCleanerJobWorker {
	...
	private static final Logger LOGGER = LogManager.getLogger(LoginTrackTableCleanerJobWorker.class);
