...
public class AnonymousViewServlet extends HttpServlet {
	...
	private void logClick(PubID pubId, String ipAddress) {
		...
		try {
            ...
            logger.error("Error inserting into swyn_click_log: source={}, mailingID={}, customerID={}, ipAddress={}",
					pubId.getSource(), pubId.getMailingID(), pubId.getCustomerID(), ipAddress, e);
		}
	}
