...
public class LayoutServlet extends HttpServlet {
	...
	private static final Logger logger = LogManager.getLogger(LayoutServlet.class);

	protected transient LayoutDao layoutDao;
	protected transient EmmLayoutBaseDao emmLayoutBaseDao;
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        try {
			...
			} else if (uriParts.length >= 1 && StringUtils.isNotBlank(uriParts[uriParts.length - 1]) && Strings.CI.startsWith(uriParts[uriParts.length - 1], "favicon.ico")) {
				companyIdString = "0";
