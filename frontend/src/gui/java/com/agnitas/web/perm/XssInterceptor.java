...
public class XssInterceptor implements HandlerInterceptor {
    ...
    private Set<HtmlCheckError> checkForXss(HttpServletRequest request, HandlerMethod handlerMethod) {
    ...
    private RequestParameterXssPreventerHelper getXssPreventHelper(Admin admin, HandlerMethod handlerMethod) {
