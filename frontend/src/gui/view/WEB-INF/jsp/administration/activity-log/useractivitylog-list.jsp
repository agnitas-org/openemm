...
<div class="filter-overview" data-editable-view="${agnEditViewKey}">
    <mvc:form id="table-tile" servletRelativeAction="/administration/useractivitylog/list.action" modelAttribute="filter" cssClass="tile" data-editable-tile="main">
        ...
        <div class="tile-body vstack gap-3 js-scrollable">
            ...
            <div>
                ...
                <mvc:select id="filter-action" path="action" cssClass="form-control">
                    <mvc:option value=""><mvc:message code="UserActivitylog.Any_Action" /></mvc:option>
                    <c:forEach var="action" items="${userActions}">
                        <mvc:option value="${action}">
                            <mvc:message code="${action.messageKey}"/>
                        </mvc:option>
                    </c:forEach>
                </mvc:select>
            </div>
