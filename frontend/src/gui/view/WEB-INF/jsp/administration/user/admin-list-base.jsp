...
<c:url var="deleteUrl"       value="/admin/delete.action">
                    ...
                    <emm:table var="admin" modelAttribute="adminEntries" cssClass="table table-hover table--borderless js-table">
                        ...
                        <c:if test="${deleteAllowed or sendAuthDataAllowed}">
                            ...
                            <emm:column title="${checkboxSelectAll}" cssClass="mobile-hidden" headerClass="mobile-hidden">
                                <input class="form-check-input" type="checkbox" name="bulkIds" value="${admin.id}" autocomplete="off" data-bulk-checkbox />
                            </emm:column>
                        </c:if>
                        ...
                        <emm:column titleKey="admin.login.last" sortable="true" property="loginDate" sortProperty="last_login_date" />
