...
<div id="soap-users-overview" class="tiles-container flex-column" data-editable-view="${agnEditViewKey}">
            ...
            <mvc:form servletRelativeAction="/administration/wsmanager/user/new.action" id="wsuser-creation-form"
                ...
                <div class="row">
                    ...
                    <div class="col" data-field="password">
                        ...
                        <mvc:password path="password" id="newPassword" cssClass="form-control js-password-strength" autocomplete="new-password" data-field="required" size="52" maxlength="99" data-rule="${PASSWORD_POLICY}"/>
                    </div>
    ...
    <div class="tiles-block">
        <mvc:form servletRelativeAction="/administration/wsmanager/users.action" id="table-tile" modelAttribute="filter" cssClass="tile" data-editable-tile="main" method="GET">
                        ...
                        <emm:table var="wsUser" modelAttribute="webserviceUserList" cssClass="table table--borderless js-table table-hover">
                            ...
                            <c:if test="${deleteAllowed}">
                                ...
                                <emm:column title="${checkboxSelectAll}" cssClass="mobile-hidden" headerClass="mobile-hidden">
                                    <input class="form-check-input" type="checkbox" name="usernames" value="${wsUser.userName}" autocomplete="off" data-bulk-checkbox />
                                </emm:column>
                            </c:if>
                            ...
                            <emm:column titleKey="webserviceuser.default_datasource_id" sortable="true" sortProperty="default_data_source_id">
                                <div class="copy-box">
                                    <a href="<c:url value="/recipient/list.action?dataSourceId=${wsUser.dataSourceId}" />" class="text-decoration-underline">
                                        ${wsUser.dataSourceId}
                                    </a>
                                    <a href="#" class="icon-btn" data-copyable data-copyable-value="${wsUser.dataSourceId}">
