...
<%--@elvariable id="campaignList" type="com.agnitas.beans.PaginatedList"--%>
                        ...
                        <c:if test="${deleteAllowed}">
                            <div class="bulk-actions hidden">
                                ...
                                <div class="bulk-actions__controls">
                                    <c:url var="bulkDeleteUrl" value="/mailing/archive/delete.action"/>
                    ...
                    <emm:table var="campaign" modelAttribute="campaignList" cssClass="table table-hover table--borderless js-table">
                        ...
                        <c:if test="${deleteAllowed}">
                            ...
                            <emm:column title="${checkboxSelectAll}" cssClass="mobile-hidden" headerClass="mobile-hidden">
                                <input class="form-check-input" type="checkbox" name="bulkIds" value="${campaign.id}" autocomplete="off" data-bulk-checkbox />
                            </emm:column>
                        </c:if>
                        ...
                        <emm:column>
                            ...
                            <c:if test="${deleteAllowed}">
                                <a href='<c:url value="/mailing/archive/delete.action?bulkIds=${campaign.id}"/>' class="icon-btn icon-btn--danger js-row-delete" data-tooltip="${deletionTooltip}">
                                    <i class="icon icon-trash-alt"></i>
                                </a>
                            </c:if>
                        </emm:column>
