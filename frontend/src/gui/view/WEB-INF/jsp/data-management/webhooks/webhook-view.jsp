            ...
            <div class="modal-body vstack gap-3">
                ...
                <c:if test="${WEBHOOK_EVENT_TYPE.includesRecipientData}">
                    <div>
                        ...
                        <mvc:select path="includedProfileFields" multiple="true" id="profileFields" cssClass="form-control"
...
<script id="target-group-select-item" type="text/x-mustache-template">
    <div class="d-flex gap-1">
        ...
        <span class="status-badge status.bell-slash" data-tooltip="<mvc:message code='profile.history.disabled'/>"></span>
        {{ } }}
        <span>{{= text }}</span>
    </div>
</script>
