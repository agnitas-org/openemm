...
<%--@elvariable id="isCustomerIdImportAllowed" type="java.lang.Boolean"--%>
...
<%--@elvariable id="profileFields" type="java.util.Map<java.lang.String, com.agnitas.util.DbColumnType>"--%>
<%--@elvariable id="blacklistDbFields" type="java.util.Map<java.lang.String, com.agnitas.util.DbColumnType>"--%>
    ...
    <script id="config:import-profile-view" type="application/json">
        {
            ...
            "blacklistModes": ${[ImportMode.TO_BLACKLIST.intValue, ImportMode.BLACKLIST_EXCLUSIVE.intValue]},
            "emailColumnName": ${emm:toJson(RecipientStandardField.Email.columnName)}
        }
    </script>
        ...
        <div class="tile-body js-scrollable">
            <div class="row g-3" data-field="toggle-vis">
                ...
                <div class="col-12">
                    ...
                    <c:choose>
                        <c:when test="${not empty form.keyColumns and form.keyColumns.contains('customer_id') and not isCustomerIdImportAllowed}">
                            <input type="text" class="form-control" disabled value="customer_id">
                        </c:when>
                        <c:otherwise>
                            <mvc:select id="import_key_column" path="keyColumns" multiple="true" cssClass="form-control" data-field="required" data-action="change-key-columns">
        ...
        <div id="manage-fields-tile" class="tile" data-initializer="import-profile-mappings" data-editable-tile style="flex: 1">
            <c:if test="${not isNewProfile}">
                <script type="application/json" id="config:import-profile-mappings">
                    {
                        "columns": ${emm:toJson(profileFields)},
                        "blacklistColumns": ${emm:toJson(blacklistDbFields)},
