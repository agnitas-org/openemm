...
<%--@elvariable id="isOfflineHtmlFormat" type="java.lang.Boolean"--%>
<%--@elvariable id="contentSize" type="java.lang.Integer"--%>
<%--@elvariable id="attachmentsSize" type="java.lang.Integer"--%>
<%--@elvariable id="approximateMaxDeliverySize" type="java.lang.Integer"--%>
<%--@elvariable id="errorSizeThreshold" type="java.lang.Integer"--%>
<%--@elvariable id="warningSizeThreshold" type="java.lang.Integer"--%>
...
<div class="tiles-container" data-controller="mailing-send" data-initializer="send-mailing" data-editable-view="${agnEditViewKey}">
    <script type="application/json" id="config:send-mailing">
        {
            "mailingId": ${emm:toJson(tmpMailingID)},
            "textEmailsCount": ${emm:toJson(textEmailsCount)},
            "htmlEmailsCount": ${emm:toJson(htmlEmailsCount)},
            "offlineHtmlEmailsCount": ${emm:toJson(offlineHtmlEmailsCount)},
            "totalSendCount": ${emm:toJson(totalSendCount)},
            "mediaTypesRecipientsCountMap": ${emm:toJson(mediaTypesRecipientsCountMap)},
            "isOfflineHtmlFormat": ${emm:toJson(isOfflineHtmlFormat)},
            "contentSize": ${emm:toJson(contentSize)},
            "attachmentsSize": ${emm:toJson(attachmentsSize)},
