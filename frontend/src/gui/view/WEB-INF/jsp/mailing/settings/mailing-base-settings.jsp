...
<%--@elvariable id="parentMailings" type="java.util.List<com.agnitas.emm.core.mailing.bean.LightweightMailingWithMailingList>"--%>
...
<div class="modal" tabindex="-1">
    <div class="modal-dialog modal-lg" data-controller="mailing-settings-base-view">
        <mvc:form servletRelativeAction="/mailing/generate.action?mediaType=${mediaType}&keepForward=${workflowDriven}&isGrid=${isGridMailing eq true}&isTemplate=${isTemplate eq true}"
            ...
            <div class="modal-header">
                <h1 class="modal-title">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${mediaType eq 5}">
                            <span class="status-badge mailing.mediatype.rcs badge--darkest-cyan" data-tooltip="<mvc:message code="mailing.MediaType.2" />"></span>
                        </c:when>
                        <c:otherwise>
            ...
            <div class="modal-body vstack gap-3 js-scrollable" data-action="change-mailing-base-info">
                ...
                <c:if test="${mediaType eq 5}">
                    <div data-field="validator">
                        <label class="form-label" for="mediaRcsSender"><mvc:message code="mailing.Sender_Adress"/></label>
                        <mvc:text path="rcsMediatype.fromAdr" id="mediaRcsSender" cssClass="form-control" maxlength="50"
                                  data-field-validator="length" data-validator-options="required: true, min: 3, max: 50" />
                    </div>
                </c:if>
            ...
            <div class="modal-footer modal-footer--nav">
                ...
                <c:choose>
                    ...
                    <c:when test="${isTemplate}">
                        ...
                        <c:url var="backUrl" value="/mailing/template/create.action" />
                    </c:when>
