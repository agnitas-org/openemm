...
window.I18n = {
    error: {
      workflow: {
        ...
        cantAddInvalidEmailToTheList: '<mvc:message javaScriptEscape="true" code="warning.workflow.email.invalid" arguments="%s" />'
      },
      delay: {
    ...
    defaults: {
      ...
      error: '<mvc:message javaScriptEscape="true" code="error.generic" />',
      ...
      none: '<mvc:message javaScriptEscape="true" code="default.none"/>',
    ...
    fields: {
      ...
      errors: {
        ...
        illegal_script_type: '<mvc:message javaScriptEscape="true" code="error.mailing.content.illegal.script.type"/>'
      },
      mailinglist: {
        errors:{
    ...
    schedule: {
      ...
      daysAndTime: '<mvc:message javaScriptEscape="true" code="default.weekdays.time" />',
      monthAndTime: '<mvc:message javaScriptEscape="true" code="default.month.time" />',
    ...
    statistics: {
      monthly: {
        mailing_type: {
          NORMAL: '<mvc:message javaScriptEscape="true" code="mailing.normal" />',
          DATE_BASED: '<mvc:message javaScriptEscape="true" code="mailing.Rulebased_Mailing" />',
          ACTION_BASED: '<mvc:message javaScriptEscape="true" code="mailing.action.based.mailings" />',
          INTERVAL: '<mvc:message javaScriptEscape="true" code="mailing.IntervalMailings" />'
        }
      },
      default: {
        allRecipients: '<mvc:message javaScriptEscape="true" code="statistic.all_subscribers"/>',
        clickers: '<mvc:message javaScriptEscape="true" code="statistic.clicker"/>',
        clicks: '<mvc:message javaScriptEscape="true" code="statistic.Clicks"/>',
        openings: '<mvc:message javaScriptEscape="true" code="statistic.openings"/>',
        hardBounces: '<mvc:message javaScriptEscape="true" code="statistic.bounces.hardbounce"/>',
        summary: '<mvc:message javaScriptEscape="true" code="Summary"/>',
        total: '<mvc:message javaScriptEscape="true" code="report.total"/>',
        openers: '<mvc:message javaScriptEscape="true" code="statistic.opener"/>',
        clicker: '<mvc:message javaScriptEscape="true" code="statistic.clicker"/>',
        openersByDevices: '<mvc:message javaScriptEscape="true" code="report.mailing.openersByDevices"/>',
        clickersByDevices: '<mvc:message javaScriptEscape="true" code="report.mailing.clickersByDevices"/>',
        keyFigures: '<mvc:message javaScriptEscape="true" code="KeydataGeneral"/>',
        sentEmails: '<mvc:message javaScriptEscape="true" code="report.sentMails"/>',
        softBounces: '<mvc:message javaScriptEscape="true" code="statistic.bounces.softbounce"/>'
      },
      device: {
        desktop: '<mvc:message javaScriptEscape="true" code="report.device.desktop"/>',
        mobile: '<mvc:message javaScriptEscape="true" code="report.device.mobile"/>',
        tablet: '<mvc:message javaScriptEscape="true" code="report.device.tablet"/>',
        smarttv: '<mvc:message javaScriptEscape="true" code="report.device.smarttv"/>',
        mixed: '<mvc:message javaScriptEscape="true" code="report.device.mixed"/>'
      },
      progress: {
        openersNet: '<mvc:message javaScriptEscape="true" code="OpeningsNet"/>',
        openingsGross: '<mvc:message javaScriptEscape="true" code="OpeningsGross"/>',
        anonymousOpenings: '<mvc:message javaScriptEscape="true" code="statistic.openings.anonym"/>',
        anonymousClicks: '<mvc:message javaScriptEscape="true" code="statistic.clicks.anonym"/>'
      },
      bounce: {
        undelivered: '<mvc:message javaScriptEscape="true" code="birt.qualified.softbounces"/>'
      },
      trackingPoint: {
        grossRequests: '<mvc:message javaScriptEscape="true" code="GWUA.trackingPoint.stat.grossRequests"/>',
        netRequests: '<mvc:message javaScriptEscape="true" code="GWUA.trackingPoint.stat.netRequests"/>'
      }
    },
    ...
    LB: {
      buildingBlock: {
        refTableNotFound: '<mvc:message javaScriptEscape="true" code="error.referencetable.not.found" arguments="%s"/>'
      }
    },
    tables: {
      // for filter panel
    ...
    mailing: {
      default: {
        ...
        attachments: '<mvc:message javaScriptEscape="true" code="mailing.Attachments" />',
        otherHtml: '<mvc:message javaScriptEscape="true" code="mailing.size.image.html" />',
        mailFormat: {
          text: '<mvc:message javaScriptEscape="true" code="Text" />',
          html: '<mvc:message javaScriptEscape="true" code="HTML" />',
          offlineHtml: '<mvc:message javaScriptEscape="true" code="OfflineHTML" />'
        },
        mediaType: {
          0: '<mvc:message javaScriptEscape="true" code="mailing.MediaType.0" />',
          2: '<mvc:message javaScriptEscape="true" code="mailing.MediaType.2" />',
          4: '<mvc:message javaScriptEscape="true" code="mailing.MediaType.4" />',
          5: '<mvc:message javaScriptEscape="true" code="mailing.MediaType.5" />'
        }
      },
      validation: {
      ...
      mediatype: {
        ...
        rcs: '<mvc:message javaScriptEscape="true" code="mailing.MediaType.rcs" />'
      }
    },
    wysiwyg: {
      dialogs: {
        ...
        link: {
          type: '<mvc:message javaScriptEscape="true" code="mailing.editor.link.type"/>',
          ...
          phone_number: '<mvc:message javaScriptEscape="true" code="mailing.editor.phone.number"/>',
        ...
        table: {
          attributes: '<mvc:message javaScriptEscape="true" code="htmled.table_attributes"/>',
          rows: '<mvc:message javaScriptEscape="true" code="htmled.rows"/>',
          columns: '<mvc:message javaScriptEscape="true" code="htmled.columns"/>',
          width: '<mvc:message javaScriptEscape="true" code="default.image.width"/>',
          height: '<mvc:message javaScriptEscape="true" code="grid.mediapool.image.sizes.height"/>',
          headers: '<mvc:message javaScriptEscape="true" code="mailing.editor.header"/>',
          top: '<mvc:message javaScriptEscape="true" code="mailing.editor.row.first"/>',
          left: '<mvc:message javaScriptEscape="true" code="mailing.editor.column.first"/>',
          topAndLeft: '<mvc:message javaScriptEscape="true" code="mailing.editor.both"/>',
          border: '<mvc:message javaScriptEscape="true" code="mailing.editor.border"/>',
          alignment: '<mvc:message javaScriptEscape="true" code="mailing.editor.alignment"/>',
          align_left: '<mvc:message javaScriptEscape="true" code="htmled.align_left"/>',
          center: '<mvc:message javaScriptEscape="true" code="htmled.center"/>',
          align_right: '<mvc:message javaScriptEscape="true" code="htmled.align_right"/>',
          caption: '<mvc:message javaScriptEscape="true" code="htmled.caption"/>',
          summary: '<mvc:message javaScriptEscape="true" code="report.summary"/>',
          cellspacing: '<mvc:message javaScriptEscape="true" code="mailing.editor.cellspacing"/>',
          cellpadding: '<mvc:message javaScriptEscape="true" code="mailing.editor.cellpadding"/>',
          insert: '<mvc:message javaScriptEscape="true" code="htmled.insert_table"/>'
        }
      },
      emoji: '<mvc:message javaScriptEscape="true" code="editor.wysiwyg.emoji" />',
      wrapTextInP: '<mvc:message javaScriptEscape="true" code="editor.wysiwyg.paragraph" />'
    },
    password : {
      error : {
