...
<%--@elvariable id="userformStatsForm" type="com.agnitas.emm.core.userform.form.UserformStatsForm"--%>

<c:set var="isStatisticPage" value="${userformStatsForm.allowedToChoseForm}"/>
...
<emm:instantiate var="agnNavHrefParams" type="java.util.LinkedHashMap" scope="request">
    <c:set target="${agnNavHrefParams}" property="user-form-id" value="${userformStatsForm.formId}"/>
</emm:instantiate>
...
<emm:instantiate var="itemActionsSettings" type="java.util.LinkedHashMap" scope="request">
    ...
    <emm:instantiate var="element" type="java.util.LinkedHashMap">
        ...
        <%-- Items for dropdown --%>
        <c:url var="csvUrl" value="/webform/statsCsv.action"/>
        <emm:instantiate var="option" type="java.util.LinkedHashMap">
            ...
            <c:set target="${option}" property="extraAttributes" value="data-form-target='#stats-form' data-form-url='${csvUrl}' data-form-submit-static='' data-prevent-load"/>
    ...
    <emm:instantiate var="element" type="java.util.LinkedHashMap">
        ...
        <c:set target="${element}" property="extraAttributes" value="data-form-target='#stats-form' data-form-submit"/>
