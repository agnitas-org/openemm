...
<mvc:form servletRelativeAction="/webform/stats.action" method="GET" modelAttribute="userformStatsForm"
          id="stats-form"
          cssClass="tiles-container flex-column"
          data-form="resource"
          data-controller="userform-stats"
        ...
        <div class="tile-body">
            <div class="row g-3">
                <c:choose>
                    <c:when test="${not empty userForms}">
                        <div class="col">
                            ...
                            <mvc:select path="formId" id="form-select" size="1" cssClass="form-control">
                ...
                <div class="col">
                    ...
                    <mvc:select id="period-mode-select" path="periodMode" cssClass="form-control">
    ...
    <div id="overview-tile" class="tile" data-editable-tile="main">
        ...
        <div class="tile-body vstack gap-3 js-scrollable">
            ...
            <div class="notification-simple notification-simple--info">
                ...
                <p><mvc:message code="AnonymousTrackedMess"/></p>
            </div>

            <div id="table" class="table-wrapper" data-js-table="stat-table"></div>

            <script id="stat-table" type="application/json">
                {
                    "columns": [
                        {
                            "headerName": "URL",
                        ...
                        {
                            "headerName": "<mvc:message code='statistic.Clicks' />",
