...
<mvc:form cssClass="tiles-container flex-column" servletRelativeAction="/webform/save.action" id="userFormForm"
    ...
    <div id="settings-tile" class="tile h-auto flex-none" data-editable-tile>
        <div class="tile-header">
            <h1 class="tile-title text-truncate"><mvc:message code="settings.form.edit"/></h1>
        </div>
        <div class="tile-body grid" style="--bs-columns:2">
            ...
            <div>
                ...
                <mvc:text path="description" cssClass="form-control" id="description" placeholder="${descriptionMsg}"/>
            </div>
            ...
            <c:if test="${form.formId ne 0}">
                <div>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <button type="button" class="btn btn-info btn-icon" data-copyable data-copyable-target="#formURL" data-tooltip='<mvc:message code="button.Copy"/>'>
                ...
                <div>
                    ...
                    <div class="d-flex gap-2">
                        <select id="formTestRecipient" class="form-control" data-action="formTestRecipient">
                        ...
                        <a href="${userFormFullURLPatternNoUid}"
                           id="formTestLink"
                           data-action="${isActive ? '' : 'activate-and-test'}"
        ...
        <div id="success-form-tile" class="tile" data-editable-tile style="flex: 1">
            ...
            <div class="tile-body vstack gap-3">
                <div>
                    ...
                    <div class="d-flex gap-2">
                        <mvc:select path="successSettings.startActionId" size="1" cssClass="form-control" id="startAction"
                        ...
                        <emm:ShowByPermission token="actions.show">
                            ...
                            <a id="startActionLink" class="btn btn-icon btn-primary ${form.successSettings.startActionId > 0 ? '' : 'hidden'}" data-tooltip="${actionSwitchTooltip}"
                               href="${fn:replace(actionEditUrlPattern, ':action-ID:', form.successSettings.startActionId)}?returnUrl=/webform/${form.formId}/view.action">
                ...
                <div class="overflow-hidden vstack" data-hide-by-checkbox="#success-type">
                    ...
                    <div class="tile flex-grow-1" id="success-form-editor" data-multi-editor>
                        <div class="tile-header">
                            ...
                            <div class="tile-controls">
                                <a href="#" class="btn-enlarge" data-enlarged-modal data-modal-set="title: <mvc:message code="settings.form.success"/>">
                        ...
                        <div class="tile-body p-0 border-0">
                            ...
                            <!-- WYSIWYG EDITOR -->
                            <div id="success-wysiwyg-editor" class="h-100 hidden">
                ...
                <div>
                    ...
                    <div class="d-flex gap-2">
                        <mvc:select path="successSettings.finalActionId" size="1" cssClass="form-control" id="finalAction" data-action="change-final-action">
                            <mvc:option value="0"><mvc:message code="settings.No_Action"/></mvc:option>
                            <mvc:options items="${emmActions}" itemValue="id" itemLabel="shortname"/>
                        </mvc:select>
                        <emm:ShowByPermission token="actions.show">
                            <mvc:message var="actionSwitchTooltip" code="form.action.switch"/>
                            <a id="finalActionLink" class="btn btn-primary btn-icon ${form.successSettings.finalActionId > 0 ? '' : 'hidden'}" data-tooltip="${actionSwitchTooltip}"
                ...
                <div class="overflow-hidden flex-grow-1 d-flex flex-column" data-hide-by-checkbox="#error-type">
                    ...
                    <div class="tile" id="error-form-editor" data-multi-editor>
                        ...
                        <div class="tile-body">
                            ...
                            <!-- WYSIWYG EDITOR -->
                            <div id="error-wysiwyg-editor" class="h-100 hidden">
    ...
    <div class="modal modal-warning" tabindex="-1" data-controller="userform-view">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                        ...
                        <div class="row mt-3">
                            {{ if (needSuccessCodeChoose) { }}
                                <div class="col">
                                    ...
                                    <select name="success_template_mode" class="form-control" id="success-template-mode" >
                            ...
                            {{ if (needErrorCodeChoose) { }}
                                <div class="col">
                                    ...
                                    <select name="error_template_mode" class="form-control" id="error-template-mode" >
                                        <option value="HTML"><mvc:message code="HTML"/></option>
                                        <option value="FORM_BUILDER"><mvc:message code="userform.builder"/></option>
                                    </select>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-action="save-specific-code-mode">
                        <i class="icon icon-check"></i>
                        <span class="text"><mvc:message code="button.Proceed"/></span>
                    </button>
                </div>
