...
<%--@elvariable id="recipient" type="com.agnitas.emm.core.recipient.dto.RecipientLightDto"--%>
...
<c:set var="agnBreadcrumbsRootUrl"	value="${recipientOverviewUrl}"             scope="request" />
<c:set var="agnHelpKey" 			value="recipientHistory" 					scope="request" />
<c:set var="agnEditViewKey" 	    value="recipient-status-history-overview"   scope="request" />
