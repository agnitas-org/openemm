            ...
            <div class="row g-3" data-field="toggle-vis">
                ...
                <c:if test="${profileForm.fieldType != GENERIC_TYPE_DATE && profileForm.fieldType != GENERIC_TYPE_DATETIME}">
                    <div id="defaultFieldBlock" class="col-12">
                        ...
                        <%-- in case of modification check fieldDefault usage in DAO layer--%>
                ...
                <emm:ShowByPermission token="profileField.visible">
                    <div class="col-12">
                        <label for="field-mode" class="form-label">
                            <mvc:message code="visibility"/>
                            <a href="#" class="icon icon-question-circle" data-help="recipient/profileField/VisibilityFilter.xml"></a>
                        </label>
                        <mvc:select id="field-mode" path="fieldMode" cssClass="form-control">
