...
<mvc:form cssClass="tiles-container flex-column" id="stat-form" servletRelativeAction="/statistics/recipient/view.action"
          ...
          modelAttribute="form"
          data-form="resource"
          data-controller="recipient-stats"
          data-initializer="recipient-stats"
    ...
    <div id="filter-tile" class="tile h-auto flex-none" data-editable-tile>
        ...
        <div class="tile-body row g-3">
            <div class="col">
                ...
                <mvc:select id="mailinglist-select" path="mailingListId" cssClass="form-control">
            ...
            <c:if test="${form.reportName ne 'recipient_doi.rptdesign'}">
                <div class="col">
                    ...
                    <mvc:select path="targetId" cssClass="form-control">
            ...
            <c:if test="${form.reportName eq 'progress'
    ...
    <div id="overview-tile" class="tile" data-editable-tile="main">
        <div class="tile-header">
            ...
            <div class="tile-title-controls gap-3">
                <mvc:select path="reportName" cssClass="form-control" id="stats-type" data-action="type-change" data-select-options="dropdownAutoWidth: true, width: 'auto'">
                    <mvc:option value="progress"><mvc:message code="statistics.progress"/></mvc:option>
        ...
        <div class="tile-body p-2 js-scrollable" style="overflow-y: auto !important;"></div>
    </div>
</mvc:form>

<%@include file="fragments/recipient-progress-stats.jspf"%>
