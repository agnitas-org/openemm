                    ...
                    <emm:table var="target" modelAttribute="targetEntries" cssClass="table table--borderless js-table ${targetForm.showDeleted ? '' : 'table-hover'}">
                        ...
                        <c:if test="${deletionAllowed}">
                            <c:set var="checkboxSelectAll">
                                <input type="checkbox" class="form-check-input" data-bulk-checkboxes autocomplete="off" />
                            </c:set>

                            <emm:column title="${checkboxSelectAll}">
                                <input type="checkbox" class="form-check-input" name="bulkIds" value="${target.id}" autocomplete="off" data-bulk-checkbox />
                            </emm:column>
                        </c:if>
                        ...
                        <emm:column titleKey="Name" sortable="true" sortProperty="target_shortname">
                            <div class="hstack gap-1 overflow-wrap-anywhere">
                                ...
                                <span class="text-truncate-table">${fn:escapeXml(target.targetName)}</span>
                            </div>
        ...
        <div class="tile-body vstack gap-3 js-scrollable">
            <c:if test="${isSearchEnabled}">
                ...
                <div>
                    ...
                    <mvc:select id="filter-complexity" path="searchComplexity" cssClass="form-control" data-result-template="select2-badge-option" data-selection-template="select2-badge-option">
                ...
                <div>
                    ...
                    <mvc:select id="filter-delivery" path="searchDeliveryOption" cssClass="form-control">
                        <mvc:option value=""><mvc:message code="default.All"/></mvc:option>
