...
public class ComAdminPreferencesFactoryImpl implements ComAdminPreferencesFactory {

    @Override
    public ComAdminPreferences newAdminPreferences() {
        return new ComAdminPreferencesImpl();
    }
