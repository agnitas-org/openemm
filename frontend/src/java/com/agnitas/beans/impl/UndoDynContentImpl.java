...
public class UndoDynContentImpl extends DynamicTagContentImpl implements UndoDynContent {
	...
	public DynamicTagContent clone() {
		UndoDynContentImpl undoDynContent = new UndoDynContentImpl();
		undoDynContent.setUndoId(undoId);
		return undoDynContent;
	}
}
