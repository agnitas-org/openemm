...
public class BounceFilterServiceImpl implements BounceFilterService {
	...
	@Override
	public int saveBounceFilter(Admin admin, BounceFilterDto bounceFilter, boolean isNew)
    ...
    @Override
    public int saveBounceFilter(int companyId, TimeZone adminTimeZone, BounceFilterDto bounceFilter, boolean isNew)
            throws BlacklistedFilterEmailException, EmailInUseException, BlacklistedForwardEmailException {
    ...
    @Override
    public PaginatedList<BounceFilterDto> overview(BounceFilterListForm filter) {
