...
public class CalendarCommentImpl implements CalendarComment {

    private int commentId;
    private int companyId;
    private int adminId;
    private List<CalendarCommentRecipient> recipients;
	...
	public boolean isNotified() {
        ...
        for (CalendarCommentRecipient recipient : recipients) {
    ...
    @Override
	public List<CalendarCommentRecipient> getRecipients() {
        return recipients;
    }

    @Override
	public void setRecipients(List<CalendarCommentRecipient> recipients) {
	...
	public String getRecipientsString() {
        ...
        List<String> addresses = recipients.stream()
                .map(CalendarCommentRecipient::getAddress)
                .toList();
