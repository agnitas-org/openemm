...
public interface CalendarCommentDao {
    ...
    CalendarCommentRecipient createCalendarCommentRecipient();

    int saveComment(CalendarComment calendarComment);

    List<CalendarComment> getComments(Date startDate, Date endDate, int companyId);
