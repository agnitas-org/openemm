...
public abstract class BaseCalendarAjaxServlet extends ComAjaxServletBase {
	private static final long serialVersionUID = -5956018526813405445L;
    ...
    protected boolean checkAllowed(HttpServletRequest request, HttpServletResponse response) {
        return checkPermitted(request, response, Permission.CALENDAR_SHOW);
    }
}
