...
public class HexEncoder implements ByteArrayToStringEncoder {
	private static final transient Logger logger = Logger.getLogger(HexEncoder.class);
	...
	@Override
	public String encodeToString(byte[] data, Charset charset) throws EncodingException {
