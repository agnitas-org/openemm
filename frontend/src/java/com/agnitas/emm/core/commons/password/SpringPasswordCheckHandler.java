...
/**
 * Implementation of {@link PasswordCheckHandler} filling {@link com.agnitas.web.mvc.Popups} collection.
 */
public class SpringPasswordCheckHandler implements PasswordCheckHandler {
    ...
    /**
     * Creates a new {@link PasswordCheckHandler} to add messages.
     *
    ...
    private void error(String code) {
        if (propertyName == null) {
            ...
            popups.fieldError(propertyName, code);
        }
    }
}
