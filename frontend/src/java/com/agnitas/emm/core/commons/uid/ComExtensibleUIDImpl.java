...
final class ComExtensibleUIDImpl implements ComExtensibleUID {
	...
	/** The logger. */
	private static final Logger logger = Logger.getLogger(ComExtensibleUIDImpl.class);
     ...
     * @see UIDFactory
     */
 	ComExtensibleUIDImpl(final String prefix, final int licenseID, @VelocityCheck final int companyID, final int customerID, final int mailingID, final int urlID, final long bitfield) {
 		this.prefix = prefix;
