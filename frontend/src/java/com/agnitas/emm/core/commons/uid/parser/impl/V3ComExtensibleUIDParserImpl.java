...
public class V3ComExtensibleUIDParserImpl extends BaseExtensibleUIDParser {
    ...
    public V3ComExtensibleUIDParserImpl() {
    ...
    protected ComExtensibleUID parse(String uidString, String[] parts) throws UIDParseException {
        ...
        ComRdirMailingData mailingData = getMailingData(uidString, correctedParts);
    ...
    private ComRdirMailingData getMailingData(final String uidString, String[] parts) throws UIDParseException {
