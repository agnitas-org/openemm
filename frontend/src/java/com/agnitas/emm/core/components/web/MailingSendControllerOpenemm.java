...
public class MailingSendControllerOpenemm extends MailingSendController {
    ...
    public MailingSendControllerOpenemm(MailingRecipientsService mailingRecipientsService, MailingDao mailingDao, ComMailingBaseService mailingBaseService,
                                        ...
                                        final ServerPrioService serverPrioService, MailinglistApprovalService mailinglistApprovalService) {

        super(mailingRecipientsService, mailingDao, mailingBaseService, gridService, targetService, configService, maildropService, deliveryStatService,
                targetDao, mailingService, mailingSizeCalculationService, mailingDependencyService, webStorage, userActivityLogService, blockSizeService,
                mailingStopService, mailinglistDao, autoImportService, dkimDao, mailingDeliveryBlockingService, mailingStatisticsDao, bounceFilterService,
                mailingSendService, conversionService, targetCopyService, premiumFeaturesService, serverPrioService, mailinglistApprovalService);
    }
}
