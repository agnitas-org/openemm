...
public class MailingSendControllerOpenemm extends MailingSendController {
    ...
    public MailingSendControllerOpenemm(MailingRecipientsService mailingRecipientsService, MailingDao mailingDao, MailingBaseService mailingBaseService, GridServiceWrapper gridService,
        ...
        super(mailingRecipientsService, mailingDao, mailingBaseService, gridService, targetService, configService, maildropService,
                ...
                userActivityLogService, blockSizeService, mailingStopService, mailinglistDao, autoImportService, dkimDao, mailingDeliveryBlockingService,
                mailingStatisticsDao, bounceFilterService, mailingSendService, conversionService, targetCopyService, premiumFeaturesService, serverPrioService,
                mailinglistApprovalService, birtReportService, workflowService);
    }
