...
public class HexProfileFieldEncodingHashTag extends AbstractProfileFieldEncodingHashTag {

	private static final HexEncoder ENCODER = new HexEncoder();
	
	@Override
	public final boolean isSupportedTag(final String tagName, final boolean hasColon) {
		return "encode-hex".equalsIgnoreCase(tagName);
	}

	@Override
	public ByteArrayToStringEncoder getByteArrayToStringEncoder() {
		return HexProfileFieldEncodingHashTag.ENCODER;
	}
