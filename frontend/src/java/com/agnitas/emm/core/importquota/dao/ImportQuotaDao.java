...
public interface ImportQuotaDao {

	void saveImportSize(final int companyID, final int importID, final ZonedDateTime timestamp, final ImportType importType, final int linesCount);
