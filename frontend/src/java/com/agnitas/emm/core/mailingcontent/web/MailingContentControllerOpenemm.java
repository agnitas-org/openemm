...
public class MailingContentControllerOpenemm extends MailingContentController {
    ...
    public MailingContentControllerOpenemm(MailinglistApprovalService mailinglistApprovalService, MailingService mailingService, MaildropService maildropService,
                                           MailingContentService mailingContentService, ComTargetService targetService, UserActivityLogService userActivityLogService,
                                           ProfileFieldDao profileFieldDao, MailingPropertiesRules mailingPropertiesRules, ComMailingBaseService mailingBaseService,
                                           GridServiceWrapper gridServiceWrapper, AgnDynTagGroupResolverFactory agnDynTagGroupResolverFactory, AgnTagService agnTagService,
                                           PreviewImageService previewImageService, DynTagChainValidator dynTagChainValidator, ExtendedConversionService extendedConversionService,
        ...
        super(mailinglistApprovalService, mailingService, maildropService, mailingContentService, targetService, userActivityLogService,
                profileFieldDao, mailingPropertiesRules, mailingBaseService, gridServiceWrapper, agnDynTagGroupResolverFactory, agnTagService,
                previewImageService, dynTagChainValidator, extendedConversionService, mediaTypesService);
    }
}
