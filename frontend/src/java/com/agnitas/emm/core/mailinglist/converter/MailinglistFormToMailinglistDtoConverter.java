...
@Component
public class MailinglistFormToMailinglistDtoConverter implements Converter<MailinglistForm, MailinglistDto> {
	@Override
	public MailinglistDto convert(MailinglistForm source) {
		MailinglistDto dto = new MailinglistDto();
		dto.setId(source.getId());
		dto.setShortname(source.getShortname());
