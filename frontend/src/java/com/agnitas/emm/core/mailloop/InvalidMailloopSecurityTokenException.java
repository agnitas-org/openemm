...
public class InvalidMailloopSecurityTokenException extends MailloopException {
	...
	/** Serial version UID. */
	private static final long serialVersionUID = -5857986735611885971L;
	
	private final int mailloopID;
	
	public InvalidMailloopSecurityTokenException(final int mailloopID) {
		super("Invalid security token for mailloop " + mailloopID);
