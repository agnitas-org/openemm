...
public final class TrackingVetoHelper {
	 ...
	 */
	public static final TrackingLevel computeTrackingLevel(final ExtensibleUID uid, final boolean doNotTrackRecipient, final ConfigService configService, final MailingContentTypeCache mailingContentTypeCache) {
