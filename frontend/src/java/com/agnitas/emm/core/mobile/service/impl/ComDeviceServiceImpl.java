...
public class ComDeviceServiceImpl implements ComDeviceService {
	private static final transient Logger logger = LogManager.getLogger(ComDeviceServiceImpl.class);
