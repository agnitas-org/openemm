 ...
 */
public class RecipientProfileHistoryDaoImplBasic extends BaseDaoImpl implements RecipientProfileHistoryDao {

	/** The logger. */
	private static final Logger logger = LogManager.getLogger(RecipientProfileHistoryDaoImplBasic.class);
