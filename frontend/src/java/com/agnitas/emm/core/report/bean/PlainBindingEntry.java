...
public interface PlainBindingEntry {
    ...
    @Nullable
    Integer getUserStatus();	// TODO Change return type to com.agnitas.emm.common.UserStatus

    void setUserStatus(Integer userStatus);	// TODO Change parameter to com.agnitas.emm.common.UserStatus
