...
public class RecipientHistoryReportDaoImpl extends BaseDaoImpl implements RecipientHistoryReportDao {
    ...
    private static final Logger logger = LogManager.getLogger(RecipientHistoryReportDaoImpl.class);
    ...
    public RecipientHistoryReportDaoImpl(DataSource dataSource, JavaMailService javaMailService) {
    ...
    public List<RecipientSoftBounceHistoryDto> getSoftBouncesHistory(int recipientId, int companyId) {
        return select(logger, "SELECT bounce_tbl.timestamp, mailing_tbl.mailing_id, mailing_tbl.shortname" +
    ...
    public List<RecipientMailingLinkClicksHistoryDto> getMailingClicksHistory(int recipientId, int companyId) {
        return select(logger, " SELECT rlog.timestamp, rlog.mailing_id, m.shortname, rlog.url_id, rdir.full_url" +
    ...
    public List<RecipientWorkflowReactionsHistoryDto> getWorkflowReactionsHistory(int recipientId, int companyId) {
        return select(logger, "SELECT step_date, case_id, reaction_id FROM workflow_reaction_out_tbl" +
