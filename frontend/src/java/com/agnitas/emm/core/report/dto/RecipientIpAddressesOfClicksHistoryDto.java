...
@TextTable(
        translationKey = "statistic.IPAddress",
        defaultTitle = "IP ADDRESSES OF CLICKS",
        order = {"getDate", "getIpAddress", "getEntityId", "getEntityName", "getLinkId", "getLinkUrl"})
public interface RecipientIpAddressesOfClicksHistoryDto extends RecipientLinkClicksHistoryDto {
