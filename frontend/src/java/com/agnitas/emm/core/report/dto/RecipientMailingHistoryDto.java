...
@TextTable(translationKey = "recipient.history.mailing", defaultTitle = "MAILING HISTORY",
        order = {"SEND_DATE", "MAILING_TYPE", "SHORT_NAME", "SUBJECT", "DELIVERY_DATE", "NUMBER_OF_DELIVERIES", "NUMBER_OF_OPENING", "NUMBER_OF_CLICKS"})
public interface RecipientMailingHistoryDto {
    ...
    @TextColumn(width = 5, translationKey = "recipient.Mailing.deliveries", defaultValue = "NUMBER OF DELIVERIES", key="NUMBER_OF_DELIVERIES")
    int getNumberOfDeliveries();
    
    void setNumberOfDeliveries(final int number);
}
