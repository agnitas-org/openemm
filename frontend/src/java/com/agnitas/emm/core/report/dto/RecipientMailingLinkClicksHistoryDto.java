...
@TextTable(
        ...
        defaultTitle = "MAILING CLICKS",
        order = {"getDate", "getEntityId", "getEntityName", "getLinkId", "getLinkUrl"})
public interface RecipientMailingLinkClicksHistoryDto extends RecipientLinkClicksHistoryDto {
