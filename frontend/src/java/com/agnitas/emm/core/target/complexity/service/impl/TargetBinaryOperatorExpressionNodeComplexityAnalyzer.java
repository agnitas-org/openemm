...
@Component
public final class TargetBinaryOperatorExpressionNodeComplexityAnalyzer extends AbstractTargetComplexityAnalyzer<BinaryOperatorExpressionalEqlNode> {
    public TargetBinaryOperatorExpressionNodeComplexityAnalyzer() {
        super(BinaryOperatorExpressionalEqlNode.class);
    }

    @Override
    public void analyze(BinaryOperatorExpressionalEqlNode node, boolean negative, TargetComplexityEvaluationState state) {
