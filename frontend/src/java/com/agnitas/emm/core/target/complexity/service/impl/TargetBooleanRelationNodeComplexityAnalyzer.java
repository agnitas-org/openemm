...
@Component
public final class TargetBooleanRelationNodeComplexityAnalyzer extends AbstractTargetComplexityAnalyzer<RelationalBooleanEqlNode> {
    public TargetBooleanRelationNodeComplexityAnalyzer() {
        super(RelationalBooleanEqlNode.class);
    }

    @Override
    public void analyze(RelationalBooleanEqlNode node, boolean negative, TargetComplexityEvaluationState state) {
