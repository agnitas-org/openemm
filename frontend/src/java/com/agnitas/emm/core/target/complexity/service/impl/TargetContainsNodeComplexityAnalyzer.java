...
@Component
public final class TargetContainsNodeComplexityAnalyzer extends AbstractTargetComplexityAnalyzer<ContainsRelationalEqlNode> {
    public TargetContainsNodeComplexityAnalyzer() {
        super(ContainsRelationalEqlNode.class);
    }

    @Override
    public void analyze(ContainsRelationalEqlNode node, boolean negative, TargetComplexityEvaluationState state) {
