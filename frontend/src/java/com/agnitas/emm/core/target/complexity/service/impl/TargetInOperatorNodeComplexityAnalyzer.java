...
@Component
public final class TargetInOperatorNodeComplexityAnalyzer extends AbstractTargetComplexityAnalyzer<InRelationalEqlNode> {
    public TargetInOperatorNodeComplexityAnalyzer() {
        super(InRelationalEqlNode.class);
    }

    @Override
    public void analyze(InRelationalEqlNode node, boolean negative, TargetComplexityEvaluationState state) {
