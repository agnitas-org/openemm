...
@Component
public final class TargetNegExpressionNodeComplexityAnalyzer extends AbstractTargetComplexityAnalyzer<NegExpressionalEqlNode> {
    public TargetNegExpressionNodeComplexityAnalyzer() {
        super(NegExpressionalEqlNode.class);
    }

    @Override
    public void analyze(NegExpressionalEqlNode node, boolean negative, TargetComplexityEvaluationState state) {
