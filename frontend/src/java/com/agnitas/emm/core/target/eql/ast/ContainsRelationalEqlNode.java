...
public final class ContainsRelationalEqlNode extends AbstractRelationalEqlNode {
	...
	public ContainsRelationalEqlNode(final AbstractExpressionalEqlNode expressionNode, final StringConstantWithEscapeCharsAtomEqlNode stringConstantNode, final boolean notFlag) {
	...
	public final String toString() {
		if (notFlag) {
			return ("(NOT-CONTAINS " + expressionNode + " " + stringConstantNode + ")");
		} else {
			return ("(CONTAINS " + expressionNode + " " + stringConstantNode + ")");
		}
	}
