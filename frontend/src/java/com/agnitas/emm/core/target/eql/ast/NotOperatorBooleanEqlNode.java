...
public final class NotOperatorBooleanEqlNode extends AbstractBooleanEqlNode {

	private final AbstractBooleanEqlNode child;
	
	public NotOperatorBooleanEqlNode(final AbstractBooleanEqlNode child) {
		this.child = child;
	}

	public AbstractBooleanEqlNode getChild() {
		return child;
	}
