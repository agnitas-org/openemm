...
public final class StartsWithRelationalEqlNode extends AbstractRelationalEqlNode {
	...
	public StartsWithRelationalEqlNode(final AbstractExpressionalEqlNode expressionNode, final StringConstantWithEscapeCharsAtomEqlNode stringConstantNode, final boolean notFlag) {
	...
	public final String toString() {
		if (notFlag) {
			return ("(NOT-STARTS-WITH " + expressionNode + " " + stringConstantNode + ")");
		} else {
			return ("(STARTS-WITH " + expressionNode + " " + stringConstantNode + ")");
		}
	}
	...
	public final void traverse(final EqlNodeVisitor visitor) {
		...
		TraversalUtil.traverse(stringConstantNode, visitor);
