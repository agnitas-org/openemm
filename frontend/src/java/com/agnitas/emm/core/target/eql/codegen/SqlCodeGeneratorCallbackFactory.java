...
public interface SqlCodeGeneratorCallbackFactory {

	public SqlCodeGeneratorCallback newCodeGeneratorCallback(final int companyID) throws ProfileFieldResolveException, ReferenceTableResolveException;
