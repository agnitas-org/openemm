...
public final class BeanShellRecipientTargetGroupMatcher implements RecipientTargetGroupMatcher {
	...
	private static final transient Logger logger = LogManager.getLogger(BeanShellRecipientTargetGroupMatcher.class);
	...
	@Override
	public final boolean isInTargetGroup(final Target target) {
