...
/**
 * Helper to transfer data between TargetEditForm and Target.
 */
public final class FormHelper {

	public static final void formPropertiesToTargetGroup(final Target target, final TargetEditForm form) {
