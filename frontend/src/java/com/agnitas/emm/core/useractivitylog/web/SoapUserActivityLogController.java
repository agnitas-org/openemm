...
public class SoapUserActivityLogController extends AbstractUserActivityLogController implements XssCheckAware {
    ...
    protected SoapUserActivityLogController(WebStorage webStorage, UserActivityLogService userActivityLogService,
    ...
    public Pollable<ModelAndView> list(Admin admin, @ModelAttribute("filter") SoapUserActivityLogFilter filter, @ModelAttribute SoapUserActivityLogSearchParams searchParams,
    ...
    protected PaginatedList<?> preparePaginatedList(UserActivityLogFilterBase filter, Admin admin) {
        ...
        return userActivityLogService.getSoapUserActivityLogByFilter(ualFilter, admin);
    }
    ...
    public ResponseEntity<FileSystemResource> download(Admin admin, SoapUserActivityLogFilter filter) {
        return downloadLogs(admin, filter, UserType.SOAP);
    }
