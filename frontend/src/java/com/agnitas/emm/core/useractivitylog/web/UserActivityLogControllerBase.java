...
public abstract class UserActivityLogControllerBase {
    ...
    protected UserActivityLogControllerBase(WebStorage webStorage, AdminService adminService, UserActivityLogService userActivityLogService, UserActivityLogExportWorkerFactory exportWorkerFactory) {
