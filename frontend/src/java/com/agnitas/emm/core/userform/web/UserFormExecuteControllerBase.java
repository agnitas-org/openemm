...
public class UserFormExecuteControllerBase {
	...
	/** The logger. */
	private static final Logger logger = LogManager.getLogger(UserFormExecuteControllerBase.class);
	...
	public UserFormExecuteControllerBase(final ConfigService configService, final UserFormExecutionService userFormExecutionService, final ComCompanyDao companyDao, final CompanyTokenService companyTokenService, final AgnTagService agnTagService, final ComDeviceService deviceService, final ComponentService componentService) {
