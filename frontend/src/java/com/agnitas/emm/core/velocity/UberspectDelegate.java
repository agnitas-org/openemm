...
public class UberspectDelegate implements Uberspect, RuntimeServicesAware, ContextAware {
	/** The logger. */
	private static final transient Logger logger = LogManager.getLogger( UberspectDelegate.class);
	
	/** Name of property holding delegate target. */
	public static final String DELEGATE_TARGET_PROPERTY_NAME = "com.agnitas.emm.core.velocity.UberspectDelegate.DELEGATE_TARGET";
