...
/**
 * Implementation of {@link OnMailOpenedHandler} interface
 * handling events for webhook interface.
 */
public final class MailOpenedWebhookHandler implements OnMailOpenedHandler {

	/** Service for enqueueing webhook messages. */
	private WebhookMessageEnqueueService messageEnqueueService;
	
	@Override
	public void handleMailOpened(int companyID, int mailingID, int customerID) {
		this.messageEnqueueService.enqueueMailOpenedMessage(companyID, mailingID, customerID);
	}
