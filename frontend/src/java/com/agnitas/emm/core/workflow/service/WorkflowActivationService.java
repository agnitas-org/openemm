...
public class WorkflowActivationService {
	...
	private Optimization createOptimization(int companyId, int workflowId, WorkflowGraph workflowGraph, Map<Integer, Mailing> mailingsToUpdate, Optimization optimization, Workflow workflow, int campaignId,
