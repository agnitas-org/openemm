...
@Component
public class WebserviceUserToWsUserDtoConverter implements Converter<WebserviceUser, WebserviceUserDto> {
    @Override
    public WebserviceUserDto convert(WebserviceUser user) {
