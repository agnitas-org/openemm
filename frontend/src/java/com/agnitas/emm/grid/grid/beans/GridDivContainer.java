...
public interface GridDivContainer {
    ...
    GridDivContainerUsages getUsageData();

    void setUsageData(GridDivContainerUsages usageData);

    boolean equalsWithoutID(GridDivContainer otherGridDivContainer);
