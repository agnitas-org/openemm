...
import com.agnitas.emm.springws.jaxb.AddBlacklistResponse;
...
public class AddBlacklistEndpoint extends BaseEndpoint {
	...
	public @ResponsePayload AddBlacklistResponse addBlacklist(@RequestPayload AddBlacklistRequest request) {
