...
public class MailingResponseBuilder {
	...
	public com.agnitas.emm.springws.jaxb.Mailing createResponse(Mailing mailing) {
		com.agnitas.emm.springws.jaxb.Mailing responseMailing = new com.agnitas.emm.springws.jaxb.Mailing();
		...
		if (targetGroups != null) {
			com.agnitas.emm.springws.jaxb.Mailing.TargetIDList targetIDList = new com.agnitas.emm.springws.jaxb.Mailing.TargetIDList();
		...
		if (emailParam != null) {
			...
			com.agnitas.emm.springws.jaxb.Mailing.Formats formats = new com.agnitas.emm.springws.jaxb.Mailing.Formats();
	...
	public com.agnitas.emm.springws.jaxb.Template createTemplateResponse(Mailing mailing) {
		com.agnitas.emm.springws.jaxb.Template responseTemplate = new Template();
		...
		Collection<Integer> targetGroups = mailing.getTargetGroups();
		if (targetGroups != null) {
			com.agnitas.emm.springws.jaxb.Template.TargetIDList targetIDList = new Template.TargetIDList();
			for (Integer targetID : targetGroups) {
				targetIDList.getTargetID().add(targetID);
			}
		...
		if (emailParam != null) {
			...
			List<Format> formatList = MailingModel.getFormatList(emailParam.getMailFormat());
			com.agnitas.emm.springws.jaxb.Template.Formats formats = new Template.Formats();
			for (Format format : formatList) {
				formats.getFormat().add(format.getName());
			}
