...
public class MailinglistResponseBuilder {

	private final Mailinglist mailinglist;

	public MailinglistResponseBuilder(Mailinglist mailinglist) {
		this.mailinglist = mailinglist;
	}
	
	public com.agnitas.emm.springws.jaxb.Mailinglist createResponse() {
        com.agnitas.emm.springws.jaxb.Mailinglist mailinglistResponse = new com.agnitas.emm.springws.jaxb.Mailinglist();
