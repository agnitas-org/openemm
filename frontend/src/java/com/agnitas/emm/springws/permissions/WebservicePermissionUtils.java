...
public final class WebservicePermissionUtils {
	
	private static final String ENDPOINT_SUFFIX = "Endpoint"; 
	
	public static final String permissionTokenFromEndpointClass(final Class<?> endpointClass) {
		final String className = endpointClass.getSimpleName();
