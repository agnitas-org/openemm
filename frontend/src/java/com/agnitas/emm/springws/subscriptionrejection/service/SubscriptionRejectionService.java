...
public interface SubscriptionRejectionService {

	public void checkSubscriptionData(final int companyID, final RecipientModel model) throws SubscriptionRejectedException;
