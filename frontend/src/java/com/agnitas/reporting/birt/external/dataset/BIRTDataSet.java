...
public class BIRTDataSet extends LongRunningSelectResultCacheDao {
	 ...
	 */
	protected List<Map<String, Object>> selectEmbedded(String statement, Object... parameter) throws Exception {
		try {
	 ...
	 * Logs the statement and parameter in debug-level, executes select and logs error.
	 */
	protected <T> List<T> selectEmbedded(String statement, RowMapper<T> rowMapper, Object... parameter) throws Exception {
		try {
			logSqlStatement("EMBEDDED: " + statement, parameter);
	 ...
	 * Logs the statement and parameter in debug-level, executes select and logs error.
	 */
	protected <T> T selectEmbedded(String statement, Class<T> requiredType, Object... parameter) throws Exception {
		try {
			logSqlStatement("EMBEDDED: " + statement, parameter);
	 ...
	 * Logs the statement and parameter in debug-level, executes select and logs error.
	 */
	protected int selectEmbeddedIntWithDefault(String statement, int defaultValue, Object... parameter) throws Exception {
		try {
			logSqlStatement("EMBEDDED: " + statement, parameter);
	...
	protected int selectEmbeddedInt(String statement, Object... parameter) throws Exception {
	 ...
	 */
	protected int updateEmbedded(String statement, Object... parameter) throws Exception {
		try {
			logSqlStatement("EMBEDDED: " + statement, parameter);
	 ...
	 */
	protected void executeEmbedded(String statement) throws Exception {
		try {
			logSqlStatement("EMBEDDED: " + statement);
	 ...
	 */
	public int[] batchupdateEmbedded(String statement, List<Object[]> values) throws Exception {
		try {
