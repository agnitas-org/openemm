...
public interface WebStorage {
    ...
    WebStorageBundle<RowsCountWebStorageEntry> MAILING_COMPARISON_OVERVIEW = WebStorageBundle.define("mailing-comparison-overview", RowsCountWebStorageEntry.class);
    ...
    WebStorageBundle<RowsCountWebStorageEntry> ARCHIVE_MAILINGS_OVERVIEW = WebStorageBundle.define("archive-mailings-overview", RowsCountWebStorageEntry.class);
    ...
    WebStorageBundle<RowsCountWebStorageEntry> EXPORT_PROFILE_OVERVIEW = WebStorageBundle.define("export-profile-overview", RowsCountWebStorageEntry.class);
    ...
    // TODO: EMMGUI-714: replace with RowsCountWebStorageEntry when old design will be removed
