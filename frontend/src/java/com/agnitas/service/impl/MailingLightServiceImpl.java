...
public class MailingLightServiceImpl implements MailingLightService {
    
    private static final Logger logger = LogManager.getLogger(MailingLightServiceImpl.class);
    ...
    public List<LightweightMailingWithMailingList> getLightweightMailings(int companyID, int adminId,
        ...
        boolean isParentIdNotInResultsList = results.stream()
                .mapToInt(LightweightMailingWithMailingList::getMailingID)
