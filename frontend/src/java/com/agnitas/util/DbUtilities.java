...
public class DbUtilities {
	...
	public static List<String> getColumnNames(DataSource dataSource, String tableName) {
		...
		try (final Connection connection = dataSource.getConnection()) {
			...
			throw new RuntimeException("Cant get column names of table '%s'!".formatted(tableName), e);
        }
    }
	...
	public static int getColumnCount(DataSource dataSource, String tableName) {
		if (dataSource == null) {
			throw new IllegalArgumentException("Invalid empty dataSource for getColumnCount");
		} else if (StringUtils.isBlank(tableName)) {
			throw new IllegalArgumentException("Invalid empty tableName for getColumnCount");
		}
	...
	protected static String getDateDefaultValue(String fieldDefault, SimpleDateFormat fieldDefaultDateFormat, boolean isOracle) throws Exception {
