...
public class ParameterParser {
	/** The logger. */
	private static final transient Logger logger = LogManager.getLogger(ParameterParser.class);
	...
	public static String buildParameterString (Map <String, String> input) {
		return input
			.entrySet ()
			.stream ()
