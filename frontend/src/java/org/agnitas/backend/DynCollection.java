...
public class DynCollection {
	...
	private Map <Long, DynName>	names;
	/** sequence to create non database based content */
	private long			extraIDSeq;
	...
	public void collectParts() throws SQLException {
		...
		names = contentDAO.getDynamicContent (data.dbase);
		for (DynName tmp : names.values ()) {
