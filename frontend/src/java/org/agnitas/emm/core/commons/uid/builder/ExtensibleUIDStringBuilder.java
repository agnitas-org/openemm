 ...
 * 
 * For supported formats of UID see {@link ComExtensibleUID}.
 */
public interface ExtensibleUIDStringBuilder {
	 ...
	 */
    String buildUIDString(final ComExtensibleUID extensibleUID) throws RequiredInformationMissingException, UIDStringBuilderException;
