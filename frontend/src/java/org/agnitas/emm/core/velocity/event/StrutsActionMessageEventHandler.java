...
public class StrutsActionMessageEventHandler implements MethodExceptionEventHandler, InvalidReferenceEventHandler {

	private final ActionErrors errors = new ActionErrors();

	public StrutsActionMessageEventHandler(Context ctx) {
