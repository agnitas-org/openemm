 ...
 * @since 1.0.0
 */
public class AgnitasMessageDispatcherServlet extends FrameworkServlet {
	private static final long serialVersionUID = -5637150405242158516L;
	...
	private final transient DefaultStrategiesHelper defaultStrategiesHelper;
	...
	private transient WebServiceMessageReceiverHandlerAdapter messageReceiverHandlerAdapter;
	...
	private transient WsdlDefinitionHandlerAdapter wsdlDefinitionHandlerAdapter;
	...
	private transient XsdSchemaHandlerAdapter xsdSchemaHandlerAdapter;
	...
	private transient WebServiceMessageReceiver messageReceiver;

	/** Keys are bean names, values are {@link WsdlDefinition WsdlDefinitions}. */
	private transient Map<String, WsdlDefinition> wsdlDefinitions;

	private transient Map<String, XsdSchema> xsdSchemas;
	 ...
	 */
	public AgnitasMessageDispatcherServlet() {
		this(null);
	}
	 ...
	 */
	public AgnitasMessageDispatcherServlet(WebApplicationContext webApplicationContext) {
	...
	protected WsdlDefinition getWsdlDefinition(HttpServletRequest request) {
		if ((HttpTransportConstants.METHOD_GET.equals(request.getMethod()) || "HEAD".equals(request.getMethod())) &&
