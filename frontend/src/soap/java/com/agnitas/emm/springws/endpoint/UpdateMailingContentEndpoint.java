...
public class UpdateMailingContentEndpoint extends BaseEndpoint {
    ...
    public UpdateMailingContentEndpoint(
    ...
    public @ResponsePayload UpdateMailingContentResponse updateMailingContent(@RequestPayload UpdateMailingContentRequest request) {
