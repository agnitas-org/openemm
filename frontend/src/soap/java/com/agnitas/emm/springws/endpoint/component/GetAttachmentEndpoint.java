...
import com.agnitas.emm.springws.jaxb.GetAttachmentRequest;
...
public class GetAttachmentEndpoint extends BaseEndpoint {
	...
	public GetAttachmentEndpoint(ComponentService componentService, SecurityContextAccess securityContextAccess) {
