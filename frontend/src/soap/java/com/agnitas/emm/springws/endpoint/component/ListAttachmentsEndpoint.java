...
import com.agnitas.emm.springws.jaxb.ListAttachmentsRequest;
import com.agnitas.emm.springws.jaxb.ListAttachmentsResponse;
...
public class ListAttachmentsEndpoint extends BaseEndpoint {
	...
	public ListAttachmentsEndpoint(ComponentService componentService, SecurityContextAccess securityContextAccess) {
