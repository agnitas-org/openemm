...
public class UpdateContentBlockEndpoint extends BaseEndpoint {
	...
	public @ResponsePayload UpdateContentBlockResponse updateContentBlock(@RequestPayload UpdateContentBlockRequest request) {
	...
	private void validateContent(ContentModel model) {
