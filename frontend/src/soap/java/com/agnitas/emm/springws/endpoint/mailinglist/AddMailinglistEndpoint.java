...
import com.agnitas.emm.springws.jaxb.AddMailinglistRequest;
import com.agnitas.emm.springws.jaxb.AddMailinglistResponse;
...
public class AddMailinglistEndpoint extends BaseEndpoint {
    ...
    public @ResponsePayload AddMailinglistResponse addMailinglist(@RequestPayload AddMailinglistRequest request) {
