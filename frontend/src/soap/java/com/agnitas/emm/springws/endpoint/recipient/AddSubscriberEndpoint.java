...
import com.agnitas.emm.springws.jaxb.AddSubscriberRequest;
import com.agnitas.emm.springws.jaxb.AddSubscriberResponse;
...
public class AddSubscriberEndpoint extends BaseEndpoint {
	...
	private static final Logger logger = LogManager.getLogger(AddSubscriberEndpoint.class);
	...
	public @ResponsePayload AddSubscriberResponse addSubscriber(@RequestPayload AddSubscriberRequest request) throws Exception {
		logger.info("Entered AddSubscriberEndpoint.addSubscriber()");
		...
		logger.info("Leaving AddSubscriberEndpoint.addSubscriber()");

		return response;
	}

	static RecipientModel parseModel(AddSubscriberRequest request, ConfigService configService, SecurityContextAccess securityContextAccess) {
