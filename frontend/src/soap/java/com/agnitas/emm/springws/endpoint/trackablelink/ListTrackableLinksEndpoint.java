...
import com.agnitas.emm.springws.jaxb.ListTrackableLinksRequest;
import com.agnitas.emm.springws.jaxb.ListTrackableLinksResponse;
import com.agnitas.emm.springws.jaxb.ListTrackableLinksResponse.TrackableLink;
...
public class ListTrackableLinksEndpoint extends BaseEndpoint {
    ...
    public ListTrackableLinksEndpoint(
    ...
    public @ResponsePayload ListTrackableLinksResponse listTrackableLinks(@RequestPayload ListTrackableLinksRequest request) {
