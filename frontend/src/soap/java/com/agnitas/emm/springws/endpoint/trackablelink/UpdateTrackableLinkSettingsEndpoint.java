...
public class UpdateTrackableLinkSettingsEndpoint extends BaseEndpoint {
    ...
    public UpdateTrackableLinkSettingsEndpoint(
    ...
    public @ResponsePayload UpdateTrackableLinkSettingsResponse updateTrackableLinkSettingsResponse(@RequestPayload UpdateTrackableLinkSettingsRequest request) {
