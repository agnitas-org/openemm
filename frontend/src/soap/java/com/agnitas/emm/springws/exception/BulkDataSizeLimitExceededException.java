...
public class BulkDataSizeLimitExceededException extends RuntimeException {

	private static final long serialVersionUID = -9170958147019018324L;

	public BulkDataSizeLimitExceededException(String endpoint, String user, long limit, long size) {
