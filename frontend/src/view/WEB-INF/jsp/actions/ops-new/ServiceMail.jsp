    ...
    <div class="inline-tile-content" data-module-content="{{- index}}">
        ...
        <div>
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select name="modules[].mailtype" id="module_{{- index}}.mailtype" class="form-control" size="1" value="{{- mailtype}}">
                        <option value="0"><mvc:message code="Text"/></option>
                        <option value="1"><mvc:message code="mailing.Text_HTML"/></option>
                    </select>
                </div>
            </div>
            <div id="TextVersion_{{-index}}" class="inline-tile">
                ...
                <div class="inline-tile-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <textarea name="modules[].textMail" id="module_{{- index}}.textMail" rows="14" cols="70" class="form-control js-editor-text">{{- textMail}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            <div id="HTMLVersion{{-index}}" class="inline-tile">
                <div class="inline-tile-header">
                ...
                <div class="inline-tile-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <textarea name="modules[].htmlMail" id="module_{{- index}}.htmlMail" rows="14" cols="70" class="form-control js-editor">{{- htmlMail}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
