...
<%--@elvariable id="bounceFilterList" type="com.agnitas.beans.PaginatedList"--%>
                        ...
                        <c:if test="${allowedDeletion}">
                            <div class="bulk-actions hidden">
                                ...
                                <div class="bulk-actions__controls">
                                    <c:url var="bulkDeleteUrl" value="/administration/bounce/delete.action"/>
                    ...
                    <emm:table var="bounceFilter" modelAttribute="bounceFilterList" cssClass="table table-hover table--borderless js-table">
                        ...
                        <c:if test="${allowedDeletion}">
                            <emm:column title="<input class='form-check-input' type='checkbox' data-bulk-checkboxes autocomplete='off' />" cssClass="mobile-hidden" headerClass="mobile-hidden">
                                <input class="form-check-input" type="checkbox" name="bulkIds" value="${bounceFilter.id}" autocomplete="off" data-bulk-checkbox />
                            </emm:column>
                        </c:if>
                        ...
                        <c:if test="${allowedDeletion}">
                            <emm:column cssClass="table-actions mobile-hidden" headerClass="mobile-hidden">
                                <a href="<c:url value="/administration/bounce/delete.action?bulkIds=${bounceFilter.id}"/>" class="icon-btn icon-btn--danger js-row-delete" data-tooltip="${deleteMsg}">
                                    <i class="icon icon-trash-alt"></i>
                                </a>
                            </emm:column>
                        </c:if>
