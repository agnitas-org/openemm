        ...
        <div class="tile-body js-scrollable">
            <div class="row g-3">
                <div class="col-6">
                    ...
                    <mvc:select id="empfaenger_detail_anrede" cssClass="form-control" path="gender" size="1">
                ...
                <div class="col-12" data-field="password">
                    <div class="row">
                        <div class="col">
                            ...
                            <mvc:password path="password" id="password" cssClass="form-control js-password-strength" size="52" data-rule="${PASSWORD_POLICY}" data-dirty-ignore=""/>
                        </div>
                        <div class="col">
                        ...
                        <div class="col">
                            ...
                            <c:choose>
                                ...
                                <c:when test="${adminForm.adminID eq 0}">
                                    <mvc:select cssClass="form-control" path="companyID">
        ...
        <div class="tile-body js-scrollable">
            <div class="row g-3">
                <div class="col-6">
                    ...
                    <mvc:select path="language" size="1" id="language" cssClass="form-control">
                ...
                <div class="col-6">
                    ...
                    <mvc:select path="adminTimezone" size="1" id="adminTimezone" cssClass="form-control">
                ...
                <div class="col-12">
                    ...
                    <mvc:select cssClass="form-control" path="layoutBaseId" size="1" id="layoutBaseId">
                ...
                <div class="col-12">
                    ...
                    <mvc:select path="adminPreferences.mailingSettingsViewType" id="mailing-settings-view" cssClass="form-control">
