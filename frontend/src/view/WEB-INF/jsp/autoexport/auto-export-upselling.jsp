...
<div class="tile" data-sizing="container">
    <div class="tile-header" data-sizing="top">
        <h2 class="headline">
            ...
            <mvc:message code="autoExport.autoExport"/>
        </h2>
    </div>

    <div class="upselling-content auto-export-upselling" data-sizing="scroll">

        <div class="upselling-headline">
            <h3 class="upselling-title"><mvc:message code="autoExport.autoExport"/></h3>
            <h1 class="upselling-header"><mvc:message code="automation.teaser.header"/></h1>
        </div>
        <div class="upselling-desc">
            <p><mvc:message code="autoExport.teaser.text"/></p>
