...
<%--@elvariable id="form" type="com.agnitas.emm.core.campaign.forms.CampaignSimpleActionForm"--%>
...
<div class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <mvc:form servletRelativeAction="/campaign/delete.action" modelAttribute="form" method="DELETE">
