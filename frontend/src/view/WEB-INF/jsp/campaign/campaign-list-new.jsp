...
<mvc:form servletRelativeAction="/campaign/list.action" cssClass="form-vertical" id="campaignForm" modelAttribute="form" data-form="resource">
    <div class="tile">
        ...
        <div class="tile-content">
            ...
            <div class="table-wrapper">
                <display:table
                        ...
                        sort="external"
                        requestURI="/campaign/list.action"
                        partialList="true"
                        excludedParams="*">
                    ...
                    <display:column class="table-actions">
                        <emm:ShowByPermission token="campaign.change">
                            <c:url var="viewLink" value="/campaign/${campaign.id}/view.action"/>
                            <a href="${viewLink}" class="hidden js-row-show"></a>
                        </emm:ShowByPermission>
                        <emm:ShowByPermission token="campaign.delete">
                            <c:url var="deletionLink" value="/campaign/${campaign.id}/confirmDelete.action"/>
