...
<emm:instantiate var="itemActionsSettings" type="java.util.LinkedHashMap" scope="request">
    ...
    <c:if test="${form.id gt 0}">
        <emm:ShowByPermission token="campaign.delete">
            <emm:instantiate type="java.util.LinkedHashMap" var="option">
                ...
                <c:set target="${option}" property="url">
                    <c:url value="/campaign/${form.id}/confirmDelete.action"/>
                </c:set>
    ...
    <emm:ShowByPermission token="campaign.change">
        <c:url var="saveUrl" value="/campaign/save.action"/>
        <emm:instantiate type="java.util.LinkedHashMap" var="option">
            ...
            <c:set target="${option}" property="extraAttributes" value="data-form-url='${saveUrl}' data-form-target='#campaignForm' data-form-submit-static"/>
