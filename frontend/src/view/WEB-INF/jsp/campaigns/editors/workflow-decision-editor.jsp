...
<div id="decision-editor" data-initializer="decision-editor-initializer">
    <mvc:form action="" id="decisionForm" name="decisionForm" cssClass="form-column">
        ...
        <select name="decisionType" id="" data-action="decision-editor-type-change" class="form-control">
            <c:choose>
        ...
        <div id="decisionPanel" class="form-column">
            <div>
                ...
                <select id="decisionCriteria" name="decisionCriteria" class="form-control"
            ...
            <div id="decisionReactionPanel" class="form-column">
                <div>
                    ...
                    <select id="decisionReaction" name="reaction" class="form-control"
                ...
                <div>
                    ...
                    <select name="mailingId" data-action="decision-editor-mailing-select" class="form-control"></select>
                </div>

                <div id="reactionLinkPanel">
                    <label class="form-label"><mvc:message code="workflow.decision.ChooseLink"/></label>
                    <select name="linkId" class="form-control"></select>
                </div>
            </div>
            ...
            <div id="decisionProfileFieldPanel" class="form-column">
                ...
                <div style="display: none;">
                    ...
                    <div>
                        ...
                        <select id="decisionProfileField" name="profileField" class="form-control"
        ...
        <div id="autoOptimizationPanel" class="form-column">
            <div>
                ...
                <select id="aoDecisionCriteria" name="aoDecisionCriteria" class="form-control"
                        data-action="decision-editor-criteria-change">
