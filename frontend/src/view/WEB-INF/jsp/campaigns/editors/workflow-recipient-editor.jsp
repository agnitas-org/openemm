...
<div id="recipient-editor" data-initializer="recipient-editor-initializer">
    <mvc:form action="" id="recipientForm" name="recipientForm" cssClass="form-column-1">
        <div>
            ...
            <select class="recipient-editor-select form-control" name="mailinglistId" id="mailinglistSelect" data-field="required">
        ...
        <div>
            ...
            <select class="form-control" multiple id="recipientTargetSelect"
