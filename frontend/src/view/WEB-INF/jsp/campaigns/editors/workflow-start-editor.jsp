    ...
    <mvc:form action="" id="startForm" name="startForm" cssClass="form-column">
        ...
        <div id="startStopType">
            <script id="start-types" type="text/x-mustache-template">
                <div>
                    ...
                    <select name="startType" id="start-type" class="form-control" data-action="start-editor-type-changed">
            ...
            <script id="stop-types" type="text/x-mustache-template">
                <select name="endType" class="form-control" data-action="start-editor-type-changed">
        ...
        <div id="startEventPanel" class="form-column" style="display: none;">
            ...
            <div id="reactionStartPanel" class="form-column">
                ...
                <div id="reactionStartMailing">
                    ...
                    <div class="d-flex gap-1">
                        <select name="mailingId" data-action="start-editor-mailing-select" class="form-control"></select>
                ...
                <div id="reactionStartMailingLink">
                    ...
                    <select id="startReactionMailingLink" name="linkId" class="form-control"></select>
                </div>
                ...
                <div id="reactionStartProfile" class="form-column" style="display: none;">
                    <div id="reactionProfileField">
                        ...
                        <select id="startProfileField" name="profileField" class="form-control" data-action="start-editor-profile-field-changed">
                            <option value="">--</option>
                    ...
                    <select name="useRules" class="form-control" data-action="start-editor-rule-changed">
                ...
                <div>
                    ...
                    <select name="executeOnce" class="form-control" data-action="start-editor-execution-changed">
            ...
            <div id="dateStartPanel" class="form-column" style="display: none">
                <div>
                    ...
                    <select id="dateProfileField" name="dateProfileField" class="form-control">
                        <option value="">--</option>
        ...
        <div id="startRemindAdmin" data-field="toggle-vis">
            ...
            <div id="reminderDetails" class="form-column mt-2">
                <select name="userType" id="user-type" class="form-control" data-field-vis="">
                ...
                <div id="emmUsers">
                    <select id="remindAdminId" name="remindAdminId"  class="form-control">
                ...
                <div id="customRecipients">
                    ...
                    <select name="recipients" class="form-control dynamic-tags" multiple=""
                ...
                <div>
                    ...
                    <textarea id="reminderComment" name="comment" rows="1" class="form-control"></textarea>
                </div>

                <div>
                    <label class="form-label" for="remind-specific-date"><mvc:message code="workflow.start.scheduleReminder"/></label>
                    <select name="remindSpecificDate" id="remind-specific-date" class="form-control" data-action="start-editor-schedule-reminder-date-changed">
