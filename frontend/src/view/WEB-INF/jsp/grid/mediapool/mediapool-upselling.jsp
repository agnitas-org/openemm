...
<div class="tile" data-sizing="container">
    <div class="tile-header" data-sizing="top">
        <h2 class="headline">
            ...
            <mvc:message code="Mediapool"/>
        </h2>
    </div>

    <div class="upselling-content mediapool-upselling" data-sizing="scroll">

        <div class="upselling-headline">
            <h3 class="upselling-title"><mvc:message code="Mediapool"/></h3>
            <h1 class="upselling-header"><mvc:message code="mediapool.teaser.header"/></h1>
        </div>
        <div class="upselling-desc">
            <p><mvc:message code="mediapool.teaser.text"/></p>

			<c:choose>
				<c:when test="${aLocale eq 'de_DE'}">
					<a href="https://www.agnitas.de/e-marketing-manager/funktionsumfang/unterschiede-emminhouse-openemm/" class="more-info-btn" target="_blank">
				</c:when>
				<c:otherwise>
					<a href="https://www.agnitas.de/en/e-marketing_manager/functions/differences-emminhouse-openemm/" class="more-info-btn" target="_blank">
				</c:otherwise>
			</c:choose>
