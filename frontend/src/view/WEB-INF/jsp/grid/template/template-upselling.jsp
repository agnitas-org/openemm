        ...
        <div class="upselling-desc">
			...
			<c:choose>
				<c:when test="${aLocale eq 'de_DE'}">
					<a href="https://www.agnitas.de/e-marketing-manager/premium-features/mailing/" class="more-info-btn" target="_blank">
				</c:when>
				<c:otherwise>
					<a href="https://www.agnitas.de/en/e-marketing_manager/premium-features/mailing/" class="more-info-btn" target="_blank">
				</c:otherwise>
			</c:choose>
