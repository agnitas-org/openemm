...
/*Version START*/
	...
	.version--wrapper {
		background-image: url(<c:url value="/assets/core/images/logonPageOffline/Version.jpg" />);
			...
			<div class="header--wrapper wrapper flexcolumn flexitem">
				<div class="header wrapper--content flexrow flexitem">
					<div class="header__logo flexitem">
						<img src="<c:url value="/assets/core/images/logonPageOffline/AgnitasLogo.jpg"/>" />
					</div>
				...
				<div class="help wrapper--content flexrow flexitem">
					<div class="help__content flexcolumn flexitem">
						...
						<div class="help__content--image flexitem">
							<img src="<c:url value="/assets/core/images/logonPageOffline/Support.jpg" />" />
						</div>
					...
					<div class="help__content flexcolumn flexitem">
						...
						<div class="help__content--image flexitem">
							<img src="<c:url value="/assets/core/images/logonPageOffline/Tutorials.jpg" />" />
						</div>
						<div class="help__content--subline flexitem">
