...
<head>
    ...
    <tiles:insertTemplate template="/WEB-INF/jsp/page-template/assets.jsp" />
</head>
...
<div class="login-form" data-controller="login">
    <div class="login-form__header">
        ...
        <div class="login-form__version">
            ...
            <h3><mvc:message code="default.version"/></h3>
        </div>
    </div>
    ...
    <div class="login-form__body">
        ...
        <div id="popups" data-popups-options="useTabs: false, collapse: false, removeEmptyContainer: false">
            <tiles:insertTemplate template="/WEB-INF/jsp/page-template/messages.jsp" />
        </div>
    </div>
