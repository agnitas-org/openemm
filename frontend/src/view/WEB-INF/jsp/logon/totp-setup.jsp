...
<c:url var="QRCODE_URL" value="/logon/totp-qrcode.action" />
...
<div style="padding: 4vw;">
	<mvc:form servletRelativeAction="/logon/totp-setup.action" data-form-focus="authenticationCode" modelAttribute="form">
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<div style="text-align: center;">
											<img src="${QRCODE_URL}" style="margin: auto; max-width: 500px;"/>
										</div>
									</div>
								</div>
								<div class="form-group">
							...
							<div class="col-md-9">
								<div class="tile">
									...
									<div class="tile-content tile-content-forms-small" style="padding: 15px;">
											<p class="well no-border"><mvc:message code="totp.setup.info.content.twoFactor" /></p>
									</div>
								</div>
								<div class="tile">
									<div class="tile-header">
										<div class="headline">
											<mvc:message code="totp.setup.info.headline.availableApps" />
										</div>
									</div>
									<div class="tile-content tile-content-forms-small" style="padding: 15px;">
								...
								<div class="tile">
									<div class="tile-header">
										<div class="headline">
											<mvc:message code="totp.setup.info.headline.nextStep" />
										</div>
									</div>
									<div class="tile-content tile-content-forms-small" style="padding: 15px;">
											<p class="well no-border"><mvc:message code="totp.setup.info.content.nextStep" /></p>
									</div>
								</div>
								<div class="tile">
									<div class="tile-header">
										<div class="headline">
											<mvc:message code="totp.setup.info.headline.lostDevice" />
										</div>
									</div>
									<div class="tile-content tile-content-forms-small tile-content" style="padding: 15px;">
											<p class="well no-border"><mvc:message code="totp.setup.info.content.lostDevice" /></p>
									</div>
								</div>
							</div>
						</div>
