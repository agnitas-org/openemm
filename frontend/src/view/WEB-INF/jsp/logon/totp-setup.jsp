            ...
            <div class="system-tile-content">
                <mvc:form servletRelativeAction="/logon/totp-setup.action" data-form-focus="authenticationCode" modelAttribute="form">
                   	<div class="form-group">
                        <div class="col-sm-4">
                            <label class="control-label"><i class="icon icon-unlock"></i> <mvc:message code="logon.totp.codeApp"/></label>
                        </div>
                        <div class="col-sm-8">
                        	<img src="${QRCODE_URL}" />
                        </div>
                    ...
                    <div class="form-group <logic:messagesPresent property="authenticationCode">has-alert has-feedback</logic:messagesPresent>">
                        <div class="col-sm-4">
                            <label class="control-label"><i class="icon icon-unlock"></i> <mvc:message code="logon.totp.codeSetup"/></label>
                        </div>
                        <div class="col-sm-8">
