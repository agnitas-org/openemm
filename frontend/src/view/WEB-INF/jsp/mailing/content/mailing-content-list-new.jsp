...
<tiles:insert page="/WEB-INF/jsp/mailing/template.jsp">
    ...
    <tiles:put name="content" type="string">
        ...
        <c:choose>
                            ...
                            <div class="tile-content" data-initializer="mailing-content-overview">
                                <div class="tile-content-forms">
                                    <mvc:form servletRelativeAction="/mailing/content/${form.mailingID}/import.action" data-form="resource">
                                        <%@include file="./mailing-content-list-contentsource-list-new.jsp"  %>

                                        <%@include file="fragments/mailing-generate-text-from-html-new.jspf" %>

                                        <%@include file="./mailing-content-list-contentsource-datelimit-new.jsp" %>
                                    </mvc:form>
                                </div>
                    ...
                    <emm:ShowByPermission token="mailing.send.show">
                        ...
                        <emm:HideByPermission token="mailing.send.migration">
                            <c:url var="previewLink" value="/mailingsend.do">
                                ...
                                <c:param name="previewForm.format" value="${form.showHTMLEditor ? PREVIEW_FORMAT_HTML : PREVIEW_FORMAT_TEXT}"/>
                            </c:url>
                        </emm:HideByPermission>
            ...
            <c:otherwise>
                <%@include file="fragments/mailing-type-post-new.jspf" %>
            </c:otherwise>
        </c:choose>
        <c:if test="${isMailingGrid}">
            </div>
...
<%@ include file="fragments/content-editor-template-new.jspf"  %>

<%@ include file="fragments/enlarged-content-editor-template-new.jspf"  %>

<%@ include file="fragments/mailing-content-table-entry-template-new.jspf"  %>
