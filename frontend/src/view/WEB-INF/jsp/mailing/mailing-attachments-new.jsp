...
<%--@elvariable id="form" type="com.agnitas.emm.core.components.form.UpdateMailingAttachmentsForm"--%>
    ...
    <tiles:put name="content" type="string">
        <c:set var="uploadFormContent">
            <mvc:form servletRelativeAction="/mailing/${mailing.id}/attachment/upload.action"
                      ...
                      data-controller="mailing-upload-attachment-new"
                ...
                <div class="tile">
                    ...
                    <div id="tile-attachmentUpload" class="tile-content tile-content-forms" data-field="toggle-vis">
                        <div class="row">
                            ...
                            <%@include file="mailing-attachments-types-new.jsp" %>
                            <div class="col-sm-6">
                                <div class="form-group">
                            ...
                            <%@include file="mailing-attachments-uploaded-pdf-new.jspf" %>
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <div class="btn-group">
