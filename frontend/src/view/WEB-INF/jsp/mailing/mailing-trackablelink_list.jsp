<%@ page language="java" contentType="text/html; charset=utf-8" buffer="64kb" import="com.agnitas.web.ComMailingContentForm" errorPage="/error.do" %>
...
<tiles:insert page="template.jsp">
    ...
    <tiles:putList name="footerItems">
        <tiles:add>
            <button type="button" class="btn btn-large btn-primary pull-right" data-form-target='#trackableLinkForm' data-form-set='everyPositionLink: false' data-form-action="${ACTION_SAVE_ALL}">
                <span class="text">
                                            ...
                                            <tr id="link-${link.id}" data-action="elem-edited"
                                                ...
                                                <td class="align-top">
                                                    <agn:agnSelect property="linkItemTrackable[${link.id}]" styleClass="form-control">
                                                        <agn:agnOption value="0"><bean:message key="Not_Trackable" /></agn:agnOption>
                                                        <agn:agnOption value="1"><bean:message key="Only_Text_Version" /></agn:agnOption>
                                                        <agn:agnOption value="2"><bean:message key="Only_HTML_Version" /></agn:agnOption>
                                                        <agn:agnOption value="3"><bean:message key="Text_and_HTML_Version" /></agn:agnOption>
                                                    </agn:agnSelect>
                                                </td>
                        ...
                        <div class="tile">
                            ...
                            <div id="tile-trackableLinkEditAll" class="tile-content tile-content-forms" data-action="elem-edited">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <button type="button" class="btn btn-regular btn-primary" data-form-set="everyPositionLink: true" data-form-action="${ACTION_SAVE_ALL}">
								...
								<%@include file="mailing-trackablelink_list-revenue.jspf" %>
