                ...
                <agn:agnForm action="/tracklink" id="trackableLinkForm" data-form="resource">
                    ...
                    <div class="tile">
                        ...
                        <div class="${isMailingGrid ? '' : 'tile-content'} tile-content-forms">
							...
							<%@include file="mailing-trackablelink_view-revenue.jspf" %>
							<%@include file="mailing-trackablelink_static-link.jsp" %>	

                            <div class="form-group">
                                <div class="col-sm-8 col-sm-push-4">
                                    <div class="checkbox">
                                        <label>
                                            <html:checkbox property="administrativeLink"></html:checkbox>
                                            <bean:message key="report.adminLinks" />
                                        </label>
                                    </div>
                                </div>
                            </div>
