...
<div class="tile">
    <div class="tile-header">
        <a href="#" class="headline" data-toggle-tile="#tile-mediaSms">
            ...
            <bean:message key="mailing.MediaType.4"/>
        </a>
    </div>
    <div id="tile-mediaSms" class="tile-content tile-content-forms">
        <div class="form-group">
            <div class="col-sm-4">
                <label class="control-label" for="mediaSmsSender">
                    <bean:message key="mailing.Sender_Adress"/>
                </label>
            </div>
            <div class="col-sm-8">
                <html:text styleId="mediaSmsSender" styleClass="form-control" property="sms.fromAdr" />
            </div>
        </div>
            ...
            <div class="inline-tile">
                <div class="inline-tile-header">
                    ...
                    <ul class="inline-tile-header-actions">
                        <li>
                            <a href="#" data-modal="modal-editor" data-modal-set="title: <bean:message key="mailing.MediaType.4"/>, target: mediaSmsTemplate, id: mediaSmsTemplateLarge, type: text" data-tooltip="<bean:message key='editor.enlargeEditor'/>">
                ...
                <div class="inline-tile-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <html:textarea styleClass="form-control js-editor-text" styleId="mediaSmsTemplate" property="sms.template" rows="14" cols="75"/>
                        </div>
                    </div>
                </div>
            </div>
