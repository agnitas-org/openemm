...
<div class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <mvc:form servletRelativeAction="/mailing/send/activate-action-based.action">
                ...
                <div class="modal-body">
                    ...
                    <mvc:message code="mailing.action.confirm.activation" arguments="${shortname}& ${mailingSubject}& ${sizeMessage}" argumentSeparator="&"/>
                </div>
