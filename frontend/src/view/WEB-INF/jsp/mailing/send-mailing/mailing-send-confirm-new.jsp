...
<c:choose>
    <c:when test="${form.approximateMaxSizeWithoutExternalImages <= form.sizeErrorThreshold}">
        <div class="modal">
        ...
        <div class="modal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <c:set var="mailingSizeErrorThreshold" value="${emm:formatBytes(form.sizeErrorThreshold, 1, 'iec', emm:getLocale(pageContext.request))}"/>
