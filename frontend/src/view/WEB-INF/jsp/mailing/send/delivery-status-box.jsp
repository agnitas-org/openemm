...
<div class="row g-3" data-initializer="delivery-status-view">
    ...
    <c:set var="isAdminOrTest" value="${deliveryStat.lastType eq MAILDROP_STATUS_ADMIN or deliveryStat.lastType eq MAILDROP_STATUS_TEST}" />

    <c:if test="${deliveryStat.lastType ne 'NO' and (isAdminOrTest or deliveryStat.sendEndTime ne null)}">
        <div class="col-12">
            <div class="tile tile--sm tile--highlighted">
                ...
                <div class="tile-body">
                    <div class="grid gap-2" style="--bs-columns: 2;">
                        ...
                        <p><fmt:formatDate value="${isAdminOrTest ? deliveryStat.lastDate : deliveryStat.sendEndTime}" pattern="${adminDateFormat}" timeZone="${adminTimeZone}" /></p>

                        <p><mvc:message code="default.Time"/></p>
                        <p><fmt:formatDate value="${isAdminOrTest ? deliveryStat.lastDate : deliveryStat.sendEndTime}" pattern="${adminTimeFormat}" timeZone="${adminTimeZone}" /></p>
