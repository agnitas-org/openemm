                                ...
                                <div class="form-check form-switch" data-field="toggle-vis" data-field-vis-scope="#mailingSettingsForm">
                                    <c:choose>
                                        <c:when test="${mediaTypeName eq 'email'}">
                                            <c:set var="filedsToToggle" value="#html-content-tile, #text-content-tile, #subject-field, #pre-header-field, #format-fields, #sender-fields, #reply-to-fields, #envelope-email-field, #mailing-bcc-recipients, #onepixel-field"/>
                                        </c:when>
