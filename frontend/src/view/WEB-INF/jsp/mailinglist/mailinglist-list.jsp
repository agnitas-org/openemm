...
<div class="filter-overview" data-editable-view="${agnEditViewKey}" data-controller="mailinglist-list">
    <div id="table-tile" class="tile" data-editable-tile="main">
                        ...
                        <c:if test="${deleteAllowed}">
                            <div class="bulk-actions hidden">
                                ...
                                <div class="bulk-actions__controls">
                                    <a href="#" class="icon-btn icon-btn--danger" data-tooltip="<mvc:message code="bulkAction.delete.mailinglist" />" data-action="bulk-delete">
        ...
        <script id="mailinglist-delete-btn" type="text/x-mustache-template">
            <a href="{{= AGN.url('/mailinglist/' + id + '/confirmDelete.action') }}" type="button" class="icon-btn icon-btn--danger js-data-table-delete" data-tooltip="<mvc:message code="Delete" />">
                <i class="icon icon-trash-alt"></i>
            </a>
        </script>
    </div>
