                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <agn:agnSelect styleId="search_mailinglist_advanced" styleClass="form-control js-select"
                                       ...
                                       data-action="change-ml-field-advanced"
                                       data-form-change="0">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <agn:agnSelect styleId="search_recipient_type_advanced"
                                       ...
                                       titleKey="default.All"
                                       disabled="${recipientForm.listID eq -1}">
            ...
            <script id="config:target-group-query-builder" type="application/json">
                {
                    ...
                    "queryBuilderRules": ${emm:toJson(recipientForm.queryBuilderRules)},
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="btn-group pull-right">
                            ...
                            <button id="refresh-button"
                                    ...
                                    data-action="refresh-advanced-search">
