...
<mvc:form servletRelativeAction="/recipient/list.action"
          ...
          data-controller="recipient-list-new"
    ...
    <div data-form-content="">
        ...
        <div class="tile" data-initializer="recipient-list-new" data-config="">
                ...
                <ul class="tile-header-actions">
                    ...
                    <li class="tab" id="basicSearch">
                        <a href="#" data-toggle-tab="#tab-basicSearch" data-toggle-tab-method="toggle"
                           ...
                           data-sync-to="#search_mailinglist, #search_targetgroup, #search_recipient_type, #search_recipient_state" data-action="chose-basic-search">
            ...
            <div class="tile-content">
                <jsp:include page="/WEB-INF/jsp/recipient/recipient-list-basic-search-tab-new-mvc.jsp"/>
                <jsp:include page="/WEB-INF/jsp/recipient/recipient-list-advanced-search-tab-new-mvc.jsp"/>
                ...
                <div class="${deactivatePagination ? 'table-wrapper hide-pagination' : 'table-wrapper'}">
                    <display:table class="table table-bordered table-striped table-hover js-table"
                        ...
                        <c:if test="${not empty recipient}">
                            ...
                            <%@include file="/WEB-INF/jsp/recipient/additional-fields-new.jspf"%>
                            ...
                            <display:column class="table-actions" headerClass="${allowedDeletion ? '' : 'hidden'}" sortable="false">
                                ...
                                <c:if test="${allowedDeletion}">
                                    ...
                                    <a href="${deletionLink}" class="btn btn-regular btn-alert js-row-delete" tooltip="${deletionTooltip}">
