...
<c:set var="IMPORT_REPORT_FILTER" value="<%= RecipientsReport.RecipientReportType.IMPORT_REPORT.name() %>" />
<c:set var="EXPORT_REPORT_FILTER" value="<%= RecipientsReport.RecipientReportType.EXPORT_REPORT.name() %>" />
			...
			<div class="hidden">
				...
				<div class="dropdown filter" data-field="filter" data-filter-target=".js-filter-type">
					...
					<ul class="dropdown-menu dropdown-menu-left dropdown-menu-top">
						<li>
							<label class="label">
								<input type="checkbox" name="filterTypes" value="IMPORT_REPORT" data-field-filter="" ${filterImportReport}>
								<bean:message key="recipient.reports.type.import.report"/>
							</label>
						</li>
						<li>
							<label class="label">
								<input type="checkbox" name="filterTypes" value="EXPORT_REPORT" data-field-filter="" ${filterExportReport}>
								<bean:message key="recipient.reports.type.export.file"/>
							</label>
						</li>
						<li class="divider"></li>
						<li>
			...
			<div class="table-wrapper">
				<display:table class="table table-bordered table-striped table-hover js-table"
					...
					<display:column sortable="true" titleKey="default.Type" headerClass="js-table-sort js-filter-type" sortProperty="type">
						<bean:message key="recipients.report.type.${report.type.name()}"/>
					</display:column>
					...
					<display:column class="table-actions">
						...
						<html:link styleClass="hidden js-row-show" page="/recipientsreport.do?method=view&reportId=${report.id}"></html:link>
					</display:column>
				</display:table>
			</div>
		</div>
