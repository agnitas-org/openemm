...
<mvc:form servletRelativeAction="/recipient/save.action" id="recipientForm" modelAttribute="form" data-form="resource" data-controller="recipient-view-new" data-action="recipient-save">
    <mvc:hidden path="id"/>
                ...
                <div class="tile-content">
                    <div class="tile-content-forms">
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
  								<label class="toggle">
  									<mvc:checkbox path="trackingVeto" id="trackingVeto"/>
                        ...
                        <%@include file="recipient-freq-counter-new.jspf" %>
                                    ...
                                    <c:if test="${definition.shortname eq COLUMN_DATASOURCE_ID}">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <a href="<c:url value='/importexport/datasource/list.action'/>">
                                                    <input type="text" class="form-control" style="cursor: pointer" value="${form.dataSourceId}" readonly="readonly"/>
                                                </a>
                                            </div>
                                        </div>
                                    </c:if>
                                    ...
                                    <c:if test="${definition.shortname eq COLUMN_LATEST_DATASOURCE_ID}">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                ...
                                                <a href="<c:url value='/importexport/datasource/list.action'/>">
                                                    <input type="text" class="form-control" style="cursor: pointer" value="${form.latestDataSourceId}" readonly="readonly"/>
                                                </a>
                                            </div>
                                        </div>
                                    </c:if>
                                                ...
                                                <c:when test="${definition.dataType eq GENERIC_TYPE_DATETIME and definition.writable}">
                                                    ...
                                                    <div class="js-datetime-field" data-field="datetime"
                                                         ...
                                                         data-field-options="value: '${form.additionalColumns[definition.columnName]}',
                                                                                format: '${fn:toLowerCase(adminDateFormat)}',
