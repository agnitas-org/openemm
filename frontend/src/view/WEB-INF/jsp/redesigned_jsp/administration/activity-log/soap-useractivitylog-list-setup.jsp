...
<c:url var="switchDesignUrl" value="/administration/soap-user/activitylog/list.action" scope="request" />
...
<emm:instantiate var="itemActionsSettings" type="java.util.LinkedHashMap" scope="request">
    <c:url var="csvDownloadUrl" value="/administration/soap-user/activitylog/downloadRedesigned.action" />
