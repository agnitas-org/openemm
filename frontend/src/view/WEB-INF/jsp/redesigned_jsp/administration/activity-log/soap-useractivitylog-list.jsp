...
<div class="filter-overview" data-editable-view="${agnEditViewKey}">
    <mvc:form id="table-tile" servletRelativeAction="/administration/soap-user/activitylog/listRedesigned.action" modelAttribute="filter" cssClass="tile" data-editable-tile="main">
