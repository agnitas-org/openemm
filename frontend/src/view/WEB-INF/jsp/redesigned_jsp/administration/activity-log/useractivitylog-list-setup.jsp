...
<c:url var="switchDesignUrl" value="/administration/useractivitylog/list.action" scope="request" />
...
<emm:instantiate var="itemActionsSettings" type="java.util.LinkedHashMap" scope="request">
    ...
    <c:url var="csvDownloadUrl" value="/administration/useractivitylog/downloadRedesigned.action" />
