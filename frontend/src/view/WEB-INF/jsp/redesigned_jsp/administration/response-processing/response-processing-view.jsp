            ...
            <div class="modal-body js-scrollable">
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        <div class="switchable-input">
                            <div class="switchable-input__header">
                                <label class="switchable-input__label" for="forwardEmail">
                                    <mvc:message code="settings.mailloop.forward"/> <a href="#" class="icon icon-question-circle" data-help="help_${helplanguage}/settings/ForwardFilteredMails.xml"></a>
                                </label>
                                <div class="switchable-input__switch">
