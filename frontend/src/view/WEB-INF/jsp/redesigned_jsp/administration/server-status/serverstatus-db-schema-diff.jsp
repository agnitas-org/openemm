    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title"><mvc:message code="GWUA.checkDbSchema.diff" /></h1>
            ...
            <div class="modal-body vstack gap-3">
                    ...
                    <div class="table-wrapper">
                        ...
                        <div class="table-wrapper__body">
                            <table class="table table--borderless">
                                <thead>
                                <tr>
                                    <th><mvc:message code="GWUA.missingTables" /></th>
                                    <th><mvc:message code="GWUA.obsoleteTables" /></th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                ...
                <c:if test="${not empty checkResult.missingColumns}">
                    <div class="table-wrapper">
                        <div class="table-wrapper__header">
                            <h1 class="table-wrapper__title"><mvc:message code="GWUA.missingColumns" /></h1>
                        </div>
                        <div class="table-wrapper__body">
                            <table class="table table--borderless">
                                <thead>
                ...
                <c:if test="${not empty checkResult.columnsWithMismatchedTypes}">
                    <div class="table-wrapper">
                        <div class="table-wrapper__header">
                            <h1 class="table-wrapper__title"><mvc:message code="GWUA.columnsWithMismatchedTypes" /></h1>
                        </div>
                        <div class="table-wrapper__body">
                            <table class="table table--borderless">
                                <thead>
                ...
                <c:if test="${not empty checkResult.columnsWithMismatchedLength}">
                    <div class="table-wrapper">
                        <div class="table-wrapper__header">
                            <h1 class="table-wrapper__title"><mvc:message code="GWUA.columnsWithMismatchedLength" /></h1>
                        </div>
                        <div class="table-wrapper__body">
                            <table class="table table--borderless">
                                <thead>
