...
<c:set var="agnEditViewKey" 	    value="user-groups-overview" 	scope="request" />
        ...
        <emm:instantiate var="element" type="java.util.LinkedHashMap">
            ...
            <emm:instantiate var="option" type="java.util.LinkedHashMap">
                ...
                <c:set target="${option}" property="name">
                    <mvc:message code="bulkAction.delete.usergroup" />
                </c:set>
            </emm:instantiate>
        </emm:instantiate>
    </emm:instantiate>
...
<emm:ShowByPermission token="role.change">
    <emm:instantiate var="newResourceSettings" type="java.util.LinkedHashMap" scope="request">
        <emm:instantiate var="element" type="java.util.LinkedHashMap">
            ...
            <c:set target="${element}" property="url"><c:url value="/administration/usergroup/create.action"/></c:set>
