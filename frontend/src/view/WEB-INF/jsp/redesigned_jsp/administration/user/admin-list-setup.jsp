...
<c:set var="agnEditViewKey" 	    value="admins-overview"             scope="request" />
...
<emm:ShowByPermission token="admin.new">
    <emm:instantiate var="newResourceSettings" type="java.util.LinkedHashMap" scope="request">
        <emm:instantiate var="element" type="java.util.LinkedHashMap">
            ...
            <c:set target="${element}" property="url"><c:url value="/admin/create.action"/></c:set>
        </emm:instantiate>
    </emm:instantiate>
    ...
    <emm:instantiate var="element" type="java.util.LinkedHashMap">
        <emm:instantiate var="element" type="java.util.LinkedHashMap">
            ...
            <emm:instantiate var="option" type="java.util.LinkedHashMap">
                ...
                <c:set target="${option}" property="url"><c:url value="/admin/list/export/csv.action"/></c:set>
            ...
            <emm:instantiate var="option" type="java.util.LinkedHashMap">
                ...
                <c:set target="${option}" property="url"><c:url value="/admin/list/export/pdf.action"/></c:set>
                <c:set target="${option}" property="extraAttributes" value="data-prevent-load"/>
