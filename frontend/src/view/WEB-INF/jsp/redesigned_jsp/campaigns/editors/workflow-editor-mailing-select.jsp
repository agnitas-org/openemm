...
<div class="form-column">
    <div>
        ...
        <select name="${param.statusName}" id="${param.containerId}-mailing-status-select" class="form-control js-select" data-action="${param.baseMailingEditor}-status-change">
    ...
    <div>
        ...
        <div class="d-flex gap-1">
            <select name="${param.selectName}" id="${param.containerId}-mailing-select" class="form-control js-select"
