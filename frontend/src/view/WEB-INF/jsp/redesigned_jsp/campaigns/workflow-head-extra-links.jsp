...
<%--css--%>
<link rel="stylesheet" href="<c:url value='/assets/core/styles/common/jquery-ui.css'/>"/>
<link rel="stylesheet" href="<c:url value='/assets/core/styles/common/jquery.contextMenu.css'/>"/>
