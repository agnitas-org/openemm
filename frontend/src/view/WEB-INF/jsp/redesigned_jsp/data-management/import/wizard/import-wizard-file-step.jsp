            ...
            <div class="row g-3">
                    ...
                    <div class="row g-1">
                        <div class="col-12">
                            <label for="csvFile" class="form-label">
                                ...
                                <a href="#" type="button" class="icon icon-question-circle" data-help="help_${helplanguage}/importwizard/step_1/FileName.xml"></a>
                            </label>
                ...
                <div class="col-12">
                    <label class="form-label" for="separator">
                        ...
                        <a href="#" type="button" class="icon icon-question-circle" data-help="help_${helplanguage}/importwizard/step_1/Separator.xml"></a>
                    </label>

                    <mvc:select id="separator" path="helper.status.separator" cssClass="form-control js-select" size="1">
                ...
                <div class="col-12">
                    <label class="form-label" for="delimiter">
                        ...
                        <a href="#" type="button" class="icon icon-question-circle" data-help="help_${helplanguage}/importwizard/step_1/Delimiter.xml"></a>
                    </label>

                    <mvc:select id="delimiter" path="helper.status.delimiter" cssClass="form-control js-select" size="1">
                ...
                <div class="col-12">
                    <label class="form-label" for="charset">
                        ...
                        <a href="#" type="button" class="icon icon-question-circle" data-help="help_${helplanguage}/importwizard/step_1/Charset.xml"></a>
                    </label>

                    <mvc:select id="charset" path="helper.status.charset" cssClass="form-control js-select" size="1">
                ...
                <div class="col-12">
                    ...
                    <mvc:select id="deteformat" path="helper.dateFormat" cssClass="form-control js-select" size="1">
