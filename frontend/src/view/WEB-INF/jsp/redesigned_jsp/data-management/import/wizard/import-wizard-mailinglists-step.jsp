        ...
        <div class="tile-body vstack gap-3 js-scrollable">
            <div class="notification-simple notification-simple--lg notification-simple--info">
                <span>
                    ...
                    <a href="#" type="button" class="icon icon-question-circle" data-help="importwizard/step_6/SubscribeLists.xml"></a>
                </span>
            </div>
            <div>
                <div class="bordered-box-sm">
                    <div class="row g-2">
                        <div class="col-12">
                            <h3 class="text-secondary"><mvc:message code="Mailinglists"/></h3>
                        </div>
