            ...
            <div class="row g-3">
                <div class="col-12">
                    <label class="form-label" for="import-mode">
                        ...
                        <a href="#" type="button" class="icon icon-question-circle" data-help="help_${helplanguage}/importwizard/step_2/Mode.xml"></a>
                    </label>

                    <mvc:select id="import-mode" path="helper.mode" size="1" cssClass="form-control js-select">
                ...
                <div class="col-12">
                    <label class="form-label" for="import-keycolumn">
                        ...
                        <a href="#" type="button" class="icon icon-question-circle" data-help="help_${helplanguage}/importwizard/step_2/KeyColumn.xml"></a>
                    </label>

                    <mvc:select id="import-keycolumn" path="helper.status.keycolumn" size="1" cssClass="form-control js-select">
                ...
                <emm:ShowByPermission token="import.mode.doublechecking">
                    <div class="col-12">
                        <label class="form-label" for="import-doublecheck">
                            ...
                            <a href="#" type="button" class="icon icon-question-circle" data-help="help_${helplanguage}/importwizard/step_2/Doublechecking.xml"></a>
                        </label>
                        <mvc:select id="import-doublecheck" path="helper.status.doubleCheck" size="1" cssClass="form-control js-select">
