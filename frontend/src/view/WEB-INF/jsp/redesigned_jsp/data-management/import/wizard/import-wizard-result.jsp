...
<%@ page language="java" contentType="text/html; charset=utf-8" import="org.agnitas.util.importvalues.ImportMode" errorPage="/errorRedesigned.action" %>
        ...
        <div class="tile-body js-scrollable">
            <div class="row g-3">
                <c:choose>
                    <c:when test="${empty importError}">
                        <c:if test="${importWizardSteps.helper.dbInsertStatus > 100}">
                            <c:forEach var="messageAndParameter" items="${importWizardSteps.dbInsertStatusMessagesAndParameters}">
                                <div class="col-12">
                                    <div class="panel text-bg-success">
                                        <h2 class="text-white">
                    ...
                    <c:otherwise>
                        <div class="col-12">
                            <div class="panel text-bg-danger">
                                <h2>${importError}</h2>
                            </div>
                        </div>
                    </c:otherwise>
