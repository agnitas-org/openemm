...
<%--@elvariable id="attachments" type="com.agnitas.beans.impl.PaginatedListImpl<com.agnitas.emm.core.components.dto.MailingAttachmentDto>"--%>
                ...
                <div class="table-wrapper__body">
                    <emm:table var="attachment" modelAttribute="attachments" cssClass="table table--borderless js-table">
                        ...
                        <emm:column sortable="true" titleKey="Target" sortProperty="targetId">
                            ...
                            <mvc:select path="attachments[${attachment_index}].targetId" cssClass="form-control js-select" disabled="${not isMailingEditable}">
