...
<c:choose>
    ...
    <c:otherwise>
        <div id="mailing-content-blocks-new-ux" class="tiles-container"
             data-controller="mailing-content-controller-new-ux"
             data-editable-view="${agnEditViewKey}">
            <script data-initializer="mailing-content-initializer-new-ux" type="application/json">
                {
            ...
            <div id="content-blocks-tile" class="tile" data-editable-tile="main" style="flex: 1 1 55%">
                ...
                <mvc:form id="frame-content-tab" cssClass="tile-body hidden" servletRelativeAction="/mailing/${mailingId}/frame.action" modelAttribute="frameContentForm"
                          ...
                          data-form="resource"
                          data-resource-selector="#mailing-content-blocks-new-ux">
                    <c:set var="showText" value="${isEmailMediaTypeActive or isMailingGrid}"/>
                    <jsp:include page="../settings/tiles/mailing-frame-content-tab-new-ux.jsp">
