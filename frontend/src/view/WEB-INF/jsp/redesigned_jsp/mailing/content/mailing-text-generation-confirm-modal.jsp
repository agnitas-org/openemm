    ...
    <div class="modal-dialog modal-fullscreen-lg-down modal-dialog-centered">
        <mvc:form cssClass="modal-content" servletRelativeAction="/mailing/content/${mailingId}/text-from-html/generate.action">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-danger flex-grow-1 js-confirm-negative" data-dismiss="modal">
                    <i class="icon icon-times"></i>
                    <mvc:message code="default.No"/>
                </button>
                <button type="button" class="btn btn-primary btn-large flex-grow-1 js-confirm-positive" data-dismiss="modal">
