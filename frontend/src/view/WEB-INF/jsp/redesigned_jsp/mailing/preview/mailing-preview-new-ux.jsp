            ...
            <div class="tile-header d-flex flex-column" style="align-items: unset" data-show-by-checkbox="#sender-info-toggle">
                ...
                <c:if test="${not empty attachments}">
                    <div class="input-group w-100">
                        ...
                        <select id="attachments" class="form-control js-select">
                            ${attachments}
                        </select>
                ...
                <div id="to-input-group" class="input-group">
                    ...
                    <mvc:select id="preview-mode" path="modeType" cssClass="form-control js-select"
                    ...
                    <c:choose>
                        <c:when test="${form.modeType eq ModeType.RECIPIENT}">
                            <mvc:select id="recipients" path="customerATID" cssClass="form-control js-select" data-action="change-header-data" data-sort="alphabetic">
                        ...
                        <c:when test="${form.modeType eq ModeType.TARGET_GROUP}">
                            <mvc:select id="target-groups" path="targetGroupId" data-action="change-stored-header-data" cssClass="form-control js-select">
                ...
                <%@include file="fragments/preview-add-to-test-run-new-ux.jspf" %>
            </div>
        </c:if>
