...
<emm:ShowByPermission token="mailing.show.types">
    ...
    <div class="${mailingTypeContainerClass}">
        ...
        <mvc:select path="mailingType" id="settingsGeneralMailType" cssClass="form-control js-select"
                                ...
                                <div class="form-check form-switch" data-field="toggle-vis" data-field-vis-scope="#mailingSettingsForm">
                                    <c:choose>
                                        <c:when test="${mediaTypeName eq 'email'}">
                                            <c:set var="filedsToToggle" value="#html-content-tile, #text-content-tile, #subject-field, #pre-header-field, #format-field, #charset-field, #sender-email-field, #sender-name-field, #reply-to-email-field, #reply-to-name-field, #envelope-email-field, #mailing-bcc-recipients, #onepixel-field"/>
                                        </c:when>
                                        <c:when test="${mediaTypeName eq 'sms'}">
                                            <c:set var="filedsToToggle" value="#sms-address-field, #sms-content-tile"/>
                                        </c:when>
                                        <c:otherwise>
...
<c:if test="${not isNewGridMailing || isCopying}">
    ...
    <div id="format-field">
        ...
        <mvc:select path="emailMediatype.mailFormat" id="emailMailFormat" cssClass="form-control js-select" disabled="${emailSettingsDisabled or isSettingsReadonly}">
