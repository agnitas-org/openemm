<%@ page language="java" contentType="text/html; charset=utf-8" import="org.agnitas.web.*" errorPage="/errorRedesigned.action" %>
...
<mvc:message var="agnHeadLineFirstCrumb"   code="settings.FormsOfAddress"    scope="request"/>
