        ...
        <div class="tile-body">
            <div class="row g-3">
                <div class="col">
                    ...
                    <mvc:select id="top10MetricsId" path="top10MetricsId" cssClass="form-control js-select">
    ...
    <div id="overview-tile" class="tile" data-editable-tile="main">
        <div class="tile-header">
            ...
            <div class="tile-title-controls">
                ...
                <mvc:select path="startYear" cssClass="form-control js-select" data-select-options="dropdownAutoWidth: true, width: 'auto'">
