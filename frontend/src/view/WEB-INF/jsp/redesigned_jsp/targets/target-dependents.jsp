...
<mvc:form cssClass="table-wrapper" servletRelativeAction="/target/${targetId}/dependentsRedesigned.action" method="GET" modelAttribute="paginationForm" data-form="resource" data-resource-selector=".table-wrapper">
