    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <img src="<c:url value="/assets/core/images/upselling/Generic.svg" />" alt="Feature">
            </div>
            <div class="modal-body vstack gap-3">
                <h2><mvc:message code="upselling.headline.generic"/></h2>
                <p><mvc:message code="upselling.description.generic"/></p>
                <p><mvc:message code="upselling.feature.interest" /></p>
            </div>
            <div class="modal-footer">
                <c:choose>
                    <c:when test="${adminLocale eq 'de_DE'}">
                        <c:set var="moreInfoUrl" value="https://www.agnitas.de/e-marketing-manager/premium-features/cross-media" />
                    </c:when>
                    <c:otherwise>
                        <c:set var="moreInfoUrl" value="https://www.agnitas.de/en/e-marketing_manager/premium-features/cross-media" />
                    </c:otherwise>
                </c:choose>
