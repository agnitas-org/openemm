            ...
            <div class="modal-footer">
                <c:choose>
                    <c:when test="${adminLocale eq 'de_DE'}">
                        <c:set var="moreInfoUrl" value="https://www.agnitas.de/e-marketing-manager/premium-features/mailing" />
                    </c:when>
                    <c:otherwise>
                        <c:set var="moreInfoUrl" value="https://www.agnitas.de/en/e-marketing_manager/premium-features/mailing" />
                    </c:otherwise>
                </c:choose>
