...
<%--@elvariable id="doiMailings" type="java.util.Map<java.lang.Integer, org.agnitas.emm.core.mailing.beans.LightweightMailingWithMailingList>"--%>
    ...
    <div id="settings-tile" class="tile" data-editable-tile>
        ...
        <div class="tile-body vstack gap-3 js-scrollable">
            <div>
                ...
                <select id="widget-type" class="form-control js-select" readonly>
            ...
            <mvc:form servletRelativeAction="/widget/subscribe/token.action" modelAttribute="subscribeSettingsForm" cssClass="vstack gap-inherit"
                ...
                <div class="d-flex flex-column gap-inherit" data-field="double-select" data-provider="opt" data-provider-src="SubscribeWidgetDOIMailings">
                    <div>
                        ...
                        <mvc:select id="subscribe-widget-mailinglist" path="mailinglistId" cssClass="form-control js-select js-double-select-trigger">
                    ...
                    <div>
                        ...
                        <mvc:select id="subscribe-widget-doi-mailing" path="doiMailingId" cssClass="form-control js-select js-double-select-target" data-field="required">
                            <%-- Loads by JS --%>
                        </mvc:select>
                    </div>
                </div>
