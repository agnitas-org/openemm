<%@ page contentType="text/html; charset=utf-8" errorPage="/error.action" import="java.util.Locale,com.agnitas.beans.AdminPreferences" %>
<%@ page import="com.agnitas.emm.core.admin.enums.UiLayoutType" %>
<%@ page import="com.agnitas.emm.core.loginmanager.enums.LoginStatus" %>
        ...
        <div class="tile-body js-scrollable">
            <div class="row g-3">
                <div class="col-6">
                    ...
                    <mvc:select id="gender" path="gender" cssClass="form-control">
                ...
                <div class="col-12">
                    ...
                    <mvc:select path="groupIDs" id="groupIDs" cssClass="form-control" multiple="true" disabled="${not setUserGroupAllowed}">
                ...
                <div class="col-12">
                    <div class="tile tile--sm">
                        ...
                        <div class="tile-body row g-3" data-field="password">
                            ...
                            <div class="col">
                                <label class="form-label text-nowrap" for="repeat"><mvc:message code="settings.admin.Confirm"/></label>
                ...
                <div class="col-6">
                    ...
                    <mvc:select path="adminLocale" id="language" cssClass="form-control">
                ...
                <div class="col-6">
                    ...
                    <mvc:select path="adminTimezone" id="adminTimezone" cssClass="form-control">
                ...
                <div class="col-12">
                    ...
                    <mvc:select path="layoutBaseId" id="layoutBaseId" cssClass="form-control">
                ...
                <div class="col-12">
                    ...
                    <mvc:select path="uiLayoutType" id="uiLayoutType" cssClass="form-control">
                ...
                <div class="col-12">
                    <label class="form-label" for="mailing-settings-view"><mvc:message code="admin.settings.mailing.view"/></label>
                    <mvc:select path="mailingSettingsViewType" id="mailing-settings-view" cssClass="form-control">
                        <c:forEach var="view" items="${MailingSettingsViewType.values()}">
                            <mvc:option value="${view}"><mvc:message code="${view.msgKey}"/></mvc:option>
                        </c:forEach>
                    </mvc:select>
                </div>
                ...
                <div class="col-12">
                    ...
                    <mvc:select path="statisticLoadType" id="statisticLoadType" cssClass="form-control">
                ...
                <div class="table-wrapper">
                    ...
                    <div class="table-wrapper__body">
                        <emm:table var="loginData" modelAttribute="loginTrackingList" pageSize="${selfForm.numberOfRows}"
                            ...
                            <%--@elvariable id="loginData" type="com.agnitas.emm.core.loginmanager.bean.LoginData"--%>
