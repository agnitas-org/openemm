...
<c:set var="agnTitleKey" 			value="settings.RestfulUser" 					scope="request" />                <!-- Titelleiste -->
<c:set var="agnSubtitleKey" 		value="settings.RestfulUser" 					scope="request" />             <!-- ueber rechte Seite -->
...
<c:choose>
	...
	<c:otherwise>
		<c:set var="agnHighlightKey" value="settings.New_RestfulUser" scope="request" />
	</c:otherwise>
</c:choose>
