...
<div class="modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <mvc:form servletRelativeAction="/restfulUser/${adminForm.adminID}/delete.action" modelAttribute="adminForm" data-form="resource">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><mvc:message code="settings.RestfulUser"/>:&nbsp;${adminForm.username}</h4>
                </div>
                <div class="modal-body">
                    <mvc:message code="settings.RestfulUserDeleteQuestion"/>
                </div>
