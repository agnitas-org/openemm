...
<mvc:form id="PermissionForm" servletRelativeAction="/restfulUser/${adminRightsForm.adminID}/rights/view.action" modelAttribute="adminRightsForm">
	<div class="tile">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="#" data-toggle-tile-all="expand">
                                <span class="text">
                                    <mvc:message code ="settings.RestfulUser.expand_all"/>
                                </span>
							</a>
						</li>
						<li>
							<a href="#" data-toggle-tile-all="collapse">
                                <span class="text">
                                    <mvc:message code ="settings.RestfulUser.collapse_all"/>
                                </span>
							</a>
						</li>
					</ul>
