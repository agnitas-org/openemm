...
<mvc:form servletRelativeAction="/restfulUser/${adminForm.adminID}/view.action" data-form-focus="username" modelAttribute="adminForm" accept-charset="UTF-8" data-form="${adminForm.adminID <= 0 ? 'resource' :''}">
    <input type="hidden" name="delete" value=""/>
    <input type="hidden" name="save" value=""/>

    <div class="tile">
        <div class="tile-header">
            <h2 class="headline"><mvc:message code="settings.RestfulUser.edit"/></h2>
        </div>
        <div class="tile-content tile-content-forms" data-form-content>
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <label class="control-label" for="companyName"><mvc:message code="settings.RestfulUser.company"/> *</label>
                </div>
                <div class="col-sm-8">
    ...
    <div class="tile">
        ...
        <div class="tile-content tile-content-forms">
                ...
                <div class="form-group">
                    <div class="col-sm-4">
                        <label class="control-label" for="password">
                            ...
                            <button class="icon icon-help" data-help="help_${helplanguage}/restfuluser/AdminPasswordRules.xml" tabindex="-1" type="button"></button>
                        </label>
                    </div>
                    <div class="col-sm-8">
            ...
            <div class="form-group">
                <div class="col-sm-4">
                    <label class="control-label" for="email"><mvc:message code="settings.RestfulUser.email"/> *</label>
                </div>
                <div class="col-sm-8">
