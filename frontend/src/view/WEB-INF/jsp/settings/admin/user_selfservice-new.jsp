...
<%--@elvariable id="adminForm" type="com.agnitas.emm.core.user.form.UserSelfForm"--%>
...
<mvc:form servletRelativeAction="/selfservice/save.action" data-form="search" data-form-focus="username" modelAttribute="adminForm">
    <mvc:hidden path="id"/>
...
<mvc:form servletRelativeAction="/selfservice/view.action" data-form="search" modelAttribute="adminForm">
    <div class="tile">
        <div class="tile-header">
        ...
        <div class="tile-content" data-form-content="">
            ...
            <div class="table-wrapper">
                <display:table
                        ...
                        id="loginData"
                        name="loginTrackingList"
                        pagesize="${adminForm.numberOfRows}"
                        sort="list"
                        requestURI="/selfservice/view.action"
                        excludedParams="*"
                >
