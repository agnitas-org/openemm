...
<c:if test="${showSupervisorPermissionManagement}">
    <mvc:form servletRelativeAction="/selfservice/grantSupervisorPermission.action" modelAttribute="supervisorLoginForm" data-form="resource">
        <div class="tile">
            ...
            <div class="tile-content">
                <div class="table-wrapper table-overflow-visible">
                    <display:table
                        ...
                        <c:url value="/selfservice/revokeSupervisorPermission.action" var="REVOCATION_URL">
