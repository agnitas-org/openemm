...
<!-- ----------Updatecheck------------------------------------------------------------- -->
					<div class="form-group" style="padding:5px; margin-left:-12px !important; margin-right:-12px !important;">
						<div class="col-sm-12 col-xs-12">
							...
							<button type="button" class="btn btn-primary btn-regular col-sm-12 col-xs-12" data-form-url="${updatecheckUrl}" data-form-submit="" style="white-space: normal; padding:5px">
...
<!-- ----------Download config--------------------------------------------------------- -->
					<div class="form-group" style="padding:5px; margin-left:-12px !important; margin-right:-12px !important;">
						<div class="col-sm-12 col-xs-12">
							...
							<a href="${configDownloadAction}" class="btn btn-primary btn-regular col-sm-12 col-xs-12" style="white-space: normal; padding:5px">
...
<!-- ----------Jobstart------------------------------------------------------------- -->
					<div class="form-group" style="padding:5px; margin-left:-12px !important; margin-right:-12px !important;">
						...
						<div class="col-sm-5 col-xs-12 pull-right">
							...
							<button type="button" class="btn btn-primary btn-regular col-sm-12 col-xs-12" data-form-url="${jobStartUrl}" data-form-submit="" style="white-space: normal; padding:5px">
...
<!-- ----------Send Testmails------------------------------------------------------------- -->
					<div class="form-group" style="padding:5px; margin-left:-12px !important; margin-right:-12px !important;">
						...
						<div class="col-sm-5 col-xs-12 pull-right">
							...
							<button type="button" class="btn btn-primary btn-regular col-sm-12 col-xs-12" data-form-url="${testMailSendUrl}" data-form-submit="" style="white-space: normal; padding:5px">
...
<!-- ----------Diagnostic Information------------------------------------------------------------- -->
					<div class="form-group" style="padding:5px; margin-left:-12px !important; margin-right:-12px !important;">
						...
						<div class="col-sm-5 col-xs-12 pull-right">
							...
							<button type="button" class="btn btn-primary btn-regular col-sm-12 col-xs-12" data-form-url="${testDiagnosisSend}" data-form-submit="" style="white-space: normal; padding:5px">
								<mvc:message code="settings.diagnosis.send" />
							</button>
						</div>
					</div>
<!-- ----------Button Group------------------------------------------------------------- -->
					<div class="form-group vspace-top-20" style="margin-bottom: 0;">
