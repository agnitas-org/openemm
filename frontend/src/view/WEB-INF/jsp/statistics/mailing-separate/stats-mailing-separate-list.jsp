...
<%--@elvariable id="mailingStatisticList" type="com.agnitas.beans.PaginatedList"--%>
    ...
    <div id="filter-tile" class="tile" data-toggle-tile data-editable-tile>
        ...
        <div class="tile-body form-column js-scrollable">
            ...
            <div>
                ...
                <mvc:select id="archives-filter" cssClass="form-control" path="filterArchives" multiple="multiple">
