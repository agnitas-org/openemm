        ...
        <div id="delivery-settings-tile" class="tile" data-editable-tile>
            ...
            <div class="tile-body vstack gap-3 js-scrollable" data-field="toggle-vis">
                <div>
                    ...
                    <mvc:select id="emailAddresses" path="emailAddresses" dynamicTags="true" cssClass="form-control"
                                placeholder="${emailPlaceholder}" data-select-options="selectOnClose: true" />
                </div>
                ...
                <div>
                    ...
                    <div class="row g-1">
                        <div class="col-12">
                            <mvc:select id="interval" path="type" cssClass="form-control" data-field-vis="" data-action="interval-change">
                        ...
                        <div id="interval-month-block" class="col-12">
                            <mvc:select path="reportMonthly" cssClass="form-control">
                        ...
                        <div id="interval-dispatch-block" class="col-12">
                            <mvc:select path="afterMailing" id="afterMailing" cssClass="form-control" size="1">
                ...
                <div id="interval-time-block" class="has-feedback">
                ...
                <div>
                    ...
                    <mvc:select path="format" id="format" cssClass="form-control" size="1">
    ...
    <div id="extended-settings-tile" class="tile" data-editable-tile>
        <div class="tile-header p-2">
            <nav class="navbar navbar-expand-lg">
                <a class="btn btn-header-tab active w-0" href="#">
                ...
                <div class="collapse navbar-collapse offcanvas" tabindex="-1" id="report-settings-tabs">
                    <ul class="navbar-nav offcanvas-body">
                        <li class="nav-item">
                            <a class="btn btn-header-tab" href="#" data-toggle-tab="#settings_${COMPARISON_KEY}" data-form-set="activeTab: ${COMPARISON_KEY}" data-bs-dismiss="offcanvas">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-header-tab" href="#" data-toggle-tab="#settings_${MAILING_KEY}" data-form-set="activeTab: ${MAILING_KEY}" data-bs-dismiss="offcanvas">
                        ...
                        <li class="nav-item">
                            <a class="btn btn-header-tab" href="#" data-toggle-tab="#settings_${RECIPIENT_KEY}" data-form-set="activeTab: ${RECIPIENT_KEY}" data-bs-dismiss="offcanvas">
                        ...
                        <c:if test="${isMailTrackingEnabled}">
                            <li class="nav-item">
                                <a class="btn btn-header-tab" href="#" data-toggle-tab="#settings_${TOP_DOMAIN_KEY}" data-form-set="activeTab: ${TOP_DOMAIN_KEY}" data-bs-dismiss="offcanvas">
        ...
        <div id="settings_${MAILING_KEY}" class="tile-body vstack gap-3 js-scrollable" data-initializer="report-settings" data-field="toggle-vis"
            ${birtReportForm.activeTab eq MAILING_KEY or isReportTypeAfterMailing? 'data-tab-show="true"' : 'data-tab-hide="true"'}>
        ...
        <c:if test="${isMailTrackingEnabled}">
            <div id="settings_${TOP_DOMAIN_KEY}" class="tile-body vstack gap-3 js-scrollable" data-field="toggle-vis"
                ${birtReportForm.activeTab eq TOP_DOMAIN_KEY and not isReportTypeAfterMailing ? 'data-tab-show="true"' : 'data-tab-hide="true"'}>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" data-form-submit>
