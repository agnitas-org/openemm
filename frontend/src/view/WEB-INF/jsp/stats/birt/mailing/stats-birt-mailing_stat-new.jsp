...
<%--@elvariable id="birtStatForm" type="com.agnitas.web.forms.birtStatForm"--%>
...
<c:if test="${birtStatForm.reportName eq 'top_domains.rptdesign' && isEverSent eq false}">
...
<tiles:insert page="/WEB-INF/jsp/mailing/template.jsp">
    ...
    <tiles:put name="content" type="string">
        <div class="${isMailingGrid ? "tile-content-padded" : "row"}">
            <div class="col-xs-12">
                <mvc:form servletRelativeAction="/mailing_stat/view.action" method="post" modelAttribute="birtStatForm">
                    ...
                    <div class="tile">
                        ...
                        <div id="tile-statisticsMailing" class="tile-content tile-content-forms">
                            ...
                            <c:if test="${birtStatForm.reportName eq 'top_domains.rptdesign'}">
                                <div class="form-group">
                                    <div class="col-sm-4">
                            ...
                            <c:if test="${isReportCanBeShown && (birtStatForm.dateSelectMode ne 'NONE')}">
                                <ul class="tile-header-nav">
                                    <li class="${birtStatForm.dateSelectMode == 'LAST_TENHOURS' ? 'active' : ''}">
                                        <a href="#" data-form-set="dateSelectMode:LAST_TENHOURS,reportName:${birtStatForm.reportName}" data-form-submit>
                                            <mvc:message code="TenHours"/>
                                        </a>
                                    </li>
                                    <li class="${birtStatForm.dateSelectMode == 'SELECT_DAY' ? 'active' : ''}">
                                        <a href="#" data-form-set="dateSelectMode:SELECT_DAY,reportName:${birtStatForm.reportName}" data-form-submit>
                                            <mvc:message code="Day"/>
                                        </a>
                                    </li>
                                    <li class="${birtStatForm.dateSelectMode == 'SELECT_MONTH' ? 'active' : ''}">
                                        <a href="#" data-form-set="dateSelectMode:SELECT_MONTH,reportName:${birtStatForm.reportName}" data-form-submit>
                                            <mvc:message code="Month"/>
                                        </a>
                                    </li>
                                    <li class="${birtStatForm.dateSelectMode == 'SELECT_PERIOD' ? 'active' : ''}">
                                        <a href="#" data-form-set="dateSelectMode:SELECT_PERIOD,reportName:${birtStatForm.reportName}" data-form-submit>
                                            ...
                                            <div class="control">
                                                <div class="input-group">
                                                    <div class="input-group-controls">
                                                        <input type="text" value="${birtStatForm.selectDay.date}" class="form-control datepicker-input js-datepicker" name="selectDay.date"
                                                    ...
                                                    <div class="input-group-btn">
                                                        <button class="btn btn-primary btn-regular pull-right" type="button" data-form-set="reportName:${birtStatForm.reportName}" data-form-submit>
                                                            <i class="icon icon-refresh"></i>
                                        ...
                                        <div class="controls controls-left">
                                            ...
                                            <div class="date-range-controls">
                                                ...
                                                <div class="control">
                                                    <div class="input-group">
                                                        <div class="input-group-controls">
                                                            <input id="startDay" type="text" value="${birtStatForm.startDate.date}" class="form-control datepicker-input js-datepicker" name="startDate.date"
                                                                   data-datepicker-options="format: '${fn:toLowerCase(localDatePattern)}'"/>
                                                        </div>
                                                        <div class="input-group-btn">
                                                            <button type="button" class="btn btn-regular btn-toggle js-open-datepicker" tabindex="-1">
                                                ...
                                                <div class="control">
                                                    <div class="input-group">
                                                        <div class="input-group-controls">
                                                            <input id="endDay" type="text" value="${birtStatForm.endDate.date}" class="form-control datepicker-input js-datepicker" name="endDate.date"
                                                                   data-datepicker-options="format: '${fn:toLowerCase(localDatePattern)}'"/>
                                                        </div>
                                                        <div class="input-group-btn">
                                                            <button type="button" class="btn btn-regular btn-toggle js-open-datepicker" tabindex="-1">
