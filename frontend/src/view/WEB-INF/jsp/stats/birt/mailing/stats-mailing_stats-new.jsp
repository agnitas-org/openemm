...
<%--@elvariable id="mailingBirtStatForm" type="com.agnitas.reporting.birt.web.forms.mailingBirtStatForm"--%>
...
<mvc:form servletRelativeAction="/mailing_stat/list.action" modelAttribute="mailingBirtStatForm">
        ...
        <div class="tile-content hidden" data-initializer="mailing-overview-table">
            ...
            <div class="table-wrapper table-overflow-visible">
                <display:table
                        ...
                        excludedParams="*"
                        requestURI="/mailing_stat/list.action?__fromdisplaytag=true">
                    ...
                    <display:column titleKey="Mailing"
                        ...
                        <c:url var="mailingSatatUrl" value="/mailing_stat/view.action?mailingID=${mailingStat.mailingid}"/>
