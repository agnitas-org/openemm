    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <img src="<c:url value="/assets/core/images/upselling/AutoExport.svg" />" alt="Auto-export">
            </div>
            <div class="modal-body vstack gap-3">
                <h2><mvc:message code="upselling.headline.autoExport"/></h2>
                <p><mvc:message code="upselling.description.autoExport"/></p>
