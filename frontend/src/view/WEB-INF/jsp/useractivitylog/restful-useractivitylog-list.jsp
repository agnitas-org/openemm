...
<mvc:form servletRelativeAction="/administration/restful-user/activitylog/list.action" modelAttribute="form" data-form="resource">
    ...
    <div class="tile">
        <div class="tile-header">
            ...
            <ul class="tile-header-actions">
                <li>
                    <c:url value="/administration/restful-user/activitylog/download.action" var="userActivityLogDownloadURL"/>
                    <a href="#"
        ...
        <div class="tile-content">
            <div class="table-wrapper">
                <display:table id="userAction"
                               ...
                               sort="external"
                               requestURI="/administration/restful-user/activitylog/list.action"
                               partialList="true"
                    ...
                    <display:column property="displayName"
