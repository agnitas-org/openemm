...
<%@ page import="com.agnitas.emm.core.userform.service.UserFormFilter" %>
...
<mvc:form servletRelativeAction="/webform/list.action" modelAttribute="form" id="userFormForm">
        ...
        <div class="tile-content">
                <div class="hidden">
                    <div class="dropdown filter" data-field="filter" data-filter-target=".js-filter-activeness">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <label class="label">
                                    <mvc:radiobutton path="filter" value="${UserFormFilter.ACTIVE}" data-field-filter="" cssStyle="margin: 0"/>
                                    <b><mvc:message code="default.status.active"/></b>
                                </label>
                            </li>
                            <li>
                                <label class="label">
                                    <mvc:radiobutton path="filter" value="${UserFormFilter.INACTIVE}" data-field-filter="" cssStyle="margin: 0"/>
                            ...
                            <li class="divider"></li>
                            <li>
                                <a href="#" class="js-dropdown-open" data-form-persist="filter: '${UserFormFilter.NONE}'">
            ...
            <div class="table-wrapper table-overflow-visible" data-sizing="scroll">
                ...
                <display:table id="userForm" name="userFormList" requestURI="/webform/list.action"
                    ...
                    pagesize="${userFormList.fullListSize + 1}"
                    excludedParams="*">

                    <c:set var="checkboxSelectAll">
                        <input type="checkbox" class="js-bulk-ids" data-form-bulk=""/>
                    </c:set>

                    <emm:ShowByPermission token="forms.delete">
                        <display:column title="${checkboxSelectAll}" sortable="false" class="js-checkable" headerClass="squeeze-column">
                            <input type="checkbox" class="js-bulk-ids" value="${userForm.id}"/>
                        </display:column>
                    </emm:ShowByPermission>
                    ...
                    <display:column headerClass="hidden" class="table-actions hidden">
