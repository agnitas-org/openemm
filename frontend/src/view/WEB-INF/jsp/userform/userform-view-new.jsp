...
<mvc:form servletRelativeAction="/webform/save.action" id="userFormForm" modelAttribute="form" data-form="resource"
          ...
          data-controller="userform-view" data-initializer="userform-view">
                    ...
                    <div class="col-sm-8">
                        <div class="inline-tile">
                            ...
                            <div class="inline-tile-content">
                                ...
                                <!-- WYSIWYG EDITOR -->
                                <div id="tab-success-template-wysiwyg" class="hidden" data-full-tags="true">
                                    <div class="row">
                    ...
                    <div class="col-sm-8">
                        <div class="inline-tile">
                            ...
                            <div class="inline-tile-content">
                                ...
                                <!-- WYSIWYG EDITOR -->
                                <div id="tab-error-template-wysiwyg" class="hidden" data-full-tags="true">
                                    <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id="tab-modalTextAreaHtmlEditor" data-full-tags="true" {{ (showHtmlEditor) ? print('data-tab-show') : print('data-tab-hide') }}>
                        <textarea id="modalTextArea" name="modalTextArea" data-sync="{{= target }}" class="form-control js-editor js-wysiwyg hidden" data-form-target="#userFormForm"></textarea>
                    </div>
