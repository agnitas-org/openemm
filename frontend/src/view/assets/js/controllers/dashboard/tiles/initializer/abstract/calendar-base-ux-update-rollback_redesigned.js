(() => {
  ...
  class CalendarBase {
    ...
    getMailingLink(mailing) {
      return mailing.workstatus === 'mailing.status.sent' && mailing.workstatus !== 'mailing.status.test' && this.statisticsViewAllowed
    ...
    static createMailingPopover(mailing) {
      new AGN.Lib.Dashboard.MailingPopoverUxUpdateRollback(mailing);
    }
  }

  AGN.Lib.Dashboard.CalendarBaseUxUpdateRollback = CalendarBase;
})();
