...
AGN.Lib.Controller.new('workflow-view-new', function () {
    ...
    var WorkflowManagerStatisticsNew;
    ...
    this.addDomInitializer('workflow-pdf-initialize', function () {
        ...
        campaignManager = new AGN.Lib.WM.CampaignManagerNew({
        ...
        WorkflowManagerStatisticsNew = new AGN.Lib.WM.WorkflowManagerStatisticsNew(campaignManager);
        ...
        if (data.showStatistics) {
            WorkflowManagerStatisticsNew.toggleStatistics(data.workflowId);
        }
    });
    ...
    this.addDomInitializer('start-editor-initializer', function ($e) {
        ...
        startMailingSelector = new AGN.Lib.WM.MailingSelectorBaseNew(startData.form, startData.container, startData.sessionId, startData.selectedName, startData.noMailingOption, editorsHelper);
    ...
    this.addDomInitializer('decision-editor-initializer', function ($e) {
        ...
        decisionMailingSelector = new AGN.Lib.WM.MailingSelectorBaseNew(decisionData.form, decisionData.container, decisionData.sessionId, decisionData.selectName, decisionData.noMailingOption, editorsHelper);
    ...
    this.addDomInitializer('mailing-editor-initializer', function ($e) {
        ...
        mailingEditorBase = new AGN.Lib.WM.MailingEditorBaseNew(mailingData, campaignManager, submitWorkflowForm);
    ...
    this.addDomInitializer('action-mailing-editor-initializer', function ($e) {
        ...
        actionbasedMailingEditorBase = new AGN.Lib.WM.MailingEditorBaseNew(actionMailingData, campaignManager, submitWorkflowForm);
    ...
    this.addDomInitializer('date-mailing-initializer', function ($e) {
        ...
        datebasedMailingEditorBase = new AGN.Lib.WM.MailingEditorBaseNew(dateMailingData, campaignManager, submitWorkflowForm);
    ...
    this.addDomInitializer('followup-mailing-editor-initializer', function ($e) {
        ...
        baseMailingEditorBase = new AGN.Lib.WM.MailingEditorBaseNew(baseMailingData, campaignManager, submitWorkflowForm);

        followupMailingEditorBase = new AGN.Lib.WM.MailingEditorBaseNew(followupMailingData, campaignManager, submitWorkflowForm);
    ...
    this.addDomInitializer('copy-dialog-initializer', function ($e) {
        ...
        var copyData = $e.find("#copy-editor-data-new").json();

        workflowCopyDialogHandler = {
            workflowId: {},
            workflowCopyDialogClose: function () {
                jQuery('#workflow-copy-dialog-new').dialog('close');
                return false;
            },
            ...
            showDialog: function (workflowId) {
                ...
                if (isAllNodesAreEmpty) {
                    jQuery("#workflow-copy-dialog-new div.form-group div.col-xs-12 div.well").html(t('workflow.copy.question'));
                    jQuery("#workflowBtnWithContent").hide();
                    jQuery("#workflowBtnOnlyChain").hide();
                    jQuery("#workflowBtnCopy").show();
                } else {
                    jQuery("#workflow-copy-dialog-new div.form-group div.col-xs-12 div.well").html(t('workflow.copy.question_with_content'));
                    jQuery("#workflowBtnCopy").hide();
                    jQuery("#workflowBtnWithContent").show();
                    jQuery("#workflowBtnOnlyChain").show();
                }

                jQuery('#workflow-copy-dialog-new').dialog({
    ...
    this.addDomInitializer('testing-dialog-initializer', function ($elem) {
        ...
        workflowTestingDialogHandler = {
            showDialog: function (positiveCallback) {
                ...
                jQuery('#workflow-testing-dialog-new').dialog({
            ...
            closeDialog: function () {
                $('#workflow-testing-dialog-new').dialog('close');
                return false;
            },
    ...
    function toggleStatistics(workflowId, $element) {
        if (data.isStatusOpen === 'true') {
            ...
            WorkflowManagerStatisticsNew.toggleStatistics(workflowId);
    ...
    function updateStatisticsButtonLabel($element) {
        ...
        if (WorkflowManagerStatisticsNew.statisticsVisible) {
