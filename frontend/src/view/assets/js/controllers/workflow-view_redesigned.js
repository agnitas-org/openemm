AGN.Lib.Controller.new('workflow-view', function() {
  ...
  const Modal = AGN.Lib.Modal;
    ...
    this.addDomInitializer('deadline-editor-initializer', function() {
        var nodeEditor = EditorsHelper.registerEditor('deadline', {
            ...
            fillEditor: function(node) {
                ...
                $form.submit(false);
              $('form[name="' + this.formName + '"] #deadlineDate').datepicker("setDate", this.dateAsUTC(data.date || new Date()));
        ...
        var nodeEditor = {
            ...
            fillEditor: function(node) {
                ...
                Form.get(editorForm).cleanErrors();
                  ...
                  if (!this.isStartEditor
                    // && editor.isAllLinkedFilledStartsHasDateType(node) todo
                  ) {
    ...
    this.addAction({ click: 'show-grid' }, function() {
        editor.toggleGrid();
    });
