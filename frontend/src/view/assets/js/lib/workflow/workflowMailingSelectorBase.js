(function() {
  ...
  var MailingSelectorBase = function(form, container, pageContextSessionId, selectName, noMailingOption, editorsHelper) {
    ...
    this.getAllMailingSorted = function(field, direction) {
      ...
      jQuery.ajax({
        type: "POST",
        url: "workflow.do;jsessionid=" + this.pageContextSessionId,
        data: {
  ...
  AGN.Lib.WM.MailingSelectorBase = MailingSelectorBase;
