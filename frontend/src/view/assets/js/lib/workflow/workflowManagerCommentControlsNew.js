(function(){
    ...
    var CommentControlsNew = function CommentControlsNew(campaignManager, data) {
    ...
    CommentControlsNew.popoverOptions = function(controls, node) {
    ...
    CommentControlsNew.prototype.generatePopoverContent = function(node) {
        var content = "";
    ...
    CommentControlsNew.prototype.getMailingThumbnail = _.memoize(function(mailingId) {
        var self = this;
        var img = '';
        jQuery.ajax({
            type: "POST",
    ...
    CommentControlsNew.prototype.showCommentPopover = function(node) {
        var comment = node.data.iconComment;
    ...
    CommentControlsNew.prototype.hideCommentPopover = function() {
        this.hidePopover(false);
    };

    CommentControlsNew.prototype.updateComments = function(node) {
        if (this.commentPopover) {
            this.commentPopover.destroy();
        }

        var commentControlsNew = this;
        this.commentPopover = Popover.new(node.elementJQ, CommentControlsNew.popoverOptions(commentControlsNew, node));
    ...
    CommentControlsNew.prototype.stopHiding = function() {
        if (this.timeoutId) {
    ...
    CommentControlsNew.prototype.showPopover = function() {
        this.stopHiding();
        this.commentPopover.show();
    };

    CommentControlsNew.prototype.hidePopover = function (immediate) {
        this.stopHiding();
    ...
    CommentControlsNew.prototype.showCommentEditDialog = function() {
    ...
    CommentControlsNew.prototype.addCommentEllipsis = function(node) {
    ...
    CommentControlsNew.prototype.showCommentFootnote = function($icon, commentText) {
        var self = this;
    ...
    AGN.Lib.WM.CommentControlsNew = CommentControlsNew;
})();
