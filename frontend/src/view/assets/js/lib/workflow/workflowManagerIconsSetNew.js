(function() {
    var IconsSetLoaderNew = function IconsSetLoaderNew(campaignManager) {

        this.loadIconsSetAJAXNew = function(rootNode, useOriginal) {
    ...
    AGN.Lib.WM.IconsSetLoaderNew = IconsSetLoaderNew;
})();
