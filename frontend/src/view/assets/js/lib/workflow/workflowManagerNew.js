(function () {
    ...
    var CampaignManagerNew = function CampaignManagerNew(data) {
        ...
        var commentControls = new AGN.Lib.WM.CommentControlsNew(self, data);
        ...
        var expandNode = function (node, useOriginal) {
            new AGN.Lib.WM.IconsSetLoaderNew(self).loadIconsSetAJAXNew(node, useOriginal);
...
//            top: viewPortJQ.position().top + editorCanvasHeight - navigatorJQ.height() - 10
    ...
    AGN.Lib.WM.CampaignManagerNew = CampaignManagerNew;
})();
