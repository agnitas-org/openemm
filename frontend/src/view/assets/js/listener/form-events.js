...
`loading` | AGN.Lib.LoadingForm | yes | intermediary form, used for polling the server until the rendering of a result table is finished. it will replace the content on each polling step (useful in case the server returns a loading bar)
*/
