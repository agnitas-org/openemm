...
(function($) {
    ...
    Dirty.prototype = {
        ...
        statuses: {
            dirty: dirty,
            clean: clean,
            dataInitialValue: dataInitialValue,
    ...
    $.fn.dirty.singleton = getSingleton;

    $.fn.dirty.defaults = {
        preventLeaving: false,
        leavingMessage: "There are unsaved changes on this page which will be discarded if you continue.",
        onDirty: $.noop, //This function is fired when the form gets dirty
        onClean: $.noop, //This function is fired when the form gets clean again
        fireEventsOnEachChange: false, // Fire onDirty/onClean on each modification of the form
    };

    $.fn.dirty.extend = function(methods) {
        $.extend(Dirty.prototype, methods);
    };

    $.fn.dirty.constructor = Dirty;
    $.fn.dirty.prototype = Dirty.prototype;
})(jQuery);