 ...
 */
    ...
    QueryBuilder.regional['en'] = {
        ...
        "add_rule": t("querybuilder.common.add_rule"),
        "add_group": t("querybuilder.common.add_group"),
        "delete_rule": t("querybuilder.common.delete_rule"),
        "delete_group": t("querybuilder.common.delete_group"),
        "conditions": {
            "AND": t("querybuilder.conditions.AND"),
            "OR": t("querybuilder.conditions.OR")
        },
        "operators": {
            "equal": t("querybuilder.operators.equal"),
            "not_equal": t("querybuilder.operators.not_equal"),
            "in": t("querybuilder.operators.in"),
            "not_in": t("querybuilder.operators.not_in"),
            "less": t("querybuilder.operators.less"),
            "less_or_equal": t("querybuilder.operators.less_or_equal"),
            "greater": t("querybuilder.operators.greater"),
            "greater_or_equal": t("querybuilder.operators.greater_or_equal"),
            "between":  t("querybuilder.operators.between"),
            "not_between": t("querybuilder.operators.not_between"),
            "begins_with": t("querybuilder.operators.begins_with"),
            "not_begins_with": t("querybuilder.operators.not_begins_with"),
            "contains": t("querybuilder.operators.contains"),
            "not_contains": t("querybuilder.operators.not_contains"),
            "ends_with": t("querybuilder.operators.ends_with"),
            "not_ends_with": t("querybuilder.operators.not_ends_with"),
            "is_empty": t("querybuilder.operators.is_empty"),
        ...
        "errors": {
            "no_filter": t("querybuilder.errors.no_filter"),
            "empty_group": t("querybuilder.errors.empty_group"),
            "radio_empty": t("querybuilder.errors.radio_empty"),
            "checkbox_empty": t("querybuilder.errors.checkbox_empty"),
            "select_empty": t("querybuilder.errors.select_empty"),
            "string_empty": t("querybuilder.errors.string_empty"),
            "string_exceed_min_length": t("querybuilder.errors.string_exceed_min_length"),
            "string_exceed_max_length": t("querybuilder.errors.string_exceed_max_length"),
            "string_invalid_format": t("querybuilder.errors.string_invalid_format"),
            "number_nan": t("querybuilder.errors.number_nan"),
            "number_not_integer": t("querybuilder.errors.number_not_integer"),
            "number_not_double": t("querybuilder.errors.number_not_double"),
            "number_exceed_min": t("querybuilder.errors.number_exceed_min"),
            "number_exceed_max": t("querybuilder.errors.number_exceed_max"),
            "number_wrong_step": t("querybuilder.errors.number_wrong_step"),
            "number_between_invalid": "Invalid values, {0} is greater than {1}",
            "datetime_empty": t("querybuilder.errors.datetime_empty"),
            "datetime_invalid": t("querybuilder.errors.datetime_invalid"),
            "datetime_exceed_min": t("querybuilder.errors.datetime_exceed_min"),
            "datetime_exceed_max": t("querybuilder.errors.datetime_exceed_max"),
            "datetime_between_invalid": "Invalid values, {0} is greater than {1}",
            "boolean_not_valid": t("querybuilder.errors.boolean_not_valid"),
            "operator_not_multiple": t("querybuilder.errors.operator_not_multiple")
        },
        "invert":  t("querybuilder.common.invert"),
        "NOT": "NOT"
    };
