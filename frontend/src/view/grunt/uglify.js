var applicationCommonFiles = [
  ...
  '<%= config.runtimeLibs %>/ace/ace_1.1.8/ace.js',
  '<%= config.runtimeLibs %>/ace/ace_1.1.8/ext-language_tools.js',
  '<%= config.runtimeLibs %>/ace/ace_1.4.14/ace.js',
  '<%= config.runtimeLibs %>/ace/ace_1.4.14/ext-language_tools.js',
