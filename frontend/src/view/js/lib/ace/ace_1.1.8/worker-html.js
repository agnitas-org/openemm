...
function TreeBuilder() {
	...
	modes.initial.processDoctype = function(name, publicId, systemId, forceQuirks) {
		...
		if (forceQuirks || name != 'html' || (publicId != null && ([
			...
			|| equals(systemId, "http://www.ibm.com/data/dtd/v11/ibmxhtml1-transitional.dtd")
		) {
			...
			if ((startsWith(publicId, "-//w3c//dtd html 4.0//") && (systemId == null || equals(systemId, "http://www.w3.org/TR/REC-html40/strict.dtd")))
				|| (startsWith(publicId, "-//w3c//dtd html 4.01//") && (systemId == null || equals(systemId, "http://www.w3.org/TR/html4/strict.dtd")))
				|| (startsWith(publicId, "-//w3c//dtd xhtml 1.0 strict//") && equals(systemId, "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"))
				|| (startsWith(publicId, "-//w3c//dtd xhtml 1.1//") && equals(systemId, "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd"))
			) {
        // Do nothing
    ...
    function equals(s1, s2) {
      return (s1 == null ? "" : s1).toLowerCase() == (s2 == null ? "" : s2).toLowerCase();
    }
    function startsWith(s1, s2) {
      return (s1 == null ? "" : s1).toLowerCase().indexOf((s2 == null ? "" : s2).toLowerCase()) === 0;
    }
	};
