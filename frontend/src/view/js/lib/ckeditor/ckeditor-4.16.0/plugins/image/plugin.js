...
( function() {
	...
	CKEDITOR.plugins.add( 'image', {
		...
		init: function( editor ) {
			...
			var allowed = 'img[alt,!src,width,height,align]{border-style,border-width,float,height,margin,margin-bottom,margin-left,margin-right,margin-top,width}',
				required = 'img[alt,src]';

			if ( CKEDITOR.dialog.isTabEnabled( editor, pluginName, 'advanced' ) )
				allowed = 'img[alt,dir,id,lang,longdesc,!src,title,width,height,align]{*}(*)';
